  ...
  [4925],
  {
      ...
      function p(e, t, l) {
        let {
          ...
          D = (0, r.useMemo)(
            ...
            [p, t.collection, t.disabledKeys, b]
          ),
          ...
          { isInvalid: F, validationErrors: B, validationDetails: w } = t.displayValidation,
          {
            labelProps: x,
            fieldProps: C,
            descriptionProps: E,
    ...
    31259: (e, t, l) => {
      ...
      function n(e) {
        ...
        let l = 0,
          n = (t) => {
            for (let s of t) 'section' === s.type ? n((0, i.iQ)(s, e)) : l++;
          };
    ...
    39496: (e, t, l) => {
      ...
      function c(e, t, l) {
        ...
        return (
          ...
          (0, a.X)({ validationBehavior: w }, t, l),
          {
      ...
      function D(e) {
        let t,
          {
            ...
            selectOnFocus: B = 'replace' === l.selectionBehavior,
          ...
          E
            ...
            : () => {
                ...
                R.current = {
                  top:
                    null !==
                      (l = null === (e = M.current) || void 0 === e ? void 0 : e.scrollTop) &&
                    void 0 !== l
                      ? l
                      : 0,
                  left:
                    null !==
                      (i = null === (t = M.current) || void 0 === t ? void 0 : t.scrollLeft) &&
                    void 0 !== i
                      ? i
                      : 0,
                };
        ...
        let L = (0, c.J)(() => {
          ...
          let i =
            ...
            void 0 !== t
              ...
              : null;
          null == i
            ? ((0, K.vX)(D.current), l.collection.size > 0 && (N.current = !1))
            : (l.setFocusedKey(i), (N.current = !1));
        });
        h(() => {
          N.current && L();
        }, [l.collection, L]);
        let V = (0, c.J)(() => {
          l.collection.size > 0 && (N.current = !1);
        });
        h(() => {
          V();
        }, [l.focusedKey, V]),
        ...
        (0, y.useEffect)(() => {
          if (O.current) {
            ...
            l.setFocused(!0),
              l.setFocusedKey(n),
              null == n && !x && D.current && (0, f.l)(D.current),
              l.collection.size > 0 && ((O.current = !1), (z.current = !0));
          }
        });
        let U = (0, y.useRef)(l.focusedKey);
        (0, y.useEffect)(() => {
          if (
            l.isFocused &&
            null != l.focusedKey &&
            (l.focusedKey !== U.current || z.current) &&
            M.current &&
            D.current
          ) {
            let e = (0, v.ME)(),
        ...
        let W = {
            onKeyDown: (e) => {
              ...
              let S = (t, s) => {
                if (null != t) {
                  if (l.isLink(t) && 'selection' === A && B && !(0, i.N9)(e)) {
                    (0, p.flushSync)(() => {
                      l.setFocusedKey(t, s);
                    });
                    let n = (0, i.au)(D, t),
                  ...
                  l.setFocusedKey(t, s),
                    (l.isLink(t) && 'override' === A) ||
                      (e.shiftKey && 'multiple' === l.selectionMode
                        ? l.extendSelection(t)
                        : B && !(0, i.N9)(e) && l.replaceSelection(t));
                }
              };
              switch (e.key) {
                case 'ArrowDown':
                ...
                case 'ArrowLeft':
                  if (d.getKeyLeftOf) {
                    ...
                    null == t &&
                      ...
                      null != t && (e.preventDefault(), S(t, 'rtl' === I ? 'first' : 'last'));
                  }
                  break;
                case 'ArrowRight':
                  if (d.getKeyRightOf) {
                    ...
                    null == t &&
                      ...
                      null != t && (e.preventDefault(), S(t, 'rtl' === I ? 'last' : 'first'));
                  }
                  break;
                case 'Home':
                  if (d.getFirstKey) {
            ...
            onFocus: (e) => {
              ...
              if (e.currentTarget.contains(e.target)) {
                if ((l.setFocused(!0), null == l.focusedKey)) {
                  ...
                  let i = (e) => {
                      null != e &&
                        (l.setFocusedKey(e), B && !l.isSelected(e) && l.replaceSelection(e));
                    },
                    r = e.relatedTarget;
                  ...
                  !E &&
                    M.current &&
                    ((M.current.scrollTop = R.current.top),
                    (M.current.scrollLeft = R.current.left));
                if (null != l.focusedKey && M.current) {
                  let e = (0, i.au)(D, l.focusedKey);
                  e instanceof HTMLElement &&
                    (e.contains(document.activeElement) || x || (0, r.e)(e),
          ...
          { typeSelectProps: j } = (0, s.I)({ keyboardDelegate: d, selectionManager: l });
        w || (W = (0, g.v)(j, W)), x || (t = null == l.focusedKey ? 0 : -1);
        let H = (0, i.j5)(l.collection);
        return { collectionProps: (0, g.v)(W, { tabIndex: t, 'data-collection': H }) };
      }
    },
    61719: (e, t, l) => {
      l.d(t, { x: () => S });
      ...
      function S(e, t, l) {
        ...
        let { key: E } = e,
          ...
          R =
            null !== (w = e.shouldFocusOnHover) && void 0 !== w
              ? w
              : null == M
                ? void 0
                : M.shouldFocusOnHover,
          N =
            null !== (x = e.shouldUseVirtualFocus) && void 0 !== x
              ? x
              : null == M
                ? void 0
        ...
        let W = (null == M ? void 0 : M.onAction)
          ...
          j = (0, i.H)(t, E),
          {
            ...
            let w = l.isLink(i) && 'override' === P,
              x = l.isLink(i) && 'selection' !== P && 'none' !== P,
              C = !d && l.canSelectItem(i) && !w,
              E = (y || x) && !d,
            ...
            let { pressProps: z, isPressed: U } = (0, p.d)(O),
              W = A
                ? (e) => {
                    'mouse' === T.current && (e.stopPropagation(), e.preventDefault(), V(e));
                  }
                : void 0,
              ...
              itemProps: (0, a.v)(
                ...
                R ? j : {},
                {
                  ...
                  onDragStartCapture: (e) => {
                    'touch' === T.current && N.current && e.preventDefault();
                  },
                  onClick: H,
                  id: t,
                },
            ...
            allowsDifferentPressOrigin: T && R,
            isVirtualized: L,
    ...
    96336: (e, t, l) => {
      ...
      function r(e) {
        ...
        return {
          ...
          focusStrategy: l,
          open(e = null) {
            0 !== u.collection.size && (r(e), t.open());
          },
          toggle(e = null) {
            0 !== u.collection.size && (r(e), t.toggle());
          },
          isFocused: c,
          setFocused: d,
        };
            ...
            menuTriggerProps: {
              ...
              ...('press' === o
                ? {
                    ...
                    onPress(e) {
                      'touch' !== e.pointerType || n || t.toggle();
                    },
                  }
                : d),
              id: r,
