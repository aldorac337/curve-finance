(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [1112, 2873, 4110, 8974, 9612],
  {
    ...
    73115: (e, t, r) => {
      ...
      var f = r(54568);
      let m = (e) => {
          let { classes: t, variant: r, animation: a, hasChildren: n, width: s, height: o } = e;
          return (0, i.A)(
            {
              root: [
                'root',
...
`,
      ...
      `
          ...
          (0, u.A)(({ theme: e }) => {
            ...
            return {
              ...
              backgroundColor: e.vars
                ...
                : (0, s.X4)(e.palette.text.primary, 'light' === e.palette.mode ? 0.11 : 0.13),
              height: '1.2em',
              variants: [
                {
                  props: { variant: 'text' },
        ...
        $ = a.forwardRef(function (e, t) {
          let r = (0, d.b)({ props: e, name: 'MuiSkeleton' }),
            ...
            c = { ...r, animation: a, component: s, variant: u, hasChildren: !!p.children },
            v = m(c);
          return (0, f.jsx)(w, {
            as: s,
            ref: t,
    ...
    75353: (e, t, r) => {
      ...
      var a = r(54568),
        ...
        i = r(7620),
        s = r(73115);
      let o = { dex: 'pools', lend: 'markets', crvusd: 'markets', dao: 'proposals' },
        l = ['lend', 'crvusd', 'dao'];
        ...
        return (
          (0, i.useEffect)(() => {
            let a = (function ({ search: e, hash: t, origin: r }, a, n) {
              let i = t.replace(/^#\//, ''),
                s = a ?? l.find((e) => r.startsWith(e)) ?? 'dex';
