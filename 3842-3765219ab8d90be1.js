  ...
  [3842],
  {
    ...
    54152: (e, t, n) => {
          ...
          if (i) {
            if (i.timestamp) {
              let o = Date.now() - i.timestamp > n,
                c = i.buster !== r;
              o || c ? t.removeClient() : (0, a.Qv)(e, i.clientState, s);
            } else t.removeClient();
          }
        } catch (e) {
          t.removeClient();
      ...
      var l = n(87606),
        u = n(61529),
        d = n(54568),
        p = ({ children: e, persistOptions: t, onSuccess: n, ...a }) => {
          let [s, p] = r.useState(!0),
            f = r.useRef({ persistOptions: t, onSuccess: n }),
            h = r.useRef(!1);
          return (
            r.useEffect(() => {
              f.current = { persistOptions: t, onSuccess: n };
            }),
            r.useEffect(() => {
              let e = { ...f.current.persistOptions, queryClient: a.client };
              return (
                h.current ||
                  ((h.current = !0),
                  o(e).then(async () => {
                    try {
                      await f.current.onSuccess?.();
                    } finally {
                      p(!1);
                    }
                  })),
            ...
            (0, d.jsx)(l.QueryClientProvider, {
              ...a,
              children: (0, d.jsx)(u.IsRestoringProvider, { value: s, children: e }),
            })
          );
        };
    },
      ...
      function w(e) {
        ...
        let {
          ...
          C = l(() => {
            ...
            if (!d && m) for (let n of m.getProviders()) t.has(n.info.rdns) || e.push(P(E(n)));
            return e;
          });
        function P(e) {
          let t = new p(
        ...
        return (
          ...
          }),
          {
            ...
            getClient: function (e = {}) {
              ...
              {
                let e = I.get(U.getState().chainId);
                if (e && !r) return e;
                if (!r) throw new x.nk();
              }
              {
    ...
    84155: (e, t, n) => {
      ...
      var r = n(93902),
        ...
        i = n(82663);
      function o(e, t) {
        let n = (0, r.sc)((0, a.q)(e, { strict: !1 }) ? (0, s.ZJ)(e) : e);
    ...
    87240: (e, t, n) => {
      ...
      function d(e, t = {}) {
        ...
        return ({ chain: d, retryCount: g, timeout: v }) => {
          ...
          })(I, { fetchOptions: a, onRequest: m, onResponse: b, timeout: E });
          return (0, u.o)(
            {
              key: p,
              methods: f,
              ...
              async request({ method: e, params: t }) {
                ...
                if (c) throw new r.J8({ body: a, error: c, url: I });
                return l;
              },
              retryCount: P,
              retryDelay: y,
