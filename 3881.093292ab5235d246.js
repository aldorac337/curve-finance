  ...
  [3881],
  {
                ...
                for (let t = 0; t < a.length; t++) {
                  ...
                  for (let t = 0; t < n.length; t++) {
                    ...
                    r[l] && r[l].node.mode === c.mode
                      ? ((i[l][d] =
                          p(r[l].lastCount + c.length, c.mode) - p(r[l].lastCount, c.mode)),
                        (r[l].lastCount += c.length))
                      : (r[l] && (r[l].lastCount = c.length),
                        (i[l][d] = p(c.length, c.mode) + 4 + o.getCharCountIndicator(c.mode, e)));
                  }
                }
                n = s;
              }
                ...
                for (let r = 0; r < t.length; r++) {
                  ...
                  switch (i.mode) {
                    ...
                    case o.ALPHANUMERIC:
                      ...
                      break;
                    case o.KANJI:
                      e.push([i, { data: i.data, mode: o.BYTE, length: h(i.data) }]);
                      break;
                    case o.BYTE:
      ...
      (i.getBitsLength = function (t) {
        ...
        (i.prototype.write = function (t) {
          ...
          for (e = 0; e + 3 <= this.data.length; e += 3)
            (o = parseInt(this.data.substr(e, 3), 10)), t.put(o, 10);
          let i = this.data.length - e;
          i > 0 && ((o = parseInt(this.data.substr(e), 10)), t.put(o, 3 * i + 1));
        }),
        (t.exports = i);
    },
    29519: (t, e, r) => {
    ...
    38888: (t, e, r) => {
      let o = r(63983),
        i = r(40748);
      function n(t) {
        (this.mode = i.BYTE), 'string' == typeof t && (t = o(t)), (this.data = new Uint8Array(t));
      }
      (n.getBitsLength = function (t) {
        return 8 * t;
      }),
        ...
        return (
          ...
          (function (t, e, r, i) {
            ...
            let v = (function (t, e, r) {
                ...
                let l = (o.getSymbolTotalCodewords(t) - d.getTotalCodewordsCount(t, e)) * 8;
                for (i.getLengthInBits() + 4 <= l && i.put(0, 4); i.getLengthInBits() % 8 != 0; )
                  i.putBit(0);
                ...
                return (function (t, e, r) {
                  ...
                  let A = new Uint8Array(l),
                    C = 0;
                  for (i = 0; i < x; i++)
                    for (n = 0; n < s; n++) i < b[n].length && (A[C++] = b[n][i]);
                  for (i = 0; i < f; i++) for (n = 0; n < s; n++) A[C++] = y[n][i];
                  return A;
                })(i, t, e);
              })(e, r, m),
            ...
            return (
              ...
              c.applyMask(i, b),
              f(b, r, i),
              { modules: b, version: e, errorCorrectionLevel: r, maskPattern: i, segments: m }
            );
          })(t, r, w, m)
        );
      };
    ...
    59693: (t, e, r) => {
      ...
      (e.from = function (t, e) {
        ...
        (e.getCapacity = function (t, e, r) {
          ...
          void 0 === r && (r = l.BYTE);
          let n = (o.getSymbolTotalCodewords(t) - i.getTotalCodewordsCount(t, e)) * 8;
        ...
        (e.getBestVersionForData = function (t, r) {
          ...
          return (function (t, r, o) {
            for (let i = 1; i <= 40; i++) if (r <= e.getCapacity(i, o, t)) return i;
    ...
    76118: (t, e, r) => {
      ...
      e.render = function (t, e, r) {
        let l = o.getOptions(e),
          ...
          c = a + 2 * l.margin,
          d = l.color.light.a
            ? '<path ' + i(l.color.light, 'fill') + ' d="M0 0h' + c + 'v' + c + 'H0z"/>'
            : '',
          h =
            '<path ' +
              ...
              for (let s = 0; s < t.length; s++) {
                ...
                c || l || (l = !0),
                  t[s]
                    ? (a++,
                      (s > 0 && c > 0 && t[s - 1]) ||
                        ((o += l ? n('M', c + r, 0.5 + d + r) : n('m', i, 0)), (i = 0), (l = !1)),
          ...
          for (let e = 0; e < a; e++)
            for (let r = 0; r < a; r++) {
              ...
              e >= s &&
                ...
                e < a - s &&
                r < a - s &&
                (h = c[+!!n[Math.floor((e - s) / l) * i + Math.floor((r - s) / l)]]),
                (t[d++] = h.r),
                (t[d++] = h.g),
                (t[d++] = h.b),
                (t[d] = h.a);
    ...
    83881: (t, e, r) => {
      'use strict';
      let o;
      r.r(e), r.d(e, { WcmModal: () => oh, WcmQrCode: () => rf });
      let i = window,
        n =
          i.ShadowRoot &&
      ...
      class s {
        ...
        get styleSheet() {
          ...
          if (n && void 0 === t) {
            ...
            r && (t = a.get(e)),
              void 0 === t &&
                ((this.o = t = new CSSStyleSheet()).replaceSync(this.cssText), r && a.set(e, t));
          }
          return t;
        }
        toString() {
      ...
      let c = (t) => new s('string' == typeof t ? t : t + '', void 0, l),
        ...
        v = (t, e) => e !== t && (e == e || t == t),
        b = { attribute: !0, type: String, converter: w, reflect: !1, hasChanged: v },
        y = 'finalized';
      class x extends HTMLElement {
        ...
        static finalizeStyles(t) {
          let e = [];
          if (Array.isArray(t)) for (let r of new Set(t.flat(1 / 0).reverse())) e.unshift(u(r));
        ...
        _$EO(t, e, r = b) {
          ...
          if (void 0 !== i && !0 === r.reflect) {
            let n = (
              void 0 !== (null === (o = r.converter) || void 0 === o ? void 0 : o.toAttribute)
                ? r.converter
                : w
            ...
            let t = o.getPropertyOptions(i),
              n =
                'function' == typeof t.converter
                  ...
                  : void 0 !==
                      (null === (r = t.converter) || void 0 === r ? void 0 : r.fromAttribute)
                    ? t.converter
                    : w;
        ...
        requestUpdate(t, e, r) {
          let o = !0;
          void 0 !== t &&
            (((r = r || this.constructor.getPropertyOptions(t)).hasChanged || v)(this[t], e)
              ? (this._$AL.has(t) || this._$AL.set(t, e),
                !0 === r.reflect &&
                  this._$El !== t &&
                  (void 0 === this._$EC && (this._$EC = new Map()), this._$EC.set(t, r)))
              : (o = !1)),
      ...
      (x[y] = !0),
        ...
        (null !== (tb = m.reactiveElementVersions) && void 0 !== tb
          ? tb
      ...
      let $ = window,
        ...
        P = Array.isArray,
        R = (t) => P(t) || 'function' == typeof (null == t ? void 0 : t[Symbol.iterator]),
        L = '[ 	\n\f\r]',
        N = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,
        S = /-->/g,
        j = />/g,
...
\f\r"'\`<>=]|("|')|))|$)`,
      ...
      let Q = (t, e) => {
        ...
        for (let e = 0; e < r; e++) {
          let r = t[e],
            ...
            c = -1,
            d = 0;
          for (; d < r.length && ((l.lastIndex = d), null !== (s = l.exec(r))); )
            (d = l.lastIndex),
              l === N
                ? '!--' === s[1]
                  ? (l = S)
          ...
          n +=
            l === N
              ? r + O
              : c >= 0
                ? (o.push(a), r.slice(0, c) + E + r.slice(c) + _ + h)
                : r + _ + (-2 === c ? (o.push(void 0), e) : h);
        }
      ...
      class J {
        constructor({ strings: t, _$litType$: e }, r) {
          ...
          let i = 0,
            ...
            a = this.parts,
            [s, c] = Q(t, e);
          if (((this.el = J.createElement(s, r)), (K.currentNode = this.el.content), 2 === e)) {
            let t = this.el.content,
              e = t.firstChild;
            e.remove(), t.append(...e.childNodes);
          }
          for (; null !== (o = K.nextNode()) && a.length < l; ) {
            if (1 === o.nodeType) {
              if (o.hasAttributes()) {
                let t = [];
                for (let e of o.getAttributeNames())
                  if (e.endsWith(E) || e.startsWith(_)) {
                    let r = c[n++];
                    if ((t.push(e), void 0 !== r)) {
                      let t = o.getAttribute(r.toLowerCase() + E).split(_),
                        e = /([.?@])?(.*)/.exec(r);
                      a.push({
                        type: 1,
                        index: i,
              ...
              if (W.test(o.tagName)) {
                let t = o.textContent.split(_),
                  e = t.length - 1;
                if (e > 0) {
                  o.textContent = A ? A.emptyScript : '';
                  for (let r = 0; r < e; r++)
                    o.append(t[r], T()), K.nextNode(), a.push({ type: 2, index: ++i });
                  o.append(t[e], T());
                }
              }
            } else if (8 === o.nodeType) {
              if (o.data === k) a.push({ type: 2, index: i });
              else {
                let t = -1;
                for (; -1 !== (t = o.data.indexOf(_, t + 1)); )
                  a.push({ type: 7, index: i }), (t += _.length - 1);
              }
            }
            i++;
          }
      ...
      function G(t, e, r = t, o) {
        var i, n, l;
        if (e === V) return e;
        let a = void 0 !== o ? (null === (i = r._$Co) || void 0 === i ? void 0 : i[o]) : r._$Cl,
          s = M(e) ? void 0 : e._$litDirective$;
        return (
          (null == a ? void 0 : a.constructor) !== s &&
            (null === (n = null == a ? void 0 : a._$AO) || void 0 === n || n.call(a, !1),
            void 0 === s ? (a = void 0) : (a = new s(t))._$AT(t, r, o),
            void 0 !== o
              ? ((null !== (l = r._$Co) && void 0 !== l ? l : (r._$Co = []))[o] = a)
              : (r._$Cl = a)),
      ...
      class X {
        ...
        u(t) {
          ...
          let {
            ...
            i = (
              null !== (e = null == t ? void 0 : t.creationScope) && void 0 !== e ? e : I
            ).importNode(r, !0);
          K.currentNode = i;
          let n = K.nextNode(),
            l = 0,
      ...
      class tt {
        constructor(t, e, r, o) {
          ...
          (this.type = 2),
            ...
            (this._$AM = r),
            (this.options = o),
            (this._$Cp = null === (i = null == o ? void 0 : o.isConnected) || void 0 === i || i);
        }
        get _$AU() {
          var t, e;
        ...
        g(t) {
          ...
          let { values: r, _$litType$: o } = t,
            i =
              'number' == typeof o
                ? this._$AC(t)
                : (void 0 === o.el && (o.el = J.createElement(Y(o.h, o.h[0]), this.options)), o);
        ...
        T(t) {
          ...
          for (let i of t)
            o === e.length
              ? e.push((r = new tt(this.k(T()), this.k(T()), this, this.options)))
              : (r = e[o]),
              r._$AI(i),
              o++;
      ...
      class te {
        ...
        _$AI(t, e = this, r, o) {
          let i = this.strings,
            n = !1;
          if (void 0 === i)
            (n = !M((t = G(this, t, e, 0))) || (t !== this._$AH && t !== V)) && (this._$AH = t);
          else {
            let o, l;
            let a = t;
      ...
      class tn extends te {
        ...
        _$AI(t, e = this) {
          var r;
          if ((t = null !== (r = G(this, t, e, 0)) && void 0 !== r ? r : F) === V) return;
          let o = this._$AH,
            i =
              (t === F && o !== F) ||
              t.capture !== o.capture ||
      ...
      null == ta || ta(J, tt),
        (null !== (ty = $.litHtmlVersions) && void 0 !== ty ? ty : ($.litHtmlVersions = [])).push(
          '2.8.0'
        );
      let ts = (t, e, r) => {
        var o, i;
        let n = null !== (o = null == r ? void 0 : r.renderBefore) && void 0 !== o ? o : e,
          l = n._$litPart$;
        if (void 0 === l) {
          let t = null !== (i = null == r ? void 0 : r.renderBefore) && void 0 !== i ? i : null;
          n._$litPart$ = l = new tt(e.insertBefore(T(), t), t, void 0, null != r ? r : {});
        }
        return l._$AI(t), l;
      };
      class tc extends x {
      ...
      (tc.finalized = !0),
        (tc._$litElement$ = !0),
        null === (tx = globalThis.litElementHydrateSupport) ||
          void 0 === tx ||
          tx.call(globalThis, { LitElement: tc });
      let td = globalThis.litElementPolyfillSupport;
      null == td || td({ LitElement: tc }),
        (null !== (t$ = globalThis.litElementVersions) && void 0 !== t$
          ? t$
      ...
      null !=
        (null === (tA = window.HTMLSlotElement) || void 0 === tA
          ? void 0
          : tA.prototype.assignedElements) ||
        ...
        ((o = class extends tw {
          ...
          update(t, [e]) {
            ...
            if (void 0 === this.it) {
              ...
              e))
                !e[o] ||
                  (null === (r = this.nt) || void 0 === r ? void 0 : r.has(o)) ||
                  this.it.add(o);
              return this.render(e);
            }
            ...
            e)) {
              ...
              r === this.it.has(t) ||
                ...
                (r ? (i.add(t), this.it.add(t)) : (i.remove(t), this.it.delete(t)));
            }
            return V;
          }
        }),
      ...
      var tb,
        ...
        tA,
        tC = r(39829);
      let tE = { duration: 0.3, delay: 0, endDelay: 0, repeat: 0, easing: 'ease' },
        t_ = { ms: (t) => 1e3 * t, s: (t) => t / 1e3 },
        tk = () => {},
        tO = (t) => t;
      function tI(t, e = !0) {
      ...
      let tT = (t) => t(),
        tM = (t, e, r = tE.duration) =>
          new Proxy({ animations: t.map(tT).filter(Boolean), duration: r, options: e }, tR),
        tP = (t) => t.animations[0],
        tR = {
          get: (t, e) => {
            let r = tP(t);
            switch (e) {
              case 'duration':
                return t.duration;
              case 'currentTime':
                return t_.s((null == r ? void 0 : r[e]) || 0);
              case 'playbackRate':
              case 'playState':
                return null == r ? void 0 : r[e];
              case 'finished':
                return (
                  t.finished || (t.finished = Promise.all(t.animations.map(tL)).catch(tk)),
                  t.finished
                );
              case 'stop':
                return () => {
                  t.animations.forEach((t) => tI(t));
                };
              case 'forEachNative':
                return (e) => {
        ...
        tS = (t) => 'number' == typeof t,
        tj = (t) => Array.isArray(t) && !tS(t[0]),
        tD = (t, e, r) => -r * t + r * e + t,
      ...
      let tW = (t, e, r) => {
        ...
        tH = (t, e, r) => Math.min(Math.max(r, t), e),
        tz = (t, e, r) => (((1 - 3 * r + 3 * e) * t + (3 * r - 6 * e)) * t + 3 * e) * t;
      function tZ(t, e, r, o) {
        if (t === e && r === o) return tO;
        let i = (e) =>
          (function (t, e, r, o, i) {
            let n, l;
            let a = 0;
            do (n = tz((l = e + (r - e) / 2), o, i) - t) > 0 ? (r = l) : (e = l);
      ...
      let tV =
          (t, e = 'end') =>
          (r) => {
            let o = (r = 'end' === e ? Math.min(r, 0.999) : Math.max(r, 0.001)) * t;
            return tH(0, 1, ('end' === e ? Math.floor(o) : Math.ceil(o)) / t);
          },
        tF = (t) => 'function' == typeof t,
        tq = (t) => Array.isArray(t) && tS(t[0]),
        tK = {
          ease: tZ(0.25, 0.1, 0.25, 1),
          'ease-in': tZ(0.42, 0, 1, 1),
          'ease-in-out': tZ(0.42, 0, 0.58, 1),
          'ease-out': tZ(0, 0, 0.58, 1),
        },
        tY = /\((.*?)\)/;
      function tQ(t) {
        if (tF(t)) return t;
        ...
        if (t.startsWith('steps')) {
          ...
          if (e) {
            let t = e[1].split(',');
            return tV(parseFloat(t[0]), t[1].trim());
          }
        }
        return tO;
      }
      class tJ {
        constructor(
          ...
          (this.repeat = l), (this.easing = tj(r) ? tO : tQ(r)), this.updateDuration(o);
          let d = (function (
            t,
            e = (function (t) {
              let e = [0];
            ...
            return (
              ...
              (i) => {
                ...
                let l = 0;
                for (; l < o - 2 && !(i < e[l + 1]); l++);
                let a = tH(0, 1, tB(e[l], e[l + 1], i));
                return (a = ((n = l), tj(r) ? r[tW(0, r.length, n)] : r)(a)), tD(t[l], t[l + 1], a);
              }
            );
          })(e, a, tj(r) ? r.map(tQ) : tO);
          (this.tick = (e) => {
            var r;
            let o = 0;
            ...
            !c && l >= 1 && (c = 1), 1 === c && a--;
            let h = a % 2;
            ('reverse' === s || ('alternate' === s && h) || ('alternate-reverse' === s && !h)) &&
              (c = 1 - c);
      ...
      let t0 = new WeakMap();
      function t1(t) {
        return t0.has(t) || t0.set(t, { transforms: [], values: new Map() }), t0.get(t);
      }
      let t2 = ['', 'X', 'Y', 'Z'],
        t5 = { x: 'translateX', y: 'translateY', z: 'translateZ' },
        t4 = { syntax: '<angle>', initialValue: '0deg', toDefaultUnit: (t) => t + 'deg' },
        t3 = {
          translate: {
          ...
          rotate: t4,
          scale: { syntax: '<number>', initialValue: 1, toDefaultUnit: tO },
          skew: t4,
        },
        t7 = new Map(),
        t8 = (t) => `--motion-${t}`,
      ...
      ['translate', 'scale', 'rotate', 'skew'].forEach((t) => {
        t2.forEach((e) => {
          t6.push(t + e), t7.set(t8(t + e), t3[t]);
        });
      });
      let t9 = (t, e) => t6.indexOf(t) - t6.indexOf(e),
        et = new Set(t6),
        ee = (t) => et.has(t),
        er = (t, e) => {
          t5[e] && (e = t5[e]);
          let { transforms: r } = t1(t);
          !(function (t, e) {
            -1 === t.indexOf(e) && t.push(e);
          })(r, e),
            (t.style.transform = eo(r));
        },
        eo = (t) => t.sort(t9).reduce(ei, '').trim(),
        ei = (t, e) => `${t} ${e}(var(${t8(e)}))`,
        en = (t) => t.startsWith('--'),
        el = new Set(),
        ea = (t, e) => document.createElement('div').animate(t, e),
        es = {
          cssRegisterProperty: () =>
          ...
          finished: () => !!ea({ opacity: [0, 1] }, { duration: 0.001 }).finished,
          linearEasing: () => {
            try {
              ea({ opacity: 0 }, { easing: 'linear(0, 1)' });
            } catch (t) {
              return !1;
            }
            return !0;
        ...
        ec = {},
        ed = {};
      for (let t in es) ed[t] = () => (void 0 === ec[t] && (ec[t] = es[t]()), ec[t]);
      let eh = (t, e) => {
          let r = '',
        ...
        eu = (t, e) =>
          tF(t) ? (ed.linearEasing() ? `linear(${eh(t, e)})` : tE.easing) : tq(t) ? em(t) : t,
        em = ([t, e, r, o]) => `cubic-bezier(${t}, ${e}, ${r}, ${o})`,
        ep = (t) => (Array.isArray(t) ? t : [t]);
      function eg(t) {
        return t5[t] && (t = t5[t]), ee(t) ? t8(t) : t;
      }
      let ef = {
          get: (t, e) => {
            let r = en((e = eg(e))) ? t.style.getPropertyValue(e) : getComputedStyle(t)[e];
            if (!r && 0 !== r) {
              let t = t7.get(e);
              t && (r = t.initialValue);
            }
          ...
          set: (t, e, r) => {
            en((e = eg(e))) ? t.style.setProperty(e, r) : (t.style[e] = r);
          },
        },
        ew = (t) => 'string' == typeof t,
        ev = (t, e) => (t[e] ? Object.assign(Object.assign({}, t), t[e]) : Object.assign({}, t)),
        eb = function (t, e, r = {}) {
          var o, i, n;
          'string' == typeof (o = t)
          ...
          tG(!!l, 'No valid element provided.'), tG(!!e, 'No keyframes defined.');
          let a = [];
          for (let o = 0; o < l; o++) {
            let s = t[o];
            for (let t in e) {
              let c = ev(r, t);
              (i = c.delay), (n = o), (c.delay = tF(i) ? i(n, l) : i);
              let d = (function (t, e, r, o = {}, i) {
                ...
                y && er(t, e);
                let $ = eg(e),
                  A = ((n = b.values).has($) || n.set($, new tX()), n.get($)),
                  C = t7.get($);
                return (
                  tI(A.animation, !(tN(m) && A.generator) && !1 !== o.record),
                  () => {
                    let n = () => {
                        var e, r;
                        return null !==
                          (r =
                            null !== (e = ef.get(t, $)) && void 0 !== e
                              ? e
                              : null == C
                                ? void 0
                      ...
                      E = (function (t, e) {
                        var r;
                        let o = (null == e ? void 0 : e.toDefaultUnit) || tO,
                          i = t[t.length - 1];
                        if (ew(i)) {
                          let t =
                            (null === (r = i.match(/(-?[\d.]+)([a-z%]*)/)) || void 0 === r
                              ? void 0
                              : r[2]) || '';
                          t && (o = (e) => e + t);
                        }
                    ...
                    if (
                      (en($) &&
                        (ed.cssRegisterProperty()
                          ? (function (t) {
                              if (!el.has(t)) {
                                el.add(t);
                                try {
                                  let { syntax: e, initialValue: r } = t7.has(t) ? t7.get(t) : {};
                          ...
                          : (x = !1)),
                      y && !ed.linearEasing() && (tF(m) || (tj(m) && m.some(tF))) && (x = !1),
                      x)
                    ) {
                      C && (b = b.map((t) => (tS(t) ? C.toDefaultUnit(t) : t))),
                        1 === b.length && (!ed.partialKeyframes() || s) && b.unshift(n());
                      let e = {
                        delay: t_.ms(d),
                        duration: t_.ms(c),
                        endDelay: t_.ms(h),
                        easing: tj(m) ? void 0 : eu(m, c),
                        direction: g,
                        iterations: u + 1,
                        fill: 'both',
                      };
                      (l = t.animate(
                        { [$]: b, offset: f, easing: tj(m) ? m.map((t) => eu(t, c)) : void 0 },
                        e
                      )).finished ||
                      ...
                      l.finished
                        .then(() => {
                          p || (ef.set(t, $, r), l.cancel());
                        })
                        .catch(tk),
                        w || (l.playbackRate = 1.000001);
                    } else if (i && y)
                      1 === (b = b.map((t) => ('string' == typeof t ? parseFloat(t) : t))).length &&
                        b.unshift(parseFloat(n())),
                        (l = new i(
                          (e) => {
                            ef.set(t, $, E ? E(e) : e);
                          },
                          b,
                          Object.assign(Object.assign({}, o), { duration: c, easing: m })
                        ));
                    else {
                      let e = b[b.length - 1];
                      ef.set(t, $, C && tS(e) ? C.toDefaultUnit(e) : e);
                    }
                    return (
                      s &&
                        a(
                          ...
                          e,
                          b,
                          { duration: c, delay: d, easing: m, repeat: u, offset: f },
                          'motion-one'
                        ),
                      A.setAnimation(l),
                      l && !v && l.pause(),
      ...
      var e$ = r(50507),
        ...
        eO = (t, e) => {
          ...
          if (eC) for (var r of eC(e)) e_.call(e, r) && ek(t, r, e[r]);
          return t;
        };
      function eI() {
        return {
      ...
      let eT = {
                  ...
                  eO(
                    eO(
                      ...
                      (function () {
                        ...
                        }[null != (t = tC.lH.state.themeMode) ? t : 'dark'];
                        return {
        ...
        eM = d`button{border-radius:var(--wcm-secondary-button-border-radius);height:28px;padding:0 10px;background-color:var(--wcm-accent-color)}button path{fill:var(--wcm-accent-fill-color)}button::after{border-radius:inherit;border:1px solid var(--wcm-color-overlay)}button:disabled::after{background-color:transparent}.wcm-icon-left svg{margin-right:5px}.wcm-icon-right svg{margin-left:5px}button:active::after{background-color:var(--wcm-color-overlay)}.wcm-ghost,.wcm-ghost:active::after,.wcm-outline{background-color:transparent}.wcm-ghost:active{opacity:.5}@media(hover:hover){button:hover::after{background-color:var(--wcm-color-overlay)}.wcm-ghost:hover::after{background-color:transparent}.wcm-ghost:hover{opacity:.5}}button:disabled{background-color:var(--wcm-color-bg-3);pointer-events:none}.wcm-ghost::after{border-color:transparent}.wcm-ghost path{fill:var(--wcm-color-fg-2)}.wcm-outline path{fill:var(--wcm-accent-color)}.wcm-outline:disabled{background-color:transparent;opacity:.5}`;
      var eP = Object.defineProperty,
        eR = Object.getOwnPropertyDescriptor,
        eL = (t, e, r, o) => {
          for (var i, n = o > 1 ? void 0 : o ? eR(e, r) : e, l = t.length - 1; l >= 0; l--)
            (i = t[l]) && (n = (o ? i(e, r, n) : i(n)) || n);
          return o && n && eP(e, r, n), n;
        };
      let eN = class extends tc {
        constructor() {
          super(...arguments),
            (this.disabled = !1),
        ...
        render() {
          ...
          return (
            ...
            z`<button class="${tv(t)}" ?disabled="${this.disabled}" @click="${this.onClick}">${this.iconLeft}<wcm-text variant="small-regular" color="${e}"><slot></slot></wcm-text>${this.iconRight}</button>`
          );
        }
      };
      (eN.styles = [eT.globalCss, eM]),
        eL([tp({ type: Boolean })], eN.prototype, 'disabled', 2),
        eL([tp()], eN.prototype, 'iconLeft', 2),
        eL([tp()], eN.prototype, 'iconRight', 2),
        eL([tp()], eN.prototype, 'onClick', 2),
        eL([tp()], eN.prototype, 'variant', 2),
        (eN = eL([th('wcm-button')], eN));
      let eS = d`:host{display:inline-block}button{padding:0 15px 1px;height:40px;border-radius:var(--wcm-button-border-radius);color:var(--wcm-accent-fill-color);background-color:var(--wcm-accent-color)}button::after{content:'';top:0;bottom:0;left:0;right:0;position:absolute;background-color:transparent;border-radius:inherit;transition:background-color .2s ease;border:1px solid var(--wcm-color-overlay)}button:active::after{background-color:var(--wcm-color-overlay)}button:disabled{padding-bottom:0;background-color:var(--wcm-color-bg-3);color:var(--wcm-color-fg-3)}.wcm-secondary{color:var(--wcm-accent-color);background-color:transparent}.wcm-secondary::after{display:none}@media(hover:hover){button:hover::after{background-color:var(--wcm-color-overlay)}}`;
      var ej = Object.defineProperty,
        eD = Object.getOwnPropertyDescriptor,
        eB = (t, e, r, o) => {
          for (var i, n = o > 1 ? void 0 : o ? eD(e, r) : e, l = t.length - 1; l >= 0; l--)
            (i = t[l]) && (n = (o ? i(e, r, n) : i(n)) || n);
          return o && n && ej(e, r, n), n;
        };
      let eU = class extends tc {
        constructor() {
          super(...arguments), (this.disabled = !1), (this.variant = 'primary');
        }
        render() {
          let t = { 'wcm-secondary': 'secondary' === this.variant };
          return z`<button ?disabled="${this.disabled}" class="${tv(t)}"><slot></slot></button>`;
        }
      };
      (eU.styles = [eT.globalCss, eS]),
        eB([tp({ type: Boolean })], eU.prototype, 'disabled', 2),
        eB([tp()], eU.prototype, 'variant', 2),
        (eU = eB([th('wcm-button-big')], eU));
      let eW = d`:host{background-color:var(--wcm-color-bg-2);border-top:1px solid var(--wcm-color-bg-3)}div{padding:10px 20px;display:inherit;flex-direction:inherit;align-items:inherit;width:inherit;justify-content:inherit}`;
      var eH = Object.defineProperty,
        ez = Object.getOwnPropertyDescriptor;
      let eZ = class extends tc {
        render() {
      ...
      (eZ.styles = [eT.globalCss, eW]),
        (eZ = ((t, e, r, o) => {
          for (var i, n = o > 1 ? void 0 : o ? ez(e, r) : e, l = t.length - 1; l >= 0; l--)
            (i = t[l]) && (n = (o ? i(e, r, n) : i(n)) || n);
          return o && n && eH(e, r, n), n;
        })([th('wcm-info-footer')], eZ));
      let eV = {
        ...
        eF = d`.wcm-toolbar-placeholder{top:0;bottom:0;left:0;right:0;width:100%;position:absolute;display:block;pointer-events:none;height:100px;border-radius:calc(var(--wcm-background-border-radius) * .9);background-color:var(--wcm-background-color);background-position:center;background-size:cover}.wcm-toolbar{height:38px;display:flex;position:relative;margin:5px 15px 5px 5px;justify-content:space-between;align-items:center}.wcm-toolbar img,.wcm-toolbar svg{height:28px;object-position:left center;object-fit:contain}#wcm-wc-logo path{fill:var(--wcm-accent-fill-color)}button{width:28px;height:28px;border-radius:var(--wcm-icon-button-border-radius);border:0;display:flex;justify-content:center;align-items:center;cursor:pointer;background-color:var(--wcm-color-bg-1);box-shadow:0 0 0 1px var(--wcm-color-overlay)}button:active{background-color:var(--wcm-color-bg-2)}button svg{display:block;object-position:center}button path{fill:var(--wcm-color-fg-1)}.wcm-toolbar div{display:flex}@media(hover:hover){button:hover{background-color:var(--wcm-color-bg-2)}}`;
      var eq = Object.defineProperty,
        eK = Object.getOwnPropertyDescriptor;
      let eY = class extends tc {
        render() {
          return z`<div class="wcm-toolbar-placeholder"></div><div class="wcm-toolbar">${eV.WALLET_CONNECT_LOGO} <button @click="${tC.D8.close}">${eV.CROSS_ICON}</button></div>`;
        }
      };
      (eY.styles = [eT.globalCss, eF]),
        (eY = ((t, e, r, o) => {
          for (var i, n = o > 1 ? void 0 : o ? eK(e, r) : e, l = t.length - 1; l >= 0; l--)
            (i = t[l]) && (n = (o ? i(e, r, n) : i(n)) || n);
          return o && n && eq(e, r, n), n;
        })([th('wcm-modal-backcard')], eY));
      let eQ = d`main{padding:20px;padding-top:0;width:100%}`;
      var eJ = Object.defineProperty,
        eG = Object.getOwnPropertyDescriptor;
      let eX = class extends tc {
        render() {
      ...
      (eX.styles = [eT.globalCss, eQ]),
        (eX = ((t, e, r, o) => {
          for (var i, n = o > 1 ? void 0 : o ? eG(e, r) : e, l = t.length - 1; l >= 0; l--)
            (i = t[l]) && (n = (o ? i(e, r, n) : i(n)) || n);
          return o && n && eJ(e, r, n), n;
        })([th('wcm-modal-content')], eX));
      let e0 = d`footer{padding:10px;display:flex;flex-direction:column;align-items:inherit;justify-content:inherit;border-top:1px solid var(--wcm-color-bg-2)}`;
      ...
      (e5.styles = [eT.globalCss, e0]),
        (e5 = ((t, e, r, o) => {
          for (var i, n = o > 1 ? void 0 : o ? e2(e, r) : e, l = t.length - 1; l >= 0; l--)
            (i = t[l]) && (n = (o ? i(e, r, n) : i(n)) || n);
          return o && n && e1(e, r, n), n;
        })([th('wcm-modal-footer')], e5));
      let e4 = d`header{display:flex;justify-content:center;align-items:center;padding:20px;position:relative}.wcm-border{border-bottom:1px solid var(--wcm-color-bg-2);margin-bottom:20px}header button{padding:15px 20px}header button:active{opacity:.5}@media(hover:hover){header button:hover{opacity:.5}}.wcm-back-btn{position:absolute;left:0}.wcm-action-btn{position:absolute;right:0}path{fill:var(--wcm-accent-color)}`;
      var e3 = Object.defineProperty,
        e7 = Object.getOwnPropertyDescriptor,
        e8 = (t, e, r, o) => {
          for (var i, n = o > 1 ? void 0 : o ? e7(e, r) : e, l = t.length - 1; l >= 0; l--)
            (i = t[l]) && (n = (o ? i(e, r, n) : i(n)) || n);
      ...
      let e6 = class extends tc {
        ...
        backBtnTemplate() {
          return z`<button class="wcm-back-btn" @click="${tC.jL.goBack}">${eV.BACK_ICON}</button>`;
        }
        actionBtnTemplate() {
        ...
        render() {
          let t = { 'wcm-border': this.border },
            e = tC.jL.state.history.length > 1,
            r = this.title
              ? z`<wcm-text variant="big-bold">${this.title}</wcm-text>`
              : z`<slot></slot>`;
          return z`<header class="${tv(t)}">${e ? this.backBtnTemplate() : null} ${r} ${this.onAction ? this.actionBtnTemplate() : null}</header>`;
        }
      };
      (e6.styles = [eT.globalCss, e4]),
        e8([tp()], e6.prototype, 'title', 2),
        e8([tp()], e6.prototype, 'onAction', 2),
        e8([tp()], e6.prototype, 'actionIcon', 2),
        e8([tp({ type: Boolean })], e6.prototype, 'border', 2),
        (e6 = e8([th('wcm-modal-header')], e6));
      let e9 = {
          ...
          getWalletIcon({ id: t, image_id: e }) {
            let { walletImages: r } = tC.mb.state;
            return (null == r ? void 0 : r[t]) ? r[t] : e ? tC.pV.getWalletImageUrl(e) : '';
          },
          ...
          handleMobileLinking(t, e = '_self') {
            let { walletConnectUri: r } = tC.IN.state,
              { mobile: o, name: i } = t,
            ...
            e9.setRecentWallet(t),
              r &&
                (function (t) {
                  if (n) {
                    let r = tC.Ao.formatNativeUrl(n, t, i);
                    tC.Ao.openHref(r, e);
                  } else if (l) {
                    let r = tC.Ao.formatUniversalUrl(l, t, i);
                    tC.Ao.openHref(r, e);
                  }
                })(r);
          },
          handleAndroidLinking() {
            let { walletConnectUri: t } = tC.IN.state;
            t &&
              (tC.Ao.setWalletConnectAndroidDeepLink(t),
              tC.Ao.openHref(t, tC.Ao.isTelegram() ? '_blank' : '_self'));
          },
          async handleUriCopy() {
            let { walletConnectUri: t } = tC.IN.state;
            if (t)
              try {
                await navigator.clipboard.writeText(t), tC.dC.openToast('Link copied', 'success');
              } catch (t) {
                tC.dC.openToast('Failed to copy', 'error');
              }
          },
          getCustomImageUrls() {
            let { walletImages: t } = tC.mb.state;
            return Object.values(Object.values(null != t ? t : {}));
          },
          truncate: (t, e = 8) =>
            t.length <= e ? t : `${t.substring(0, 4)}...${t.substring(t.length - 4)}`,
          setRecentWallet(t) {
            try {
              localStorage.setItem(e9.WCM_RECENT_WALLET_DATA, JSON.stringify(t));
            } catch (t) {
          ...
          openWalletExplorerUrl() {
            tC.Ao.openHref(e9.EXPLORER_WALLET_URL, '_blank');
          },
          getCachedRouterWalletPlatforms() {
            let { desktop: t, mobile: e } = tC.Ao.getWalletRouterData(),
              r = !!(null == t ? void 0 : t.native),
              o = !!(null == t ? void 0 : t.universal);
            return {
              isDesktop: r,
              isMobile: !!(null == e ? void 0 : e.native) || !!(null == e ? void 0 : e.universal),
              isWeb: o,
            };
          },
          goToConnectingView(t) {
            tC.jL.setData({ Wallet: t });
            let e = tC.Ao.isMobile(),
              { isDesktop: r, isWeb: o, isMobile: i } = e9.getCachedRouterWalletPlatforms();
            e
              ? i
                ? (tC.jL.push('MobileConnecting'),
                  !tC.Ao.isAndroid() && tC.Ao.isTelegram() && this.handleMobileLinking(t, '_blank'))
                : o
                  ? tC.jL.push('WebConnecting')
                  : tC.jL.push('InstallWallet')
              : r
                ? tC.jL.push('DesktopConnecting')
                : o
                  ? tC.jL.push('WebConnecting')
                  : i
                    ? tC.jL.push('MobileQrcodeConnecting')
                    : tC.jL.push('InstallWallet');
          },
        },
        rt = d`.wcm-router{overflow:hidden;will-change:transform}.wcm-content{display:flex;flex-direction:column}`;
      var re = Object.defineProperty,
        rr = Object.getOwnPropertyDescriptor,
        ro = (t, e, r, o) => {
          for (var i, n = o > 1 ? void 0 : o ? rr(e, r) : e, l = t.length - 1; l >= 0; l--)
            (i = t[l]) && (n = (o ? i(e, r, n) : i(n)) || n);
      ...
      let ri = class extends tc {
        constructor() {
          super(),
            (this.view = tC.jL.state.view),
            (this.prevView = tC.jL.state.view),
            (this.unsubscribe = void 0),
            (this.oldHeight = '0px'),
            (this.resizeObserver = void 0),
            (this.unsubscribe = tC.jL.subscribe((t) => {
        ...
        firstUpdated() {
          (this.resizeObserver = new ResizeObserver(([t]) => {
            ...
            '0px' !== this.oldHeight &&
              ey(this.routerEl, { height: [this.oldHeight, e] }, { duration: 0.2 }),
              (this.oldHeight = e);
          })),
      ...
      (ri.styles = [eT.globalCss, rt]),
        ro([tg()], ri.prototype, 'view', 2),
        ro([tg()], ri.prototype, 'prevView', 2),
        (ri = ro([th('wcm-modal-router')], ri));
      let rn = d`div{height:36px;width:max-content;display:flex;justify-content:center;align-items:center;padding:9px 15px 11px;position:absolute;top:12px;box-shadow:0 6px 14px -6px rgba(10,16,31,.3),0 10px 32px -4px rgba(10,16,31,.15);z-index:2;left:50%;transform:translateX(-50%);pointer-events:none;backdrop-filter:blur(20px) saturate(1.8);-webkit-backdrop-filter:blur(20px) saturate(1.8);border-radius:var(--wcm-notification-border-radius);border:1px solid var(--wcm-color-overlay);background-color:var(--wcm-color-overlay)}svg{margin-right:5px}@-moz-document url-prefix(){div{background-color:var(--wcm-color-bg-3)}}.wcm-success path{fill:var(--wcm-accent-color)}.wcm-error path{fill:var(--wcm-error-color)}`;
      var rl = Object.defineProperty,
        ra = Object.getOwnPropertyDescriptor,
        rs = (t, e, r, o) => {
          for (var i, n = o > 1 ? void 0 : o ? ra(e, r) : e, l = t.length - 1; l >= 0; l--)
            (i = t[l]) && (n = (o ? i(e, r, n) : i(n)) || n);
      ...
      let rc = class extends tc {
        constructor() {
          super(),
            ...
            (this.unsubscribe = void 0),
            (this.timeout = void 0),
            (this.unsubscribe = tC.dC.subscribe((t) => {
              t.open
                ? ((this.open = !0), (this.timeout = setTimeout(() => tC.dC.closeToast(), 2200)))
        ...
        render() {
          let { message: t, variant: e } = tC.dC.state;
          return this.open
            ? z`<div class="${tv({ 'wcm-success': 'success' === e, 'wcm-error': 'error' === e })}">${'success' === e ? eV.CHECKMARK_ICON : null} ${'error' === e ? eV.CROSS_ICON : null}<wcm-text variant="small-regular">${t}</wcm-text></div>`
            : null;
        }
      };
      function rd(t, e, r) {
      ...
      (rc.styles = [eT.globalCss, rn]),
        rs([tg()], rc.prototype, 'open', 2),
        (rc = rs([th('wcm-modal-toast')], rc));
      let rh = {
          generate(t, e, r) {
            let o = '#141414',
              i = [],
              n = (function (t, e) {
                let r = Array.prototype.slice.call(
                    e$.create(t, { errorCorrectionLevel: 'Q' }).modules.data,
                    0
                  ),
                  o = Math.sqrt(r.length);
                return r.reduce(
                  (t, e, r) => (r % o == 0 ? t.push([e]) : t[t.length - 1].push(e)) && t,
                  []
                );
              })(t, 0),
              l = e / n.length,
            ...
            a.forEach(({ x: t, y: e }) => {
              ...
              for (let t = 0; t < a.length; t += 1) {
                let e = l * (7 - 2 * t);
                i.push(
                  Z`<rect fill="${t % 2 == 0 ? o : '#ffffff'}" height="${e}" rx="${0.45 * e}" ry="${0.45 * e}" width="${e}" x="${r + l * t}" y="${s + l * t}">`
                );
              }
            });
            ...
            return (
              ...
              Object.entries(u)
                ...
                .forEach(([t, e]) => {
                  e.forEach((e) => {
                    i.push(Z`<circle cx="${t}" cy="${e}" fill="${o}" r="${l / 2.5}">`);
                  });
                }),
              Object.entries(u)
                ...
                .forEach(([t, e]) => {
                  e.forEach(([e, r]) => {
                    i.push(
                      Z`<line x1="${t}" x2="${t}" y1="${e}" y2="${r}" stroke="${o}" stroke-width="${l / 1.25}" stroke-linecap="round">`
                    );
                  });
                }),
              i
      ...
      var rm = Object.defineProperty,
        ...
        rg = (t, e, r, o) => {
          for (var i, n = o > 1 ? void 0 : o ? rp(e, r) : e, l = t.length - 1; l >= 0; l--)
            (i = t[l]) && (n = (o ? i(e, r, n) : i(n)) || n);
      ...
      let rf = class extends tc {
        ...
        svgTemplate() {
          let t = 'light' === tC.lH.state.themeMode ? this.size : this.size - 36;
          return Z`<svg height="${t}" width="${t}">${rh.generate(this.uri, t, t / 4)}</svg>`;
        }
        render() {
          let t = { 'wcm-dark': 'dark' === tC.lH.state.themeMode };
          return z`<div style="${`width: ${this.size}px`}" class="${tv(t)}">${this.walletId || this.imageUrl ? z`<wcm-wallet-image walletId="${ex(this.walletId)}" imageId="${ex(this.imageId)}" imageUrl="${ex(this.imageUrl)}"></wcm-wallet-image>` : eV.WALLET_CONNECT_ICON_COLORED} ${this.svgTemplate()}</div>`;
        }
      };
      (rf.styles = [eT.globalCss, ru]),
        rg([tp()], rf.prototype, 'uri', 2),
        rg([tp({ type: Number })], rf.prototype, 'size', 2),
        rg([tp()], rf.prototype, 'imageId', 2),
        rg([tp()], rf.prototype, 'walletId', 2),
        rg([tp()], rf.prototype, 'imageUrl', 2),
        (rf = rg([th('wcm-qrcode')], rf));
      let rw = d`:host{position:relative;height:28px;width:80%}input{width:100%;height:100%;line-height:28px!important;border-radius:var(--wcm-input-border-radius);font-style:normal;font-family:-apple-system,system-ui,BlinkMacSystemFont,'Segoe UI',Roboto,Ubuntu,'Helvetica Neue',sans-serif;font-feature-settings:'case' on;font-weight:500;font-size:16px;letter-spacing:-.03em;padding:0 10px 0 34px;transition:.2s all ease;color:var(--wcm-color-fg-1);background-color:var(--wcm-color-bg-3);box-shadow:inset 0 0 0 1px var(--wcm-color-overlay);caret-color:var(--wcm-accent-color)}input::placeholder{color:var(--wcm-color-fg-2)}svg{left:10px;top:4px;pointer-events:none;position:absolute;width:20px;height:20px}input:focus-within{box-shadow:inset 0 0 0 1px var(--wcm-accent-color)}path{fill:var(--wcm-color-fg-2)}`;
      var rv = Object.defineProperty,
        rb = Object.getOwnPropertyDescriptor,
        ry = (t, e, r, o) => {
          for (var i, n = o > 1 ? void 0 : o ? rb(e, r) : e, l = t.length - 1; l >= 0; l--)
            (i = t[l]) && (n = (o ? i(e, r, n) : i(n)) || n);
          return o && n && rv(e, r, n), n;
        };
      let rx = class extends tc {
        constructor() {
      ...
      (rx.styles = [eT.globalCss, rw]),
        ry([tp()], rx.prototype, 'onChange', 2),
        (rx = ry([th('wcm-search-input')], rx));
      let r$ = d`@keyframes rotate{100%{transform:rotate(360deg)}}@keyframes dash{0%{stroke-dasharray:1,150;stroke-dashoffset:0}50%{stroke-dasharray:90,150;stroke-dashoffset:-35}100%{stroke-dasharray:90,150;stroke-dashoffset:-124}}svg{animation:rotate 2s linear infinite;display:flex;justify-content:center;align-items:center}svg circle{stroke-linecap:round;animation:dash 1.5s ease infinite;stroke:var(--wcm-accent-color)}`;
      ...
      (rE.styles = [eT.globalCss, r$]),
        (rE = ((t, e, r, o) => {
          for (var i, n = o > 1 ? void 0 : o ? rC(e, r) : e, l = t.length - 1; l >= 0; l--)
            (i = t[l]) && (n = (o ? i(e, r, n) : i(n)) || n);
          return o && n && rA(e, r, n), n;
        })([th('wcm-spinner')], rE));
      ...
      var rk = Object.defineProperty,
        ...
        rI = (t, e, r, o) => {
          for (var i, n = o > 1 ? void 0 : o ? rO(e, r) : e, l = t.length - 1; l >= 0; l--)
            (i = t[l]) && (n = (o ? i(e, r, n) : i(n)) || n);
          return o && n && rk(e, r, n), n;
        };
      let rT = class extends tc {
        constructor() {
        ...
        render() {
          ...
          return z`<span><slot class="${tv(t)}"></slot></span>`;
        }
      };
      (rT.styles = [eT.globalCss, r_]),
        rI([tp()], rT.prototype, 'variant', 2),
        rI([tp()], rT.prototype, 'color', 2),
        (rT = rI([th('wcm-text')], rT));
      let rM = d`button{width:100%;height:100%;border-radius:var(--wcm-button-hover-highlight-border-radius);display:flex;align-items:flex-start}button:active{background-color:var(--wcm-color-overlay)}@media(hover:hover){button:hover{background-color:var(--wcm-color-overlay)}}button>div{width:80px;padding:5px 0;display:flex;flex-direction:column;align-items:center}wcm-text{width:100%;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;text-align:center}wcm-wallet-image{height:60px;width:60px;transition:all .2s ease;border-radius:var(--wcm-wallet-icon-border-radius);margin-bottom:5px}.wcm-sublabel{margin-top:2px}`;
      ...
      let rN = class extends tc {
        ...
        handleClick() {
          tC.vZ.click({ name: 'WALLET_BUTTON', walletId: this.walletId }), this.onClick();
        }
        render() {
          var t;
          return z`<button @click="${this.handleClick.bind(this)}"><div><wcm-wallet-image walletId="${this.walletId}" imageId="${ex(this.imageId)}"></wcm-wallet-image><wcm-text variant="xsmall-regular">${null != (t = this.label) ? t : e9.getWalletName(this.name, !0)}</wcm-text>${this.sublabelTemplate()}</div></button>`;
        }
      };
      (rN.styles = [eT.globalCss, rM]),
        rL([tp()], rN.prototype, 'onClick', 2),
        rL([tp()], rN.prototype, 'name', 2),
        rL([tp()], rN.prototype, 'walletId', 2),
        rL([tp()], rN.prototype, 'label', 2),
        rL([tp()], rN.prototype, 'imageId', 2),
        rL([tp({ type: Boolean })], rN.prototype, 'installed', 2),
        rL([tp({ type: Boolean })], rN.prototype, 'recent', 2),
        (rN = rL([th('wcm-wallet-button')], rN));
      let rS = d`:host{display:block}div{overflow:hidden;position:relative;border-radius:inherit;width:100%;height:100%;background-color:var(--wcm-color-overlay)}svg{position:relative;width:100%;height:100%}div::after{content:'';position:absolute;top:0;bottom:0;left:0;right:0;border-radius:inherit;border:1px solid var(--wcm-color-overlay)}div img{width:100%;height:100%;object-fit:cover;object-position:center}#wallet-placeholder-fill{fill:var(--wcm-color-bg-3)}#wallet-placeholder-dash{stroke:var(--wcm-color-overlay)}`;
      var rj = Object.defineProperty,
        rD = Object.getOwnPropertyDescriptor,
        rB = (t, e, r, o) => {
          for (var i, n = o > 1 ? void 0 : o ? rD(e, r) : e, l = t.length - 1; l >= 0; l--)
            (i = t[l]) && (n = (o ? i(e, r, n) : i(n)) || n);
          return o && n && rj(e, r, n), n;
        };
      let rU = class extends tc {
        constructor() {
          super(...arguments),
            (this.walletId = ''),
            (this.imageId = void 0),
        ...
        render() {
          ...
          return z`${e.length ? z`<div><img crossorigin="anonymous" src="${e}" alt="${this.id}"></div>` : eV.WALLET_PLACEHOLDER}`;
        }
      };
      (rU.styles = [eT.globalCss, rS]),
        rB([tp()], rU.prototype, 'walletId', 2),
        rB([tp()], rU.prototype, 'imageId', 2),
        rB([tp()], rU.prototype, 'imageUrl', 2),
        (rU = rB([th('wcm-wallet-image')], rU));
      var rW = Object.defineProperty,
        rH = Object.getOwnPropertyDescriptor,
        rz = (t, e, r, o) => {
          for (var i, n = o > 1 ? void 0 : o ? rH(e, r) : e, l = t.length - 1; l >= 0; l--)
            (i = t[l]) && (n = (o ? i(e, r, n) : i(n)) || n);
          return o && n && rW(e, r, n), n;
        };
      let rZ = class extends tc {
        constructor() {
        ...
        async preloadListings() {
          if (tC.mb.state.enableExplorer) {
            await tC.pV.getRecomendedWallets(), tC.IN.setIsDataLoaded(!0);
            let { recomendedWallets: t } = tC.pV.state,
              e = t.map((t) => e9.getWalletIcon(t));
            await this.loadImages(e);
          } else tC.IN.setIsDataLoaded(!0);
        }
        ...
        async preloadData() {
          try {
            ...
            console.error(t), tC.dC.openToast('Failed preloading', 'error');
          }
        }
      };
      rz([tg()], rZ.prototype, 'preload', 2), (rZ = rz([th('wcm-explorer-context')], rZ));
      var rV = Object.defineProperty,
        rF = Object.getOwnPropertyDescriptor;
      let rq = class extends tc {
        constructor() {
          super(),
            (this.unsubscribeTheme = void 0),
            eT.setTheme(),
            (this.unsubscribeTheme = tC.lH.subscribe(eT.setTheme));
        }
        disconnectedCallback() {
          var t;
      ...
      rq = ((t, e, r, o) => {
        for (var i, n = o > 1 ? void 0 : o ? rF(e, r) : e, l = t.length - 1; l >= 0; l--)
          (i = t[l]) && (n = (o ? i(e, r, n) : i(n)) || n);
        return o && n && rV(e, r, n), n;
      })([th('wcm-theme-context')], rq);
      ...
      let rJ = class extends tc {
        ...
        render() {
          let { recomendedWallets: t } = tC.pV.state,
            e = [...t, ...t],
            r = 2 * tC.Ao.RECOMMENDED_WALLET_AMOUNT;
          return z`<wcm-modal-header title="Connect your wallet" .onAction="${this.onGoToQrcode}" .actionIcon="${eV.QRCODE_ICON}"></wcm-modal-header><wcm-modal-content><div class="wcm-title">${eV.MOBILE_ICON}<wcm-text variant="small-regular" color="accent">WalletConnect</wcm-text></div><div class="wcm-slider"><div class="wcm-track">${[
            ...Array(r),
          ].map((t, r) => {
            let o = e[r % e.length];
            return o
          ...
          })}</div><wcm-button-big @click="${e9.handleAndroidLinking}"><wcm-text variant="medium-regular" color="inverse">Select Wallet</wcm-text></wcm-button-big></div></wcm-modal-content><wcm-info-footer><wcm-text color="secondary" variant="small-thin">Choose WalletConnect to see supported apps on your device</wcm-text></wcm-info-footer>`;
        }
      };
      (rJ.styles = [eT.globalCss, rK]),
        (rJ = ((t, e, r, o) => {
          for (var i, n = o > 1 ? void 0 : o ? rQ(e, r) : e, l = t.length - 1; l >= 0; l--)
            (i = t[l]) && (n = (o ? i(e, r, n) : i(n)) || n);
      ...
      var rX = Object.defineProperty,
        ...
        r1 = (t, e, r, o) => {
          for (var i, n = o > 1 ? void 0 : o ? r0(e, r) : e, l = t.length - 1; l >= 0; l--)
            (i = t[l]) && (n = (o ? i(e, r, n) : i(n)) || n);
          return o && n && rX(e, r, n), n;
        };
      let r2 = class extends tc {
        constructor() {
          super(...arguments),
            (this.walletId = void 0),
            (this.imageId = void 0),
        ...
        svgLoaderTemplate() {
          ...
          let r =
              null !=
              (e =
                null == (t = tC.lH.state.themeVariables)
                  ? void 0
        ...
        render() {
          ...
          return z`<div class="${tv(t)}">${this.svgLoaderTemplate()}<wcm-wallet-image walletId="${ex(this.walletId)}" imageId="${ex(this.imageId)}"></wcm-wallet-image></div><wcm-text variant="medium-regular" color="${this.isError ? 'error' : 'primary'}">${this.isError ? 'Connection declined' : this.label}</wcm-text>`;
        }
      };
      (r2.styles = [eT.globalCss, rG]),
        r1([tp()], r2.prototype, 'walletId', 2),
        r1([tp()], r2.prototype, 'imageId', 2),
        r1([tp({ type: Boolean })], r2.prototype, 'isError', 2),
        r1([tp({ type: Boolean })], r2.prototype, 'isStale', 2),
        r1([tp()], r2.prototype, 'label', 2),
        (r2 = r1([th('wcm-connector-waiting')], r2));
      let r5 = {
          manualWallets() {
            var t, e;
            let { mobileWallets: r, desktopWallets: o } = tC.mb.state,
              i = null == (t = r5.recentWallet()) ? void 0 : t.id,
              n = tC.Ao.isMobile() ? r : o,
              l = null == n ? void 0 : n.filter((t) => i !== t.id);
            return null !=
              (e = tC.Ao.isMobile()
                ? null == l
                  ? void 0
          ...
          recomendedWallets(t = !1) {
            var e;
            let r = t ? void 0 : null == (e = r5.recentWallet()) ? void 0 : e.id,
              { recomendedWallets: o } = tC.pV.state;
        ...
        r4 = {
          ...
          manualWalletsTemplate() {
            return r5
              ...
              .map(
                (t) =>
                  z`<wcm-wallet-button walletId="${t.id}" name="${t.name}" .onClick="${() => this.onConnecting(t)}"></wcm-wallet-button>`
              );
          },
          recomendedWalletsTemplate(t = !1) {
            return r5
              ...
              .map(
                (t) =>
                  z`<wcm-wallet-button name="${t.name}" walletId="${t.id}" imageId="${t.image_id}" .onClick="${() => this.onConnecting(t)}"></wcm-wallet-button>`
              );
          },
          recentWalletTemplate() {
            let t = r5.recentWallet();
            if (t)
              return z`<wcm-wallet-button name="${t.name}" walletId="${t.id}" imageId="${ex(t.image_id)}" .recent="${!0}" .onClick="${() => this.onConnecting(t)}"></wcm-wallet-button>`;
          },
        },
      ...
      let r6 = class extends tc {
        render() {
          let { explorerExcludedWalletIds: t, enableExplorer: e } = tC.mb.state,
          ...
          return z`<wcm-modal-header .border="${!0}" title="Connect your wallet" .onAction="${e9.handleUriCopy}" .actionIcon="${eV.COPY_ICON}"></wcm-modal-header><wcm-modal-content><div class="wcm-mobile-title"><div class="wcm-subtitle">${eV.MOBILE_ICON}<wcm-text variant="small-regular" color="accent">Mobile</wcm-text></div><div class="wcm-subtitle">${eV.SCAN_ICON}<wcm-text variant="small-regular" color="secondary">Scan with your wallet</wcm-text></div></div><wcm-walletconnect-qr></wcm-walletconnect-qr></wcm-modal-content>${a ? z`<wcm-modal-footer><div class="wcm-desktop-title">${eV.DESKTOP_ICON}<wcm-text variant="small-regular" color="accent">Desktop</wcm-text></div><div class="wcm-grid">${l} ${n ? z`<wcm-view-all-wallets-button></wcm-view-all-wallets-button>` : null}</div></wcm-modal-footer>` : null}`;
        }
      };
      (r6.styles = [eT.globalCss, r3]),
        (r6 = ((t, e, r, o) => {
          for (var i, n = o > 1 ? void 0 : o ? r8(e, r) : e, l = t.length - 1; l >= 0; l--)
            (i = t[l]) && (n = (o ? i(e, r, n) : i(n)) || n);
          return o && n && r7(e, r, n), n;
        })([th('wcm-desktop-wallet-selection')], r6));
      let r9 = d`div{background-color:var(--wcm-color-bg-2);padding:10px 20px 15px 20px;border-top:1px solid var(--wcm-color-bg-3);text-align:center}a{color:var(--wcm-accent-color);text-decoration:none;transition:opacity .2s ease-in-out;display:inline}a:active{opacity:.8}@media(hover:hover){a:hover{opacity:.8}}`;
      var ot = Object.defineProperty,
        oe = Object.getOwnPropertyDescriptor;
      let or = class extends tc {
        render() {
          let { termsOfServiceUrl: t, privacyPolicyUrl: e } = tC.mb.state;
          return (null != t ? t : e)
            ? z`<div><wcm-text variant="small-regular" color="secondary">By connecting your wallet to this app, you agree to the app's ${t ? z`<a href="${t}" target="_blank" rel="noopener noreferrer">Terms of Service</a>` : null} ${t && e ? 'and' : null} ${e ? z`<a href="${e}" target="_blank" rel="noopener noreferrer">Privacy Policy</a>` : null}</wcm-text></div>`
            : null;
        }
      };
      (or.styles = [eT.globalCss, r9]),
        (or = ((t, e, r, o) => {
          for (var i, n = o > 1 ? void 0 : o ? oe(e, r) : e, l = t.length - 1; l >= 0; l--)
            (i = t[l]) && (n = (o ? i(e, r, n) : i(n)) || n);
          return o && n && ot(e, r, n), n;
        })([th('wcm-legal-notice')], or));
      let oo = d`div{display:grid;grid-template-columns:repeat(4,80px);margin:0 -10px;justify-content:space-between;row-gap:10px}`;
      ...
      let ol = class extends tc {
        ...
        render() {
          ...
          return z`<wcm-modal-header title="Connect your wallet" .onAction="${this.onQrcode}" .actionIcon="${eV.QRCODE_ICON}"></wcm-modal-header>${a ? z`<wcm-modal-content><div>${l} ${n ? z`<wcm-view-all-wallets-button></wcm-view-all-wallets-button>` : null}</div></wcm-modal-content>` : null}`;
        }
      };
      (ol.styles = [eT.globalCss, oo]),
        (ol = ((t, e, r, o) => {
          for (var i, n = o > 1 ? void 0 : o ? on(e, r) : e, l = t.length - 1; l >= 0; l--)
            (i = t[l]) && (n = (o ? i(e, r, n) : i(n)) || n);
          return o && n && oi(e, r, n), n;
        })([th('wcm-mobile-wallet-selection')], ol));
      ...
      var os = Object.defineProperty,
        ...
        od = (t, e, r, o) => {
          for (var i, n = o > 1 ? void 0 : o ? oc(e, r) : e, l = t.length - 1; l >= 0; l--)
            (i = t[l]) && (n = (o ? i(e, r, n) : i(n)) || n);
          return o && n && os(e, r, n), n;
        };
      let oh = class extends tc {
        constructor() {
          super(),
            (this.open = !1),
            (this.active = !1),
            ...
            (this.unsubscribeModal = tC.D8.subscribe((t) => {
        ...
        onCloseModal(t) {
          t.target === t.currentTarget && tC.D8.close();
        }
        onOpenModalEvent() {
          this.toggleBodyScroll(!1),
            ...
            (this.open = !0),
            setTimeout(async () => {
              let t = e9.isMobileAnimation() ? { y: ['50vh', '0vh'] } : { scale: [0.98, 1] };
              await Promise.all([
                ey(this.overlayEl, { opacity: [0, 1] }, { delay: 0.1, duration: 0.2 }).finished,
        ...
        async onCloseModalEvent() {
          ...
          let t = e9.isMobileAnimation() ? { y: ['0vh', '50vh'] } : { scale: [1, 0.98] };
          await Promise.all([
            ...
            window.addEventListener(
              ...
              (t) => {
                ...
                'Escape' === t.key
                  ? tC.D8.close()
                  : 'Tab' !== t.key ||
                    (null == (e = t.target) ? void 0 : e.tagName.includes('wcm-')) ||
        ...
        render() {
          ...
          return z`<wcm-explorer-context></wcm-explorer-context><wcm-theme-context></wcm-theme-context><div id="wcm-modal" class="${tv(t)}" @click="${this.onCloseModal}" role="alertdialog" aria-modal="true"><div class="wcm-container" tabindex="0">${this.open ? z`<wcm-modal-backcard></wcm-modal-backcard><div class="wcm-card"><wcm-modal-router></wcm-modal-router><wcm-modal-toast></wcm-modal-toast></div>` : null}</div></div>`;
        }
      };
      (oh.styles = [eT.globalCss, oa]),
        od([tg()], oh.prototype, 'open', 2),
        od([tg()], oh.prototype, 'active', 2),
        (oh = od([th('wcm-modal')], oh));
      let ou = d`div{display:flex;margin-top:15px}slot{display:inline-block;margin:0 5px}wcm-button{margin:0 5px}`;
      var om = Object.defineProperty,
        op = Object.getOwnPropertyDescriptor,
        og = (t, e, r, o) => {
          for (var i, n = o > 1 ? void 0 : o ? op(e, r) : e, l = t.length - 1; l >= 0; l--)
            (i = t[l]) && (n = (o ? i(e, r, n) : i(n)) || n);
          return o && n && om(e, r, n), n;
        };
      let of = class extends tc {
        constructor() {
          super(...arguments),
            (this.isMobile = !1),
            (this.isDesktop = !1),
        ...
        onMobile() {
          tC.Ao.isMobile()
            ? tC.jL.replace('MobileConnecting')
            : tC.jL.replace('MobileQrcodeConnecting');
        }
        onDesktop() {
          tC.jL.replace('DesktopConnecting');
        }
        onWeb() {
          tC.jL.replace('WebConnecting');
        }
        render() {
          return z`<div>${this.isRetry ? z`<slot></slot>` : null} ${this.isMobile ? z`<wcm-button .onClick="${this.onMobile}" .iconLeft="${eV.MOBILE_ICON}" variant="outline">Mobile</wcm-button>` : null} ${this.isDesktop ? z`<wcm-button .onClick="${this.onDesktop}" .iconLeft="${eV.DESKTOP_ICON}" variant="outline">Desktop</wcm-button>` : null} ${this.isWeb ? z`<wcm-button .onClick="${this.onWeb}" .iconLeft="${eV.GLOBE_ICON}" variant="outline">Web</wcm-button>` : null}</div>`;
        }
      };
      (of.styles = [eT.globalCss, ou]),
        og([tp({ type: Boolean })], of.prototype, 'isMobile', 2),
        og([tp({ type: Boolean })], of.prototype, 'isDesktop', 2),
        og([tp({ type: Boolean })], of.prototype, 'isWeb', 2),
        og([tp({ type: Boolean })], of.prototype, 'isRetry', 2),
        (of = og([th('wcm-platform-selection')], of));
      let ow = d`button{display:flex;flex-direction:column;padding:5px 10px;border-radius:var(--wcm-button-hover-highlight-border-radius);height:100%;justify-content:flex-start}.wcm-icons{width:60px;height:60px;display:flex;flex-wrap:wrap;padding:7px;border-radius:var(--wcm-wallet-icon-border-radius);justify-content:space-between;align-items:center;margin-bottom:5px;background-color:var(--wcm-color-bg-2);box-shadow:inset 0 0 0 1px var(--wcm-color-overlay)}button:active{background-color:var(--wcm-color-overlay)}@media(hover:hover){button:hover{background-color:var(--wcm-color-overlay)}}.wcm-icons img{width:21px;height:21px;object-fit:cover;object-position:center;border-radius:calc(var(--wcm-wallet-icon-border-radius)/ 2);border:1px solid var(--wcm-color-overlay)}.wcm-icons svg{width:21px;height:21px}.wcm-icons img:nth-child(1),.wcm-icons img:nth-child(2),.wcm-icons svg:nth-child(1),.wcm-icons svg:nth-child(2){margin-bottom:4px}wcm-text{width:100%;text-align:center}#wallet-placeholder-fill{fill:var(--wcm-color-bg-3)}#wallet-placeholder-dash{stroke:var(--wcm-color-overlay)}`;
      var ov = Object.defineProperty,
        ob = Object.getOwnPropertyDescriptor;
      let oy = class extends tc {
        onClick() {
          tC.jL.push('WalletExplorer');
        }
        render() {
          let { recomendedWallets: t } = tC.pV.state,
            e = [...t, ...r5.manualWallets()].reverse().slice(0, 4);
          return z`<button @click="${this.onClick}"><div class="wcm-icons">${e.map((t) => {
            let e = e9.getWalletIcon(t);
            if (e) return z`<img crossorigin="anonymous" src="${e}">`;
            let r = e9.getWalletIcon({ id: t.id });
            return r ? z`<img crossorigin="anonymous" src="${r}">` : eV.WALLET_PLACEHOLDER;
          })} ${[...Array(4 - e.length)].map(() => eV.WALLET_PLACEHOLDER)}</div><wcm-text variant="xsmall-regular">View All</wcm-text></button>`;
        }
      };
      (oy.styles = [eT.globalCss, ow]),
        (oy = ((t, e, r, o) => {
          for (var i, n = o > 1 ? void 0 : o ? ob(e, r) : e, l = t.length - 1; l >= 0; l--)
            (i = t[l]) && (n = (o ? i(e, r, n) : i(n)) || n);
          return o && n && ov(e, r, n), n;
        })([th('wcm-view-all-wallets-button')], oy));
      let ox = d`.wcm-qr-container{width:100%;display:flex;justify-content:center;align-items:center;aspect-ratio:1/1}`;
      var o$ = Object.defineProperty,
        oA = Object.getOwnPropertyDescriptor,
        oC = (t, e, r, o) => {
          for (var i, n = o > 1 ? void 0 : o ? oA(e, r) : e, l = t.length - 1; l >= 0; l--)
            (i = t[l]) && (n = (o ? i(e, r, n) : i(n)) || n);
      ...
      let oE = class extends tc {
        ...
        render() {
          return z`<div class="wcm-qr-container">${this.uri ? z`<wcm-qrcode size="${this.overlayEl.offsetWidth}" uri="${this.uri}" walletId="${ex(this.walletId)}" imageId="${ex(this.imageId)}"></wcm-qrcode>` : z`<wcm-spinner></wcm-spinner>`}</div>`;
        }
      };
      (oE.styles = [eT.globalCss, ox]),
        oC([tp()], oE.prototype, 'walletId', 2),
        oC([tp()], oE.prototype, 'imageId', 2),
        oC([tg()], oE.prototype, 'uri', 2),
        (oE = oC([th('wcm-walletconnect-qr')], oE));
      var o_ = Object.defineProperty,
        ok = Object.getOwnPropertyDescriptor;
      let oO = class extends tc {
        viewTemplate() {
          return tC.Ao.isAndroid() && !tC.Ao.isTelegram()
      ...
      (oO.styles = [eT.globalCss]),
        (oO = ((t, e, r, o) => {
          for (var i, n = o > 1 ? void 0 : o ? ok(e, r) : e, l = t.length - 1; l >= 0; l--)
            (i = t[l]) && (n = (o ? i(e, r, n) : i(n)) || n);
          return o && n && o_(e, r, n), n;
        })([th('wcm-connect-wallet-view')], oO));
      let oI = d`wcm-info-footer{flex-direction:column;align-items:center;display:flex;width:100%;padding:5px 0}wcm-text{text-align:center}`;
      var oT = Object.defineProperty,
        oM = Object.getOwnPropertyDescriptor,
        oP = (t, e, r, o) => {
          for (var i, n = o > 1 ? void 0 : o ? oM(e, r) : e, l = t.length - 1; l >= 0; l--)
            (i = t[l]) && (n = (o ? i(e, r, n) : i(n)) || n);
          return o && n && oT(e, r, n), n;
        };
      let oR = class extends tc {
        ...
        onFormatAndRedirect(t) {
          let { desktop: e, name: r } = tC.Ao.getWalletRouterData(),
            o = null == e ? void 0 : e.native,
            i = null == e ? void 0 : e.universal;
          if (o) {
            let e = tC.Ao.formatNativeUrl(o, t, r);
            tC.Ao.openHref(e, '_self');
          } else if (i) {
            let e = tC.Ao.formatUniversalUrl(i, t, r);
            tC.Ao.openHref(e, '_blank');
          }
        }
        openDesktopApp() {
          let { walletConnectUri: t } = tC.IN.state,
            e = tC.Ao.getWalletRouterData();
          e9.setRecentWallet(e), t && this.onFormatAndRedirect(t);
        }
        render() {
          let { name: t, id: e, image_id: r } = tC.Ao.getWalletRouterData(),
            { isMobile: o, isWeb: i } = e9.getCachedRouterWalletPlatforms();
          return z`<wcm-modal-header title="${t}" .onAction="${e9.handleUriCopy}" .actionIcon="${eV.COPY_ICON}"></wcm-modal-header><wcm-modal-content><wcm-connector-waiting walletId="${e}" imageId="${ex(r)}" label="${`Continue in ${t}...`}" .isError="${this.isError}"></wcm-connector-waiting></wcm-modal-content><wcm-info-footer><wcm-text color="secondary" variant="small-thin">${`Connection can continue loading if ${t} is not installed on your device`}</wcm-text><wcm-platform-selection .isMobile="${o}" .isWeb="${i}" .isRetry="${!0}"><wcm-button .onClick="${this.openDesktopApp.bind(this)}" .iconRight="${eV.RETRY_ICON}">Retry</wcm-button></wcm-platform-selection></wcm-info-footer>`;
        }
      };
      (oR.styles = [eT.globalCss, oI]),
        oP([tg()], oR.prototype, 'isError', 2),
        (oR = oP([th('wcm-desktop-connecting-view')], oR));
      let oL = d`wcm-info-footer{flex-direction:column;align-items:center;display:flex;width:100%;padding:5px 0}wcm-text{text-align:center}wcm-button{margin-top:15px}`;
      var oN = Object.defineProperty,
        oS = Object.getOwnPropertyDescriptor;
      let oj = class extends tc {
        onInstall(t) {
          t && tC.Ao.openHref(t, '_blank');
        }
        render() {
          let { name: t, id: e, image_id: r, homepage: o } = tC.Ao.getWalletRouterData();
          return z`<wcm-modal-header title="${t}"></wcm-modal-header><wcm-modal-content><wcm-connector-waiting walletId="${e}" imageId="${ex(r)}" label="Not Detected" .isStale="${!0}"></wcm-connector-waiting></wcm-modal-content><wcm-info-footer><wcm-text color="secondary" variant="small-thin">${`Download ${t} to continue. If multiple browser extensions are installed, disable non ${t} ones and try again`}</wcm-text><wcm-button .onClick="${() => this.onInstall(o)}" .iconLeft="${eV.ARROW_DOWN_ICON}">Download</wcm-button></wcm-info-footer>`;
        }
      };
      (oj.styles = [eT.globalCss, oL]),
        (oj = ((t, e, r, o) => {
          for (var i, n = o > 1 ? void 0 : o ? oS(e, r) : e, l = t.length - 1; l >= 0; l--)
            (i = t[l]) && (n = (o ? i(e, r, n) : i(n)) || n);
          return o && n && oN(e, r, n), n;
        })([th('wcm-install-wallet-view')], oj));
      ...
      var oB = Object.defineProperty,
        ...
        oW = (t, e, r, o) => {
          for (var i, n = o > 1 ? void 0 : o ? oU(e, r) : e, l = t.length - 1; l >= 0; l--)
            (i = t[l]) && (n = (o ? i(e, r, n) : i(n)) || n);
      ...
      let oH = class extends tc {
        ...
        onFormatAndRedirect(t, e = !1) {
          let { mobile: r, name: o } = tC.Ao.getWalletRouterData(),
            i = null == r ? void 0 : r.native,
            n = null == r ? void 0 : r.universal,
            l = tC.Ao.isTelegram() ? '_blank' : '_self';
          if (
            ((t = tC.Ao.isTelegram() && tC.Ao.isAndroid() ? encodeURIComponent(t) : t), i && !e)
          ) {
            let e = tC.Ao.formatNativeUrl(i, t, o);
            tC.Ao.openHref(e, l);
          } else if (n) {
            let e = tC.Ao.formatUniversalUrl(n, t, o);
            tC.Ao.openHref(e, l);
          }
        }
        openMobileApp(t = !1) {
          let { walletConnectUri: e } = tC.IN.state,
            r = tC.Ao.getWalletRouterData();
          e && this.onFormatAndRedirect(e, t), e9.setRecentWallet(r);
        }
        onGoToAppStore(t) {
          t && tC.Ao.openHref(t, '_blank');
        }
        render() {
          let { name: t, id: e, image_id: r, app: o, mobile: i } = tC.Ao.getWalletRouterData(),
            { isWeb: n } = e9.getCachedRouterWalletPlatforms(),
            l = null == o ? void 0 : o.ios,
            a = null == i ? void 0 : i.universal;
          return z`<wcm-modal-header title="${t}"></wcm-modal-header><wcm-modal-content><wcm-connector-waiting walletId="${e}" imageId="${ex(r)}" label="Tap 'Open' to continue…" .isError="${this.isError}"></wcm-connector-waiting></wcm-modal-content><wcm-info-footer class="wcm-note"><wcm-platform-selection .isWeb="${n}" .isRetry="${!0}"><wcm-button .onClick="${() => this.openMobileApp(!1)}" .iconRight="${eV.RETRY_ICON}">Retry</wcm-button></wcm-platform-selection>${a ? z`<wcm-text color="secondary" variant="small-thin">Still doesn't work? <span tabindex="0" @click="${() => this.openMobileApp(!0)}">Try this alternate link</span></wcm-text>` : null}</wcm-info-footer><wcm-info-footer class="wcm-app-store"><div><wcm-wallet-image walletId="${e}" imageId="${ex(r)}"></wcm-wallet-image><wcm-text>${`Get ${t}`}</wcm-text></div><wcm-button .iconRight="${eV.ARROW_RIGHT_ICON}" .onClick="${() => this.onGoToAppStore(l)}" variant="ghost">App Store</wcm-button></wcm-info-footer>`;
        }
      };
      (oH.styles = [eT.globalCss, oD]),
        oW([tg()], oH.prototype, 'isError', 2),
        (oH = oW([th('wcm-mobile-connecting-view')], oH));
      ...
      (oF.styles = [eT.globalCss, oz]),
        (oF = ((t, e, r, o) => {
          for (var i, n = o > 1 ? void 0 : o ? oV(e, r) : e, l = t.length - 1; l >= 0; l--)
            (i = t[l]) && (n = (o ? i(e, r, n) : i(n)) || n);
          return o && n && oZ(e, r, n), n;
        })([th('wcm-mobile-qr-connecting-view')], oF));
      ...
      (oY.styles = [eT.globalCss]),
        ...
        })([th('wcm-qrcode-view')], oY));
      let oQ = d`wcm-modal-content{height:clamp(200px,60vh,600px);display:block;overflow:scroll;scrollbar-width:none;position:relative;margin-top:1px}.wcm-grid{display:grid;grid-template-columns:repeat(4,80px);justify-content:space-between;margin:-15px -10px;padding-top:20px}wcm-modal-content::after,wcm-modal-content::before{content:'';position:fixed;pointer-events:none;z-index:1;width:100%;height:20px;opacity:1}wcm-modal-content::before{box-shadow:0 -1px 0 0 var(--wcm-color-bg-1);background:linear-gradient(var(--wcm-color-bg-1),rgba(255,255,255,0))}wcm-modal-content::after{box-shadow:0 1px 0 0 var(--wcm-color-bg-1);background:linear-gradient(rgba(255,255,255,0),var(--wcm-color-bg-1));top:calc(100% - 20px)}wcm-modal-content::-webkit-scrollbar{display:none}.wcm-placeholder-block{display:flex;justify-content:center;align-items:center;height:100px;overflow:hidden}.wcm-empty,.wcm-loading{display:flex}.wcm-loading .wcm-placeholder-block{height:100%}.wcm-end-reached .wcm-placeholder-block{height:0;opacity:0}.wcm-empty .wcm-placeholder-block{opacity:1;height:100%}wcm-wallet-button{margin:calc((100% - 60px)/ 3) 0}`;
      var oJ = Object.defineProperty,
        oG = Object.getOwnPropertyDescriptor,
        oX = (t, e, r, o) => {
          for (var i, n = o > 1 ? void 0 : o ? oG(e, r) : e, l = t.length - 1; l >= 0; l--)
            (i = t[l]) && (n = (o ? i(e, r, n) : i(n)) || n);
          return o && n && oJ(e, r, n), n;
        };
      let o0 = class extends tc {
        constructor() {
          super(...arguments),
            (this.loading = !tC.pV.state.wallets.listings.length),
            (this.firstFetch = !tC.pV.state.wallets.listings.length),
            (this.search = ''),
            (this.endReached = !1),
            ...
            (this.searchDebounce = e9.debounce((t) => {
              t.length >= 1
                ? ((this.firstFetch = !0),
                  ...
                  this.fetchWallets())
                : this.search &&
                  ((this.search = ''), (this.endReached = this.isLastPage()), tC.pV.resetSearch());
            }));
        }
        firstUpdated() {
        ...
        async fetchWallets() {
          ...
          if (!this.endReached && (this.firstFetch || (i > 40 && o.length < i)))
            try {
              ...
              await Promise.all([...o.map(async (t) => e9.preloadImage(t)), tC.Ao.wait(300)]),
                (this.endReached = this.isLastPage());
            } catch (t) {
              console.error(t), tC.dC.openToast(e9.getErrorMessage(t), 'error');
            } finally {
              (this.loading = !1), (this.firstFetch = !1);
            }
        }
        onConnect(t) {
          tC.Ao.isAndroid() ? e9.handleMobileLinking(t) : e9.goToConnectingView(t);
        }
        onSearchChange(t) {
        ...
        render() {
          ...
          i &&
            ((n = n.filter(({ values: t }) => e9.caseSafeIncludes(t[0], this.search))),
            (l = l.filter(({ values: t }) => e9.caseSafeIncludes(t[0], this.search))));
          ...
          return z`<wcm-modal-header><wcm-search-input .onChange="${this.onSearchChange.bind(this)}"></wcm-search-input></wcm-modal-header><wcm-modal-content class="${tv(s)}"><div class="wcm-grid">${o ? null : n} ${o ? null : l} ${o ? null : r.map((t) => z`${t ? z`<wcm-wallet-button imageId="${t.image_id}" name="${t.name}" walletId="${t.id}" .onClick="${() => this.onConnect(t)}"></wcm-wallet-button>` : null}`)}</div><div class="wcm-placeholder-block">${a ? z`<wcm-text variant="big-bold" color="secondary">No results found</wcm-text>` : null} ${!a && this.loading ? z`<wcm-spinner></wcm-spinner>` : null}</div></wcm-modal-content>`;
        }
      };
      (o0.styles = [eT.globalCss, oQ]),
        oX([tg()], o0.prototype, 'loading', 2),
        oX([tg()], o0.prototype, 'firstFetch', 2),
        oX([tg()], o0.prototype, 'search', 2),
        oX([tg()], o0.prototype, 'endReached', 2),
        (o0 = oX([th('wcm-wallet-explorer-view')], o0));
      let o1 = d`wcm-info-footer{flex-direction:column;align-items:center;display:flex;width:100%;padding:5px 0}wcm-text{text-align:center}`;
      var o2 = Object.defineProperty,
        o5 = Object.getOwnPropertyDescriptor,
        o4 = (t, e, r, o) => {
          for (var i, n = o > 1 ? void 0 : o ? o5(e, r) : e, l = t.length - 1; l >= 0; l--)
            (i = t[l]) && (n = (o ? i(e, r, n) : i(n)) || n);
          return o && n && o2(e, r, n), n;
        };
      let o3 = class extends tc {
        constructor() {
        ...
        onFormatAndRedirect(t) {
          ...
          if (o) {
            let e = tC.Ao.formatUniversalUrl(o, t, r);
            tC.Ao.openHref(e, '_blank');
          }
        }
        openWebWallet() {
        ...
        render() {
          let { name: t, id: e, image_id: r } = tC.Ao.getWalletRouterData(),
            ...
            n = tC.Ao.isMobile();
          return z`<wcm-modal-header title="${t}" .onAction="${e9.handleUriCopy}" .actionIcon="${eV.COPY_ICON}"></wcm-modal-header><wcm-modal-content><wcm-connector-waiting walletId="${e}" imageId="${ex(r)}" label="${`Continue in ${t}...`}" .isError="${this.isError}"></wcm-connector-waiting></wcm-modal-content><wcm-info-footer><wcm-text color="secondary" variant="small-thin">${`${t} web app has opened in a new tab. Go there, accept the connection, and come back`}</wcm-text><wcm-platform-selection .isMobile="${o}" .isDesktop="${!n && i}" .isRetry="${!0}"><wcm-button .onClick="${this.openWebWallet.bind(this)}" .iconRight="${eV.RETRY_ICON}">Retry</wcm-button></wcm-platform-selection></wcm-info-footer>`;
        }
      };
      (o3.styles = [eT.globalCss, o1]),
        o4([tg()], o3.prototype, 'isError', 2),
        (o3 = o4([th('wcm-web-connecting-view')], o3));
    },
    88448: (t, e) => {
      let r;
      let o = [
    ...
    90897: (t, e, r) => {
      ...
      (e.mul = function (t, e) {
        ...
        (e.generateECPolynomial = function (t) {
          ...
          for (let i = 0; i < t; i++) r = e.mul(r, new Uint8Array([1, o.exp(i)]));
          return r;
        });
    },
    95200: (t, e) => {
      ...
      (e.isValid = function (t) {
        ...
        (e.getPenaltyN1 = function (t) {
          ...
          for (let s = 0; s < e; s++) {
            ...
            for (let c = 0; c < e; c++) {
              let e = t.get(s, c);
              e === l ? i++ : (i >= 5 && (o += r.N1 + (i - 5)), (l = e), (i = 1)),
                (e = t.get(c, s)) === a ? n++ : (n >= 5 && (o += r.N1 + (n - 5)), (a = e), (n = 1));
            }
        ...
        (e.getBestMask = function (t, r) {
          ...
          for (let l = 0; l < o; l++) {
            r(l), e.applyMask(l, t);
            let o = e.getPenaltyN1(t) + e.getPenaltyN2(t) + e.getPenaltyN3(t) + e.getPenaltyN4(t);
      ...
      var e = {
        single_source_shortest_paths: function (t, r, o) {
          ...
          for (m.push(r, 0); !m.empty(); )
            for (l in ((n = (i = m.pop()).value), (a = i.cost), (s = t[n] || {})))
              s.hasOwnProperty(l) &&
                ((c = a + s[l]),
                (d = u[l]),
                (void 0 === u[l] || d > c) && ((u[l] = c), m.push(l, c), (h[l] = n)));
          if (void 0 !== o && void 0 === u[o])
            throw Error(['Could not find a path from ', r, ' to ', o, '.'].join(''));
          return h;
        },
