  ...
  [7653],
  {
    37653: (e, r, t) => {
      ...
      var n = /^-?(?:\d+(?:\.\d*)?|\.\d+)(?:e[+-]?\d+)?$/i,
        ...
        s = Math.floor,
        o = '[BigNumber Error] ',
        f = o + 'Number primitive has more than 15 significant digits: ',
      ...
      function a(e, r) {
        var t,
          ...
          l = r.e;
        if (!o || !f) return null;
        if (((t = i && !i[0]), (n = s && !s[0]), t || n)) return t ? (n ? 0 : -f) : o;
        if (o != f) return o;
      ...
      var m = (function e(r) {
        var t,
          ...
          y,
          E,
          A = (k.prototype = { constructor: k, toString: null, valueOf: null }),
          x = new k(1),
          S = 20,
          _ = 4,
          R = -7,
        ...
        function k(e, r) {
          ...
          if (null == r) {
            ...
            (u = g.indexOf('.')) > -1 && (g = g.replace('.', '')),
              (l = g.search(/e/i)) > 0
                ? (u < 0 && (u = l), (u += +g.slice(l + 1)), (g = g.substring(0, l)))
                : u < 0 && (u = g.length);
          } else {
            if ((h(r, 2, T.length, 'Base'), 10 == r && M)) return q((p = new k(e)), S + p.e + 1, _);
            if (((g = String(e)), (c = 'number' == typeof e))) {
              if (0 * e != 0) return E(p, g, c, r);
              if (
                ((p.s = 1 / e < 0 ? ((g = g.slice(1)), -1) : 1),
                k.DEBUG && g.replace(/^0\.0*|\./, '').length > 15)
              )
                throw Error(f + e);
            } else p.s = 45 === g.charCodeAt(0) ? ((g = g.slice(1)), -1) : 1;
            for (t = T.slice(0, r), u = l = 0, a = g.length; l < a; l++)
          ...
          if ((g = g.slice(l, ++a))) {
            if (((a -= l), c && k.DEBUG && a > 15 && (e > 0x1fffffffffffff || e !== s(e))))
              throw Error(f + p.s * e);
            if ((u = u - l - 1) > B) p.c = p.e = null;
            else if (u < P) p.c = [(p.e = 0)];
            else {
              if (((p.e = u), (p.c = []), (l = (u + 1) % 14), u < 0 && (l += 14), l < a)) {
                for (l && p.c.push(+g.slice(0, l)), a -= 14; l < a; )
        ...
        function G(e, r, t, n) {
          var i, s, o, f, u;
          if ((null == t ? (t = _) : h(t, 0, 8), !e.c)) return e.toString();
          if (((i = e.c[0]), (o = e.e), null == r))
            (u = c(e.c)), (u = 1 == n || (2 == n && (o <= R || o >= D)) ? p(u, o) : w(u, o, '0'));
          else if (
            ((s = (e = q(new k(e), r, t)).e),
            (f = (u = c(e.c)).length),
            1 == n || (2 == n && (r <= s || s <= R)))
            ...
            for (; f < r; u += '0', f++);
            u = p(u, s);
          } else if (((r -= o), (u = w(u, s, '0')), s + 1 > f)) {
            if (--r > 0) for (u += '.'; r--; u += '0');
          } else if ((r += s - f) > 0) for (s + 1 == f && (u += '.'); r--; u += '0');
          return e.s < 0 && i ? '-' + u : u;
        }
        function F(e, r) {
          for (var t, n, i = 1, s = new k(e[0]); i < e.length; i++)
            ((n = new k(e[i])).s && (t = a(s, n)) !== r && (0 !== t || s.s !== r)) || (s = n);
          return s;
        }
        function j(e, r, t) {
        ...
        function q(e, r, t, n) {
          ...
          if (p) {
            e: {
              ...
              if ((f = r - o) < 0)
                (f += 14), (l = r), (g = s(((a = p[(h = 0)]) / u[o - l - 1]) % 10));
              else if ((h = i((f + 1) / 14)) >= p.length) {
                if (n) {
                  for (; p.length <= h; p.push(0));
                  (a = g = 0), (o = 1), (f %= 14), (l = f - 14 + 1);
                } else break e;
              } else {
                for (o = 1, a = c = p[h]; c >= 10; c /= 10, o++);
                (f %= 14), (g = (l = f - 14 + o) < 0 ? 0 : s((a / u[o - l - 1]) % 10));
              }
              if (
                ((n = n || r < 0 || null != p[h + 1] || (l < 0 ? a : a % u[o - l - 1])),
                (n =
                  t < 4
                    ? (g || n) && (0 == t || t == (e.s < 0 ? 3 : 2))
                    : g > 5 ||
                      (5 == g &&
                        (4 == t ||
                          n ||
                          (6 == t && (f > 0 ? (l > 0 ? a / u[o - l] : 0) : p[h - 1]) % 10 & 1) ||
                          t == (e.s < 0 ? 8 : 7)))),
                r < 1 || !p[0])
              )
                return (
                  (p.length = 0),
                  n
                    ? ((r -= e.e + 1), (p[0] = u[(14 - (r % 14)) % 14]), (e.e = -r || 0))
                    : (p[0] = e.e = 0),
                  e
                );
              if (
                ...
                for (;;) {
                  if (0 == h) {
                    ...
                    f != c && (e.e++, 1e14 == p[0] && (p[0] = 1));
                    break;
                  }
                  if (((p[h] += c), 1e14 != p[h])) break;
                  (p[h--] = 0), (c = 1);
                }
              for (f = p.length; 0 === p[--f]; p.pop());
            }
        ...
        return (
                ...
                if ('object' == typeof e) {
                  if (
                    (e.hasOwnProperty((r = 'DECIMAL_PLACES')) &&
                      (h((t = e[r]), 0, 1e9, r), (S = t)),
                    e.hasOwnProperty((r = 'ROUNDING_MODE')) && (h((t = e[r]), 0, 8, r), (_ = t)),
                    e.hasOwnProperty((r = 'EXPONENTIAL_AT')) &&
                      ((t = e[r]) && t.pop
                        ? (h(t[0], -1e9, 0, r), h(t[1], 0, 1e9, r), (R = t[0]), (D = t[1]))
                        : (h(t, -1e9, 1e9, r), (R = -(D = t < 0 ? -t : t)))),
                    e.hasOwnProperty((r = 'RANGE')))
                  ) {
                    if ((t = e[r]) && t.pop)
                      h(t[0], -1e9, -1, r), h(t[1], 1, 1e9, r), (P = t[0]), (B = t[1]);
                    else if ((h(t, -1e9, 1e9, r), t)) P = -(B = t < 0 ? -t : t);
                    ...
                    if (!!(t = e[r]) === t) {
                      if (t) {
                        if (
                          ...
                          L = t;
                        else throw ((L = !t), Error(o + 'crypto unavailable'));
                      } else L = t;
                    } else throw Error(o + r + ' not true or false: ' + t);
                  }
                  if (
                    (e.hasOwnProperty((r = 'MODULO_MODE')) && (h((t = e[r]), 0, 9, r), (U = t)),
                    e.hasOwnProperty((r = 'POW_PRECISION')) && (h((t = e[r]), 0, 1e9, r), (C = t)),
                  ...
                  if (e.hasOwnProperty((r = 'ALPHABET'))) {
                    if ('string' != typeof (t = e[r]) || /^.?$|[+\-.\s]|(.).*\1/.test(t))
                      throw Error(o + r + ' invalid: ' + t);
          ...
          (k.random = function (e) {
            var r,
              ...
              g = [],
              p = new k(x);
            if ((null == e ? (e = S) : h(e, 0, 1e9), (l = i(e / 14)), L)) {
              if (crypto.getRandomValues) {
                for (r = crypto.getRandomValues(new Uint32Array((l *= 2))); a < l; )
                ...
                for (r = crypto.randomBytes((l *= 7)); a < l; )
                  (c =
                    ...
                    : (g.push(c % 1e14), (a += 7));
                a = l / 7;
              } else throw ((L = !1), Error(o + 'crypto unavailable'));
            }
            if (!L) for (; a < l; ) (c = t()) < 9e15 && (g[a++] = c % 1e14);
            for (
              l = g[--a], e %= 14, l && e && ((c = u[14 - e]), (g[a] = s(l / c) * c));
              0 === g[a];
              g.pop(), a--
            );
            if (a < 0) g = [(f = 0)];
            else {
              for (f = -1; 0 === g[0]; g.splice(0, 1), f -= 14);
              for (a = 1, c = g[0]; c >= 10; c /= 10, a++);
              a < 14 && (f -= 14 - a);
            }
            return (p.e = f), (p.c = g), p;
          }),
          (k.sum = function () {
            ...
            function r(e, r, t, n) {
              for (var i, s, o = [0], f = 0, u = e.length; f < u; ) {
                ...
                for (o[0] += n.indexOf(e.charAt(f++)), i = 0; i < o.length; i++)
                  o[i] > t - 1 &&
                    (null == o[i + 1] && (o[i + 1] = 0), (o[i + 1] += (o[i] / t) | 0), (o[i] %= t));
              }
              return o.reverse();
            }
            return function (t, n, i, s, o) {
              ...
              for (
                d >= 0 &&
                  ...
                  (C = 0),
                  (t = t.replace('.', '')),
                  (g = (m = new k(n)).pow(t.length - d)),
                  (C = a),
                  (m.c = r(w(c(g.c), g.e, '0'), 10, i, e)),
                  (m.e = m.c.length)),
                  l = a = (p = r(t, n, i, o ? ((f = T), e) : ((f = e), T))).length;
                0 == p[--a];
                p.pop()
              );
              ...
              if (
                ...
                (h =
                  N < 4
                    ...
                    : d > a ||
                      (d == a &&
                        (4 == N || h || (6 == N && 1 & p[u - 1]) || N == (g.s < 0 ? 8 : 7)))),
                u < 1 || !p[0])
              )
                t = h ? w(f.charAt(1), -v, f.charAt(0)) : f.charAt(0);
              else {
                if (((p.length = u), h))
          ...
          (b = (function () {
            function e(e, r, t) {
              ...
              for (e = e.slice(); u--; )
                (n = c * (s = e[u] % 1e7) + (o = (e[u] / 1e7) | 0) * l),
                  (f = (((i = l * s + (n % 1e7) * 1e7 + f) / t) | 0) + ((n / 1e7) | 0) + c * o),
                  (e[u] = i % t);
            ...
            return function (n, i, o, f, u) {
              ...
              for (
                v = (d = new k(_)).c = [],
                  _ = o + (a = n.e - i.e) + 1,
                  u || ((u = 1e14), (a = l(n.e / 14) - l(i.e / 14)), (_ = (_ / 14) | 0)),
                  h = 0;
                D[h] == (R[h] || 0);
                h++
              );
              if ((D[h] > (R[h] || 0) && a--, _ < 0)) v.push(1), (g = !0);
              else {
                for (
                  E = R.length,
                    x = D.length,
                    ...
                    _ += 2,
                    (p = s(u / (D[0] + 1))) > 1 &&
                      ((D = e(D, p, u)), (R = e(R, p, u)), (x = D.length), (E = R.length)),
                    y = x,
                    O = (N = R.slice(0, x)).length;
                  O < x;
                  N[O++] = 0
                );
                (S = [0].concat((S = D.slice()))), (A = D[0]), D[1] >= u / 2 && A++;
                do {
                  if (((p = 0), (c = r(D, N, x, O)) < 0)) {
                    if (((b = N[0]), x != O && (b = b * u + (N[1] || 0)), (p = s(b / A)) > 1))
                      for (
                        p >= u && (p = u - 1), m = (w = e(D, p, u)).length, O = N.length;
                        1 == r(w, N, m, O);

                      )
                        p--, t(w, x < m ? S : D, m, u), (m = w.length), (c = 1);
                    else 0 == p && (c = p = 1), (m = (w = D.slice()).length);
                    if ((m < O && (w = [0].concat(w)), t(N, w, O, u), (O = N.length), -1 == c))
                      for (; 1 > r(D, N, x, O); ) p++, t(N, x < O ? S : D, O, u), (O = N.length);
                  } else 0 === c && (p++, (N = [0]));
                  (v[h++] = p), N[0] ? (N[O++] = R[y] || 0) : ((N = [R[y]]), (O = 1));
                } while ((y++ < E || null != N[0]) && _--);
                (g = null != N[0]), v[0] || v.splice(0, 1);
              }
              if (1e14 == u) {
                for (h = 1, _ = v[0]; _ >= 10; _ /= 10, h++);
                q(d, o + (d.e = h + 14 * a - 1) + 1, f, g);
              } else (d.e = a), (d.r = +g);
              return d;
            };
          })()),
          ...
          (E = function (e, r, t, n) {
            ...
            if (N.test(s)) e.s = isNaN(s) ? null : s < 0 ? -1 : 1;
              ...
              if (
                !t &&
                ((s = s.replace(m, function (e, r, t) {
                  return (
                    (i = 'x' == (t = t.toLowerCase()) ? 16 : 'b' == t ? 2 : 8), n && n != i ? e : r
                  );
                })),
                n && ((i = n), (s = s.replace(d, '$1').replace(v, '0.$1'))),
                r != s)
              )
                return new k(s, i);
          ...
          (A.decimalPlaces = A.dp =
            function (e, r) {
              ...
              if (null != e)
                return (
                  h(e, 0, 1e9), null == r ? (r = _) : h(r, 0, 8), q(new k(this), e + this.e + 1, r)
                );
          ...
          (A.exponentiatedBy = A.pow =
            function (e, r) {
              ...
              if (
                ...
                return (p = new k(Math.pow(+$(w), c ? e.s * (2 - g(e)) : +$(e)))), r ? p.mod(r) : p;
              if (((a = e.s < 0), r)) {
                ...
                if (
                  ...
                  return (
                    (u = w.s < 0 && g(e) ? -0 : 0), w.e > -1 && (u = 1 / u), new k(a ? 1 / u : u)
                  );
                C && (u = i(C / 14 + 2));
              }
              for (
                c
                  ? ((t = new k(0.5)), a && (e.s = 1), (h = g(e)))
                  : (h = (f = Math.abs(+$(e))) % 2),
                  p = new k(x);
                ;
                ...
                if (h) {
                  ...
                  u ? p.c.length > u && (p.c.length = u) : n && (p = p.mod(r));
                }
                if (f) {
                  if (0 === (f = s(f / 2))) break;
                  h = f % 2;
                ...
                (w = w.times(w)),
                  u ? w.c && w.c.length > u && (w.c.length = u) : n && (w = w.mod(r));
              }
              return n ? p : (a && (p = x.div(p)), r ? p.mod(r) : u ? q(p, C, _, l) : p);
            }),
          (A.integerValue = function (e) {
            var r = new k(this);
            return null == e ? (e = _) : h(e, 0, 8), q(r, r.e + 1, e);
          }),
          (A.isEqualTo = A.eq =
            function (e, r) {
          ...
          (A.minus = function (e, r) {
            ...
            if (!f || !u) {
              ...
              if (!c[0] || !a[0])
                return a[0] ? ((e.s = -r), e) : new k(c[0] ? this : 3 == _ ? -0 : 0);
            }
            if (((f = l(f)), (u = l(u)), (c = c.slice()), (o = f - u))) {
              for (
                (s = o < 0) ? ((o = -o), (i = c)) : ((u = f), (i = a)), i.reverse(), r = o;
                r--;
                i.push(0)
              );
              i.reverse();
            ...
            return c[0] ? j(e, c, u) : ((e.s = 3 == _ ? -1 : 1), (e.c = [(e.e = 0)]), e);
          }),
          (A.modulo = A.mod =
            function (e, r) {
              var t, n;
              return ((e = new k(e, r)), this.c && e.s && (!e.c || e.c[0]))
                ? e.c && (!this.c || this.c[0])
                  ? (9 == U
                      ? ((n = e.s), (e.s = 1), (t = b(this, e, 0, 3)), (e.s = n), (t.s *= n))
                      : (t = b(this, e, 0, U)),
          ...
          (A.multipliedBy = A.times =
            function (e, r) {
              ...
              for (
                n = l(this.e / 14) + l(e.e / 14),
                  e.s *= this.s,
                  (u = m.length) < (h = d.length) &&
                    ((w = m), (m = d), (d = w), (i = u), (u = h), (h = i)),
                  i = u + h,
                  w = [];
                i--;
                w.push(0)
              ...
              for (i = h; --i >= 0; ) {
                for (t = 0, g = d[i] % 1e7, p = (d[i] / 1e7) | 0, s = i + (o = u); s > i; )
                  (f = p * (c = m[--o] % 1e7) + (a = (m[o] / 1e7) | 0) * g),
                    (t =
                      (((c = g * c + (f % 1e7) * 1e7 + w[s] + t) / 1e14) | 0) +
                      ((f / 1e7) | 0) +
                      p * a),
                    (w[s--] = c % 1e14);
                w[s] = t;
          ...
          (A.plus = function (e, r) {
            ...
            var i = this.e / 14,
              ...
              f = e.c;
            if (!i || !s) {
              if (!o || !f) return new k(n / 0);
              if (!o[0] || !f[0]) return f[0] ? e : new k(o[0] ? this : 0 * n);
            }
            if (((i = l(i)), (s = l(s)), (o = o.slice()), (n = i - s))) {
              for (n > 0 ? ((s = i), (t = f)) : ((n = -n), (t = o)), t.reverse(); n--; t.push(0));
              t.reverse();
            }
            for (
              (n = o.length) - (r = f.length) < 0 && ((t = f), (f = o), (o = t), (r = n)), n = 0;
              r;

            )
              (n = ((o[--r] = o[r] + f[r] + n) / 1e14) | 0),
          ...
          (A.precision = A.sd =
            function (e, r) {
              var t, n, i;
              if (null != e && !!e !== e)
                return h(e, 1, 1e9), null == r ? (r = _) : h(r, 0, 8), q(new k(this), e, r);
              if (!(t = this.c)) return null;
          ...
          (A.squareRoot = A.sqrt =
            function () {
              var e,
                ...
                a = new k('0.5');
              if (1 !== o || !s || !s[0])
                return new k(!o || (o < 0 && (!s || s[0])) ? NaN : s ? this : 1 / 0);
              if (
                (0 == (o = Math.sqrt(+$(this))) || o == 1 / 0
                  ? (((r = c(s)).length + f) % 2 == 0 && (r += '0'),
                    (o = Math.sqrt(+r)),
                    (f = l((f + 1) / 2) - (f < 0 || f % 2)),
                    (t = new k(
                      (r =
                        o == 1 / 0
                          ? '5e' + f
                          : (r = o.toExponential()).slice(0, r.indexOf('e') + 1) + f)
                    )))
                  : (t = new k(o + '')),
                t.c[0])
              ) {
                for ((o = (f = t.e) + u) < 3 && (o = 0); ; )
                  if (
                    ((i = t),
                    (t = a.times(i.plus(b(this, i, u, 1)))),
                    c(i.c).slice(0, o) === (r = c(t.c)).slice(0, o))
                  ) {
                    if (
                      (t.e < f && --o, '9999' != (r = r.slice(o - 3, o + 1)) && (n || '4999' != r))
                    ) {
          ...
          (A.toFormat = function (e, r, t) {
            ...
            if (((n = this.toFixed(e, r)), this.c)) {
              var i,
                ...
                g = h ? c.slice(1) : c,
                p = g.length;
              if ((u && ((i = f), (f = u), (u = i), (p -= i)), f > 0 && p > 0)) {
                for (i = p % f || f, c = g.substr(0, i); i < p; i += f) c += l + g.substr(i, f);
                u > 0 && (c += l + g.slice(i)), h && (c = '-' + c);
              }
              n = a
                ? c +
                  (t.decimalSeparator || '') +
          ...
          (A.toFraction = function (e) {
            var r,
              ...
              w,
              m = this.c;
            if (null != e && ((!(l = new k(e)).isInteger() && (l.c || 1 !== l.s)) || l.lt(x)))
              throw Error(
                o + 'Argument ' + (l.isInteger() ? 'out of range: ' : 'not an integer: ') + $(l)
              );
            ...
            for (
              r = new k(x),
                ...
                r.c[0] = u[(f = s % 14) < 0 ? 14 + f : f],
                e = !e || l.comparedTo(r) > 0 ? (s > 0 ? r : h) : l,
                f = B,
                B = 1 / 0,
                l = new k(w),
                a.c[0] = 0;
              (g = b(l, r, 0, 1)), 1 != (i = t.plus(g.times(n))).comparedTo(e);
            ...
            return (
              ...
              (p =
                ...
                b(h, n, s, _)
                  .minus(this)
                  .abs()
                  .comparedTo(b(a, t, s, _).minus(this).abs())
                  ? [h, n]
                  : [a, t]),
              (B = f),
              p
            ...
            return (
              null === i
                ? n
                  ...
                  : (r = 'NaN')
                : (null == e
                    ? (r = i <= R || i >= D ? p(c(t.c), i) : w(c(t.c), i, '0'))
                    : 10 === e && M
                      ? (r = w(c((t = q(new k(t), S + i + 1, _)).c), t.e, '0'))
                      : (h(e, 2, T.length, 'Base'), (r = y(w(c(t.c), i, '0'), 10, e, n, !0))),
                  n < 0 && t.c[0] && (r = '-' + r)),
              r
            );
          }),
