  ...
  [3033],
  {
    4289: (e, t, l) => {
      ...
      function d({
        ...
        let s = (e, t) => (0, c.p6)(o, e, t),
          f = (e) => (0, c.VG)(o, e) && !F?.(e).some((e) => !r.q.getQueryData(e)),
          E = ({ queryKey: t }) => (
            (0, i.dB)(t),
            e(
              s(
          ...
          z = (e, r = !0) =>
            (0, a.j)({
              ...
              queryFn: E,
              staleTime: n.o[l ?? '5m'],
              refetchInterval: d ? n.o[d] : void 0,
              enabled: r && f(e),
              refetchOnWindowFocus: h,
              refetchOnMount: p,
            });
        return {
          assertValidity: s,
          checkValidity: (e, t) => (0, c.VG)(o, e, t),
          isEnabled: f,
          queryKey: t,
          getQueryOptions: z,
          ...
          prefetchQuery: (e, l = 0) =>
            r.q.prefetchQuery({ queryKey: t(e), queryFn: E, staleTime: l }),
    ...
    4387: (e, t, l) => {
      ...
      let Cv = (e) =>
        Cb.createElement(
          'svg',
          CA({ xmlns: 'http://www.w3.org/2000/svg', fill: 'none', viewBox: '0 0 17 18' }, e),
          r ||
      ...
      let CS = (e) =>
        Cb.createElement(
          'svg',
          CL({ xmlns: 'http://www.w3.org/2000/svg', fill: 'none', viewBox: '0 0 15 15' }, e),
          Ch ||
            (Ch = Cb.createElement('path', {
              fill: 'currentColor',
              fillRule: 'evenodd',
      ...
      let Ck = (e) =>
          Cb.createElement(
            'svg',
            CM({ xmlns: 'http://www.w3.org/2000/svg', fill: 'none', viewBox: '0 0 15 15' }, e),
            Cp ||
              (Cp = Cb.createElement('path', {
                fill: '#1F1E1B',
      ...
      let CO = (e) =>
        Cb.createElement(
          'svg',
          CT({ xmlns: 'http://www.w3.org/2000/svg', viewBox: '0 0 24 24' }, e),
          Cs ||
            (Cs = Cb.createElement('path', {
      ...
      let Cj = (e) =>
        Cb.createElement(
          'svg',
          CP({ xmlns: 'http://www.w3.org/2000/svg', viewBox: '0 0 24 24' }, e),
          Cf ||
            (Cf = Cb.createElement('path', {
      ...
      let CI = (e) =>
        Cb.createElement(
          'svg',
          CN({ xmlns: 'http://www.w3.org/2000/svg', width: 18, height: 16, fill: 'none' }, e),
          CE ||
            (CE = Cb.createElement('path', {
              stroke: '#fff',
              strokeWidth: 2.5,
      ...
      let C_ = (e) =>
        Cb.createElement(
          'svg',
          CR({ xmlns: 'http://www.w3.org/2000/svg', viewBox: '0 0 24 24' }, e),
          Cz ||
            (Cz = Cb.createElement('path', {
      ...
      let CU = (e) =>
        Cb.createElement(
          'svg',
          CW({ xmlns: 'http://www.w3.org/2000/svg', width: 14, height: 14, fill: '#EA3943' }, e),
          Cu ||
            (Cu = Cb.createElement('path', {
              fillRule: 'evenodd',
    ...
    7908: (e, t, l) => {
      ...
      let i = (0, r.i7)(['100%{transform:translateX(100%);}']),
        n = r.Ay.span.withConfig({ componentId: 'sc-d22a12ef-0' })(
          [
      ...
      `;
        ...
        m = ({ className: e, isLightBg: t = !1, skeleton: l = [12, 12], ...r }) =>
          (0, a.jsx)(n, { className: e, isLightBg: t, skeleton: l, ...r });
    },
    16726: (e, t, l) => {
      l.d(t, { A: () => p });
      var a = l(54568),
        ...
        c = l(94990),
        d = l(75778);
      let o = (0, r.forwardRef)(({ className: e, children: t, loading: l, testId: i, ...n }, d) => {
          let o = (0, r.useRef)(null),
            { isFocusVisible: p, focusProps: s } = (0, c.o)();
          return (0, a.jsxs)(F, {
            ...n,
            ...s,
            'data-testid': `btn-${i}`,
            ...
            children: [
              ...
              l &&
                (0, a.jsx)(h, {
                  ...
                  fillWidth: !0,
                  fillHeight: !0,
                  children: (0, a.jsx)(m.A, { isDisabled: !0, size: 17 }),
                }),
            ],
          });
        }),
        F = i.Ay.button.withConfig({ componentId: 'sc-186dc391-0' })(['', ';'], d.ku),
        h = (0, i.Ay)(n.A).withConfig({ componentId: 'sc-186dc391-1' })([
    ...
    17147: (e, t, l) => {
      ...
      var n = l(72415),
        m = l(84032),
        c = l(41265);
      let { LineHeight: d, OutlineWidth: o, FontWeight: F, ButtonSize: h, FontSize: p } = m.B,
        ...
        E = (e, t, l, a, i) => ({
          [r.b.breakpoints.up(i)]: { height: e, fontSize: t[i], fontWeight: l, lineHeight: a[i] },
        }),
        z = ({ height: e, fontSize: t, fontWeight: l = 'Bold', lineHeight: a }) => ({
          ...E(h[e], p[t], F[l], d[a], 'mobile'),
          ...E(h[e], p[t], F[l], d[a], 'tablet'),
          ...E(h[e], p[t], F[l], d[a], 'desktop'),
        }),
        u = ({ Button: e, Text: t }) => {
          let {
              Primary: l,
            ...
            g = c.vX[t.FontFamily.Button];
          return {
            styleOverrides: {
              root: {
                variants: [
                  ...Object.entries(u).map(([e, t]) => ({ props: { color: e }, style: t })),
                  {
                    props: { variant: 'link' },
                    style: { textTransform: 'none', padding: 0, height: `${n.XQ[400]} !important` },
                  },
                ],
                borderRadius: 0,
                border: `${o} solid transparent`,
                boxSizing: 'border-box',
                '&:focus-visible': { borderColor: s },
                fontFamily: g,
                textTransform: 'uppercase',
                transition: E,
              },
              sizeExtraSmall: {
                ...z({ height: 'xs', fontSize: 'sm', lineHeight: 'md' }),
                textTransform: 'none',
              },
              sizeSmall: z({ height: 'sm', fontSize: 'sm', lineHeight: 'md' }),
              sizeMedium: z({ height: 'md', fontSize: 'md', lineHeight: 'xl' }),
              sizeLarge: z({ height: 'lg', fontSize: 'md', lineHeight: 'xl' }),
              startIcon: {
                [r.b.breakpoints.up('mobile')]: { marginInlineEnd: m.B.Spacing.xs.mobile },
                [r.b.breakpoints.up('tablet')]: { marginInlineEnd: m.B.Spacing.xs.tablet },
                [r.b.breakpoints.up('desktop')]: { marginInlineEnd: m.B.Spacing.xs.desktop },
              },
              endIcon: {
                [r.b.breakpoints.up('mobile')]: { marginInlineStart: m.B.Spacing.xs.mobile },
                [r.b.breakpoints.up('tablet')]: { marginInlineStart: m.B.Spacing.xs.tablet },
                [r.b.breakpoints.up('desktop')]: { marginInlineStart: m.B.Spacing.xs.desktop },
              },
            },
          };
        },
        ...
        A = ({ Button: e, Layer: t, Text: l }) => ({
          styleOverrides: {
            root: {
              ...
              '&.current': { borderColor: t.Highlight.Outline },
              ':focus-visible': { borderColor: t.Highlight.Outline },
              '&:hover': {
                color: e.Ghost.Hover.Label,
                backgroundColor: 'transparent',
                filter: 'saturate(2)',
              },
              fontFamily: c.vX[l.FontFamily.Button],
            },
            sizeExtraSmall: { height: g.xs, minWidth: g.xs },
            sizeSmall: { height: g.sm, minWidth: g.sm },
            sizeMedium: { height: g.md, minWidth: g.md },
            sizeLarge: { height: g.lg, minWidth: g.lg },
          },
        }),
        {
          Spacing: v,
        ...
        w = ({ Label: e, Fill: t }) => ({ color: e, backgroundColor: t }),
        L = (e, t, l, a, i, n, m, c) => ({
        ...
        S = ({
          ...
          return { ...L('mobile', ...n), ...L('tablet', ...n), ...L('desktop', ...n) };
        },
        ...
        P = (e, t) => ({
          styleOverrides: {
            ...
            title: {
              ...t.headingSBold,
              variants: [{ props: { size: 'small' }, style: { ...t.headingXsBold } }],
            },
          },
        });
      var j = l(54568),
      ...
      let R = (0, I.A)(
        ...
        { Sizing: _ } = m.B,
        W = (0, I.A)((0, j.jsx)('svg', { viewBox: '0 0 24 24' }), 'Empty'),
        U = (e) =>
          (0, j.jsx)(N.A, {
        ...
        X = ({ size: e }) => ({ '& .icon-wrapper svg': (0, r.N)({ fontSize: _[e] }) }),
        $ = () => ({
          defaultProps: {
            icon: U((0, j.jsx)(W, {})),
            checkedIcon: U((0, j.jsx)(R, {})),
            disableRipple: !0,
          },
          styleOverrides: {
            root: {
        ...
        Q = (e, t) => ({
          style: { backgroundColor: t.Fill[e], color: t.Label[e], borderColor: t.Border[e] },
          props: { color: e.toLowerCase() },
        }),
        { Sizing: V, Spacing: G, IconSize: Z } = m.B,
        q = {
          extraSmall: { font: 'bodyXsBold', height: Z.md, iconSize: Z.sm },
          small: { font: 'buttonXs', height: Z.md, iconSize: Z.sm },
          medium: { font: 'buttonXs', height: V.md, iconSize: Z.md },
          large: { font: 'buttonM', height: V.md, iconSize: Z.lg },
          extraLarge: { font: 'headingSBold', height: V.xl, iconSize: Z.xl },
        },
        K = {
          extraSmall: { deleteIconSize: Z.xs },
          small: { height: V.md, deleteIconSize: Z.sm },
          medium: { font: 'buttonS', deleteIconSize: Z.md },
          large: { height: V.lg, font: 'buttonS', deleteIconSize: Z.lg },
          extraLarge: { height: V.xl, deleteIconSize: Z.xl },
        },
        J = ({ Chips: e, Color: t, Text: { TextColors: l }, Layer: a, Badges: i }, n) => ({
          ...
          variants: [
            ...
            ...Object.entries(q).map(([e, { font: t, iconSize: l, ...a }]) => ({
              ...
              style: {
                ...(0, r.N)({ ...n[t], ...a }),
                '&:has(.MuiChip-icon)': { '& .MuiChip-icon': (0, r.N)({ width: l, height: l }) },
              },
            })),
            ...Object.entries(K).map(([e, { font: t, deleteIconSize: l, ...a }]) => ({
              ...
              style: {
                ...(0, r.N)({ ...(t && n[t]), ...a }),
                '& .MuiChip-deleteIcon': (0, r.N)({ width: l, height: l }),
              },
            })),
          ],
        });
      ...
      let ee = (0, I.A)(
        ...
        er = (
          ...
          defaultProps: {
            iconMapping: {
              success: (0, j.jsx)(R, { fontSize: 'small' }),
              info: (0, j.jsx)(ee, { fontSize: 'small' }),
              warning: (0, j.jsx)(Y.P, { fontSize: 'small' }),
              error: (0, j.jsx)(Y.P, { fontSize: 'small' }),
            },
          },
          styleOverrides: {
            root: (0, r.N)({
            ...
            outlined: {
              ...
              color: a.Secondary,
              '&.MuiAlert-colorInfo': { [ea]: { color: a.Highlight }, borderColor: l.Outline },
              '&.MuiAlert-colorSuccess': {
                [ea]: { color: a.Feedback.Success },
                borderColor: t.Success,
              },
              '&.MuiAlert-colorWarning': {
                [ea]: { color: a.Feedback.Warning },
                borderColor: t.Warning,
              },
              '&.MuiAlert-colorError': { [ea]: { color: a.Feedback.Error }, borderColor: t.Error },
            },
            filled: {
              color: a.Feedback.Inverted,
              '&.MuiAlert-colorInfo': { backgroundColor: t.Info },
              '&.MuiAlert-colorSuccess': { backgroundColor: t.Success },
              '&.MuiAlert-colorWarning': { backgroundColor: t.Warning, color: a.Primary },
              '&.MuiAlert-colorError': { backgroundColor: t.Error },
            },
            icon: {
              ...(0, r.N)({ marginRight: et.xs }),
              '& svg': (0, r.N)({ width: el.sm, height: el.sm }),
            },
          },
        }),
        ei = ({}, { bodySBold: e }) => ({
          styleOverrides: { root: (0, r.N)({ ...e, height: el.sm, marginBlockEnd: '4px' }) },
        }),
        ...
        eo = ({ Switch: { Default: e, Checked: t }, Button: { Focus_Outline: l } }) => ({
          styleOverrides: {
            ...
            track: {
              ...
              '.Mui-checked &': { backgroundColor: t.Fill, borderColor: t.Outline },
            },
            thumb: { borderRadius: 0, color: e.Label, '.Mui-checked &': { color: t.Label } },
          },
        }),
        ...
        ep = (e, t) => ({
          styleOverrides: {
            tooltip: {
              ...
              display: 'flex',
              alignItems: 'center',
              ...(0, r.N)({ padding: eF.md, ...t.bodyMBold }),
            },
          },
        }),
        { Sizing: es } = m.B,
        ef = (0, I.A)((0, j.jsx)('svg', { viewBox: '0 0 24 24' }), 'Empty'),
        eE = (0, I.A)(
          (0, j.jsx)('svg', {
            viewBox: '0 0 24 24',
            children: (0, j.jsx)('circle', { cx: '12', cy: '12', r: '6', fill: 'currentColor' }),
          }),
          'Circle'
        ),
        ez = (e) =>
        ...
        eu = ({ size: e }) => ({ '& .icon-wrapper svg': (0, r.N)({ fontSize: es[e] }) }),
        eg = () => ({
          defaultProps: {
            icon: ez((0, j.jsx)(ef, {})),
          ...
          styleOverrides: {
            ...
            sizeSmall: { ...eu({ size: 'xs' }) },
            sizeLarge: { ...eu({ size: 'md' }) },
          },
        }),
        { Sizing: eb } = m.B,
        eA = { small: eb.xs, medium: eb.sm },
        ev = {
          ...(0, r.N)({ height: eA.small }),
          borderRadius: 0,
          border: 'none',
          '&.MuiSlider-sizeMedium, .MuiSlider-sizeMedium &': (0, r.N)({ height: eA.medium }),
        },
        eC = (e) => ({
          '&::after': {
            content: '""',
        ...
        eB = (e) => ({
          ...
          [`&${ex}::before`]: { backgroundColor: e.Button.Primary.Default.Fill },
          [`&.Mui-disabled${ex}::before`]: { backgroundColor: 'var(--mui-palette-grey-400)' },
        }),
        ey = (e) => ({
      ...
      let ew = {
        ...
        eL = ({ Text: e }) => ({
          defaultProps: { variant: 'bodyMRegular', variantMapping: ew },
        ...
        ek = (e, t) => ({
          ...
          MuiDialog: {
            styleOverrides: {
              paper: { maxHeight: '100dvh', [r.b.breakpoints.down('tablet')]: { margin: 0 } },
            },
          },
          ...
          MuiFormControlLabel: {
            styleOverrides: {
              root: { margin: '0' },
              label: { marginLeft: m.B.Spacing.xs.desktop, ...t.headingXsBold },
            },
          },
          MuiIconButton: A(e),
          MuiLinearProgress: {
          ...
          MuiInputBase: {
            styleOverrides: {
              ...
              input: { height: m.B.ButtonSize.md, boxSizing: 'border-box' },
              inputSizeSmall: { height: m.B.ButtonSize.sm },
            },
          },
          MuiMenuItem: ec(e),
          MuiSelect: ed(e, t),
          ...
          MuiSkeleton: {
            styleOverrides: {
              root: { backgroundColor: (0, a.X4)(e.Text.TextColors.Primary, 0.13) },
            },
          },
          MuiTab: (0, eD.Yk)(e),
          MuiTabs: (0, eD.Xq)(e),
          MuiToolbar: { styleOverrides: { root: { minHeight: eS, paddingX: 3 } } },
          MuiTooltip: ep(e, t),
          MuiPaper: {
            styleOverrides: {
              root: { boxShadow: i(e, 1), backgroundImage: 'none' },
              elevation2: { boxShadow: i(e, 2) },
              elevation3: { boxShadow: i(e, 3) },
              elevation11: { boxShadow: i(e, -1) },
              elevation12: { boxShadow: i(e, -2) },
            },
          },
          MuiPopover: {
            ...
            styleOverrides: {
              paper: {
                backgroundColor: e.Layer[3].Fill,
                '& .MuiMenu-list': { maxHeight: m.B.MaxHeight.popover },
              },
            },
          },
          MuiRadio: eg(),
    ...
    21802: (e, t, l) => {
      ...
      let r = {
        ...
        i = { PAGE_MARKETS: '/markets', PAGE_DISCLAIMER: '/disclaimer' },
        n = {
        ...
        d = {
          ...
          crvusd: {
            label: 'crvUSD',
            routes: [
              { app: 'crvusd', route: n.PAGE_MARKETS, label: () => (0, a.t)`crvUSD` },
              {
                app: 'crvusd',
              ...
              { app: 'crvusd', route: n.PAGE_PEGKEEPERS, label: () => (0, a.t)`Peg Keepers` },
              {
                app: 'crvusd',
          ...
          lend: {
            label: 'Lend',
            routes: [{ app: 'lend', route: i.PAGE_MARKETS, label: () => (0, a.t)`Lend` }],
          },
          dao: {
            label: 'DAO',
            routes: [
              { app: 'dao', route: m.PAGE_VECRV_CREATE, label: () => (0, a.t)`Lock CRV` },
              { app: 'dao', route: m.PAGE_PROPOSALS, label: () => (0, a.t)`Proposals` },
              { app: 'dao', route: m.PAGE_GAUGES, label: () => (0, a.t)`Gauges` },
              { app: 'dao', route: m.PAGE_ANALYTICS, label: () => (0, a.t)`Analytics` },
              {
                app: 'dao',
                route: m.DISCUSSION,
        ...
        F = ({ route: e, target: t, label: l, app: a }, { networkId: r, pathname: i }) => {
          ...
          return { href: n, target: t, label: l(), isActive: i?.startsWith(n.split('?')[0]) };
        };
    },
    23779: (e, t, l) => {
      l.d(t, { Jg: () => E, Xs: () => f, hJ: () => p });
      var a = l(16430),
        r = l(58648),
        i = l.n(r),
        n = l(44096),
      ...
      function E(e, t, l) {
        let { addressesResult: a, tokensResult: r } = f(e, t, ['symbol'], { tokens: ['address'] }),
    ...
    25941: (e, t, l) => {
      ...
      var a = l(13267),
        ...
        s = l(11830),
        f = l(88259);
      let E = '982ea4bdf92e49746bd040a981283b36',
        z = (0, c.Ay)(),
        u = (0, p.A)({ email: 'info@curve.fi', appUrl: 'https://curve.fi' }),
        g = () => (0, d.A)({ walletConnectVersion: 2, projectId: E }),
        b = (0, m.A)({
          whitelistedDomains: [
        ...
        A = (0, r.A)({ darkMode: !0 }),
        v = (0, i.A)({ apiKey: 'pk_live_190B10CE18F47DCD' }),
        C = () => (0, f.A)({ projectId: E, dappUrl: window.location.origin }),
        x = (0, h.A)(),
        B = (0, F.A)(),
        y = (0, n.A)(),
        D = (0, s.A)(),
    ...
    27280: (e, t, l) => {
      ...
      let i = (0, r.i7)(['0%{transform:rotate(0deg);}100%{transform:rotate(360deg);}']),
        n = r.Ay.div.withConfig({ componentId: 'sc-4b3b4f81-0' })(
          [
    ...
    35183: (e, t, l) => {
      ...
      let a = 'https://cdn.jsdelivr.net',
        ...
        c = (e) => `${i}/chains/${e}.png`,
        d = (e) => `${i}/branding/curve_illustration-${'dark' === e ? 'dark' : 'light'}.svg`;
    },
    35420: (e, t, l) => {
      l.d(t, { t: () => c });
      var a = l(25941),
    ...
    39416: (e, t, l) => {
      ...
      let b = {
        ...
        A = ({ className: e, name: t, size: l, ...i }) => {
          ...
          return n ? (0, a.jsx)(n, { className: e, size: l, ...i }) : (0, a.jsx)(a.Fragment, {});
        };
    },
    39651: (e, t, l) => {
      l.d(t, { HP: () => r, fi: () => a, tr: () => i });
    ...
    41265: (e, t, l) => {
      ...
      var a = l(5230),
        ...
        m = l(22174),
        c = l.n(m);
      let d = 'true' === l(40459).env.STORYBOOK,
        o = d ? { style: { fontFamily: 'MonaSans' } } : r(),
        F = d ? { style: { fontFamily: 'Hubot Sans' } } : n(),
        h = d ? { style: { fontFamily: 'Minecraft' } } : c(),
        ...
        E = { 'Mona Sans': p, 'Hubot Sans': s, Minecraft: f },
        z = { '--font': s, '--button--font': f };
    },
    42822: (e, t, l) => {
      l.d(t, { K: () => r });
      var a = l(7620);
        ...
        z = ({ onConnect: e, wallet: t, isLoading: l, isDisabled: i }) => {
          ...
          return (0, a.jsx)(
            F.D,
            {
              ...
              icon: (0, a.jsx)(m, { sx: (0, p.N)({ width: E.xl, height: E.xl }) }),
              value: n,
              onSelected: c,
              isLoading: l,
              disabled: i && !l,
            ...
            children: [
              F
                ? (0, a.jsxs)(i.A, {
                    ...
                    severity: 'error',
                    children: [
                      (0, a.jsx)(n.A, { children: (0, d.t)`Error connecting wallet` }),
                      F.shortMessage ?? F.message ?? F,
                    ],
                  })
                : null,
              (0, a.jsx)(m.A, {
                children: g.map(({ key: e, ...t }) => (0, a.jsx)(z, { ...t }, e)),
              }),
            ],
          });
        };
    ...
    49478: (e, t, l) => {
      ...
      let d = (0, r.A)(
          (0, a.jsx)('svg', {
            ...
            children: (0, a.jsxs)('g', {
              children: [
                ...
                (0, a.jsx)('g', { transform: 'translate(50, 0) scale(0.5)', children: m }),
                (0, a.jsx)('g', { transform: 'translate(0, 50) scale(0.5)', children: i }),
                (0, a.jsx)('g', { transform: 'translate(50, 50) scale(1.5)', children: n }),
              ],
            }),
          }),
          'BrowserWallet'
        ...
        h = [
          ...
          { label: 'Coinbase', icon: o, connector: 'coinbaseWallet' },
          { label: 'Safe', icon: F, connector: 'safe' },
        ];
    },
    49770: (e, t, l) => {
      l.d(t, { D: () => o });
      ...
      function o({
        ...
        return (0, a.jsx)(d.O, {
          ...
          children: (0, a.jsxs)(n.A, {
            ...
            children: [
              F,
              (0, a.jsx)(m.A, { sx: { flexGrow: 1 }, variant: p ?? 'headingXsBold', children: e }),
              o && (0, a.jsx)(c, {}),
              h && (0, a.jsx)(i.A, { size: 20 }),
            ],
          }),
        });
      }
    ...
    61873: (e, t, l) => {
      ...
      let c = new i.$({
        ...
        h = (0, a.s)({ storage: window.localStorage });
    },
    64174: (e, t, l) => {
      l.d(t, { Dc: () => h, MC: () => F, QX: () => p, iq: () => o, pQ: () => s, xM: () => d });
      var a = l(3861),
        r = l.n(a),
        i = l(84826),
        n = l(68642);
    ...
    64269: (e, t, l) => {
      ...
      let o = a.A,
        F = (0, c.o0)((0, c.uz)('lang'), (0, c.sm)(), () => 'en') || 'en-US',
        h = {
                ...
                (!('minimumFractionDigits' in l) &&
                  ...
                  (r
                    ...
                    : n && i > 10
                      ...
                      : t?.style === 'percent'
                        ? (l.maximumFractionDigits = p(d, 2))
                        : 'compact' === m
                          ? (delete l.minimumFractionDigits,
                            delete l.maximumFractionDigits,
                            i >= 1e6
                              ? ((l.maximumFractionDigits = p(d, 2)), (l.notation = m))
                              : i > 10
                                ? ((l.trailingZeroDisplay = 'stripIfInteger'),
                                  (l.maximumFractionDigits = 0),
                                  (l.minimumFractionDigits = 0))
                                : (l.minimumFractionDigits = p(d, 5)))
                          : (l.minimumFractionDigits = p(d, 5))),
                1 > Number(e))
              ) {
                if (
                  ...
                  if (1e-9 > Number(e) && 'percent' !== l.style) return '<0.000000001';
                  {
                    ...
                    return E(e, { ...r, minimumSignificantDigits: 2, maximumSignificantDigits: 2 });
                  }
                }
                if (9e-4 >= Number(e) && !('showAllFractionDigits' in (t ?? {}))) {
                  let { minimumFractionDigits: t, maximumFractionDigits: a, ...r } = l;
                  return E(e, { ...(r ?? {}), maximumSignificantDigits: 4 });
                }
              }
              return E(e, { ...l, ...c });
            }
      ...
      function u(e, t) {
        ...
        return E(e, { minimumFractionDigits: l, maximumFractionDigits: l });
      }
      let g = (e, t = 'short') =>
          'short' === t
    ...
    66464: (e, t, l) => {
      ...
      let o = new Map(),
        ...
        p = (e, t) => (0, d.E)({ key: e, initialValue: t, get: F, set: h });
      var s = l(35420),
        f = l(49478);
      let E = ({ chainId: e, provider: t, label: l, address: a, ensName: r }) => ({
          label: l,
          provider: t,
          account: { address: a, ...(r && { ensName: r }) },
          chainId: e,
        }),
        z = () => p('wallet', null),
        u = () => p('wagmiConnectCallbacks', null),
        g = () => {
          let [e, t] = u(),
            [l, d] = z(),
            { address: o, isConnecting: F, isReconnecting: h } = (0, r.F)(),
            { data: p } = (0, i.v)({ address: o }),
            { data: g } = (0, n.Q)(),
            b =
              (0, a.useMemo)(
                () =>
                  ...
                  E({
                    chainId: g.chain.id,
                    provider: { request: g.transport.request },
                    label: l?.label,
            ...
            { connectAsync: A } = (0, m.e)(),
            { disconnectAsync: v } = (0, c.u)(),
            C = async () => {
              await v(), await v();
            },
            x = (0, a.useMemo)(() => g?.transport?.request, [g]),
            B = (0, a.useCallback)(
              async (l) => {
                if (!l) return new Promise((...e) => t(e));
                let a = f.f.find((e) => e.label === l) ?? f.f[0];
                d(a);
                let [r, i] = e ?? [];
                try {
                  let {
                      accounts: [e],
                      chainId: t,
                    } = await A({ connector: s.t[a.connector] }),
                    i = E({
                      chainId: t,
                      provider: (x && { request: x }) || void 0,
                      label: l,
                      address: e,
                    });
                  return r?.(i), i;
                } catch (e) {
                  throw (console.error('Error connecting wallet:', e), i?.(e), e);
                }
              },
              [d, e, t, A, x]
            ),
            y = (0, a.useCallback)(() => t((e) => (e?.[0]?.(null), null)), [t]),
            D = !!e;
          return [{ wallet: b, connecting: (F || D) && !h && !o, showModal: D }, B, C, y];
        };
    },
    68153: (e, t, l) => {
      l.d(t, {
      ...
      (s.initialize = (...e) => c(...e)),
        (s.getState = () => ({ wallet: h.wallet, provider: h.provider }));
      var f = l(33550),
        E = l(91920),
        z = l(90214);
      let u = () => {
        ...
        return (0, i.useCallback)(
          async (e) => {
            if (!l) return t({ chainId: f.nD(e) });
            try {
              return await (0, z.S)(E.$, { chainId: e }), !0;
            } catch (e) {
              return console.error('Error switching chain:', e), !1;
            }
          },
          [t, l]
        );
      ...
      let b = new EventTarget(),
        A = 'walletNotification',
        v = 'walletNotificationDismiss',
        C = (e, t, l) => {
          let a = { id: (0, g.A)(), type: t, message: e, ...(void 0 !== l && { autoDismiss: l }) };
          return (
            b.dispatchEvent(new CustomEvent(A, { detail: a })),
            { dismiss: () => b.dispatchEvent(new CustomEvent(v, { detail: a })) }
          );
        },
        x = (e, t) => {
          let l = (t) => e(t.detail);
          b.addEventListener(A, l);
          let a = (e) => t(e.detail);
          return (
            b.addEventListener(v, a),
            () => {
              b.removeEventListener(A, l), b.removeEventListener(v, a);
            }
          );
        };
      var B = l(73716),
        y = l(54568),
        D = l(56120);
      let w = ({ walletAddress: e, ...t }) =>
        (0, y.jsx)(D.A, { size: 'small', color: 'ghost', title: e, ...t, children: (0, o.Wr)(e) });
      var L = l(36074);
      let S = (e) =>
          (0, y.jsx)(D.A, {
            size: 'small',
        ...
        M = ({ sx: e, onConnect: t }) => {
          let { signerAddress: l, connect: a, disconnect: r, wallet: i } = s(),
            { connectState: n } = (0, B.w5)(),
            m = (0, B.VP)(n, B.Ej.CONNECT_WALLET);
          return i && l
            ? (0, y.jsx)(w, { walletAddress: l, onClick: () => r(i.label), loading: m, sx: e })
            : (0, y.jsx)(S, { onClick: () => (t?.(), a()), loading: m, sx: e });
        };
      var k = l(61773),
        H = l(31184),
        T = l(32678),
      ...
      let I = ({
          ...
          (0, y.jsxs)(H.A, {
            padding: 7,
            spacing: 8,
            width: N.B.MaxWidth.connectWallet,
            maxWidth: '90vw',
            ...
            children: [
              (0, y.jsxs)(H.A, {
                ...
                justifyContent: 'center',
                sx: {
                  backgroundImage: (e) => `url(${(0, j.K4)(e.key)})`,
                  backgroundSize: 'contain',
                  backgroundPosition: 'center',
                  backgroundRepeat: 'no-repeat',
                },
                children: [
                  (0, y.jsx)(R, { src: P.jp, alt: 'Curve Logo' }),
                  (0, y.jsx)(O.A, { variant: 'headingXxl', children: (0, L.t)`Enter Curve` }),
                ],
              }),
              (0, y.jsxs)(H.A, {
                spacing: 3,
                alignItems: 'center',
                children: [
                  (0, y.jsx)(O.A, { variant: 'bodyMRegular', children: e }),
                  (0, y.jsx)(D.A, {
                    size: 'large',
                    color: 'primary',
                    onClick: a,
      ...
      var W = l(24388),
        ...
        X = l(55570),
        $ = l(15984);
      let Q = { hint: 'info', error: 'error', pending: 'info', success: 'success' },
        V = {
          hint: (0, L.t)`Hint`,
          error: (0, L.t)`Error`,
          pending: (0, L.t)`Pending`,
          success: (0, L.t)`Success`,
        },
        G = ({ headerHeight: e }) => {
          let [t, l] = (0, i.useState)([]);
          return (
            (0, i.useEffect)(() => {
              let e = [],
                t = (e) => {
                ...
                children: t.map(({ id: e, type: t, message: l }) =>
                  (0, y.jsxs)(
                    W.A,
                    {
                      ...
                      severity: Q[t],
                      children: [
                        (0, y.jsx)(U.A, { children: V[t] }),
                        (0, y.jsx)(O.A, { children: l }),
                      ],
                    },
                    e
                  )
    ...
    70697: (e, t, l) => {
      ...
      let i = (e) => ({
        ...
        m = (e, t) =>
          (0, r.useQueries)({ queries: e, combine: (0, a.useCallback)((e) => n(e, t), [t]) });
      var c = l(67933);
      let d = (e) => (t, l) => {
          let a = e(t, l);
          return (0, c.useQuery)(a);
        },
        o = { isError: !1, isLoading: !0, isPending: !0, isFetching: !0, data: void 0 },
        F = { isError: !1, isLoading: !1, isPending: !1, isFetching: !1 };
    },
    71741: (e, t, l) => {
      l.d(t, { A: () => a });
    ...
    73716: (e, t, l) => {
      ...
      let c = {
        ...
        { HYDRATE: h, SWITCH_NETWORK: p, CONNECT_WALLET: s, CONNECT_API: f } = c,
        E = ({ status: e, stage: t }, l) => e === d && !!(!l || t?.startsWith(l)),
        z = ({ status: e, stage: t }, l) =>
          e === o &&
          !!(!l || (Array.isArray(l) ? l.some((e) => t?.startsWith(e)) : t?.startsWith(l))),
        u = ({ status: e, stage: t }) => e === F && t !== h,
        g = (0, r.createContext)({ connectState: { status: o } }),
        b = (e, t) => !e || i.kB(e)?.toLowerCase() == t?.signerAddress?.toLowerCase(),
        A = null,
        v = null;
      ...
      let x = ({ hydrate: e, initLib: t, chainId: l, onChainUnavailable: c, children: E }) => {
          let [z, u] = (0, r.useState)({ status: o }),
            A = (0, r.useRef)(!1),
            { wallet: v, connect: x } = (0, i.vT)(),
            [B, D] = (0, m.MC)(),
            w = (0, i.v3)();
          (0, r.useEffect)(() => {
            ...
            (0, r.useEffect)(() => {
              ...
              return (
                (async () => {
                  try {
                    if (!A.current && ((A.current = !0), B && (await m(B)))) return;
                    let a = (0, i.oe)(v),
                      n = document.hasFocus();
                    if (a && a !== l && n && (u({ status: o, stage: p }), !(await w(l)))) {
                      if (r.aborted) return;
                      u({ status: d, stage: p }), c([l, a]);
                    }
                    await C(async () => {
                      let a = y.get(),
                        i = a;
                      if (!b(v, a) || a?.chainId != l) {
                        if (
                          r.aborted ||
                          (u({ status: o, stage: f }),
                          (i = (await t(l, v?.provider)) ?? null),
                          r.aborted)
                        )
                          return;
                        y.set(i);
                      }
                      r.aborted || (u({ status: F, stage: h }), await e(i, a, v));
                    }, [l, v]),
                      u({ status: F });
                  } catch (e) {
                    if (r.aborted) return console.info('Error during init ignored', e);
                    console.error('Error during init', e),
                      u(({ stage: t }) => ({ status: d, stage: t, error: e }));
                  }
                })(),
                () => a.abort()
              );
    ...
    74043: (e, t, l) => {
      ...
      let h = {
          plain: {
            Light: (function () {
              let e = {
                ...
                t = {
                  1: { Fill: F.ri[50], Outline: F.ri[300] },
                  2: { Fill: F.ri[100], Outline: F.ri[200] },
                  3: { Fill: F.ri[50], Outline: F.ri[300] },
                  Highlight: F.w8[500],
                  TypeAction: { Selected: F.w8[100], Hover: F.ri[150] },
                  Feedback: {
                    Info: F.w8[500],
                    Success: F.vd[600],
                    Warning: F.B6[300],
            ...
            Dark: (function () {
              let e = {
                ...
                t = {
                  1: { Fill: F.ri[950], Outline: F.ri[900] },
                  2: { Fill: F.ri[900], Outline: F.ri[800] },
                  3: { Fill: F.ri[800], Outline: F.ri[700] },
                  Highlight: F.w8[500],
                  TypeAction: { Selected: F.w8[900], Hover: F.ri[800] },
                  Feedback: {
                    Info: F.w8[50],
                    Success: F.vd[300],
                    Warning: F.B6[400],
            ...
            Chad: (function () {
              let e = {
                ...
                t = {
                  1: { Fill: F.Ac[100], Outline: F.Ac[300] },
                  2: { Fill: F.Ac[200], Outline: F.Ac[400] },
                  3: { Fill: F.Ac[300], Outline: F.Ac[500] },
                  Highlight: F.Ac[800],
                  TypeAction: { Selected: F.Ac[50], Hover: F.Ac[200] },
                  Feedback: {
                    Info: F.Ac[700],
                    Success: F.vd[600],
                    Warning: F.B6[300],
          ...
          inverted: {
            Light: (function () {
              let e = {
                  1: { Fill: F.ri[950], Outline: F.ri[600] },
                  2: { Fill: F.ri[900], Outline: F.ri[750] },
                  3: { Fill: F.ri[750], Outline: F.ri[600] },
                  Highlight: F.w8[500],
                  TypeAction: { Selected: F.ri[850], Hover: F.ri[900] },
                  Feedback: {
                    Info: F.w8[800],
                    Success: F.vd[300],
                    Warning: F.B6[400],
            ...
            Dark: (function () {
              let e = {
                ...
                t = {
                  1: { Fill: F.ri[75], Outline: F.ri[300] },
                  2: { Fill: F.ri[100], Outline: F.ri[200] },
                  3: { Fill: F.ri[50], Outline: F.ri[300] },
                  Highlight: F.w8[500],
                  TypeAction: { Selected: F.w8[100], Hover: F.w8[50] },
                  Feedback: {
                    Info: F.w8[500],
                    Success: F.vd[600],
                    Warning: F.B6[300],
            ...
            Chad: (function () {
              let e = {
                ...
                t = {
                  1: { Fill: F.Ac[950], Outline: F.Ac[800] },
                  2: { Fill: F.Ac[800], Outline: F.Ac[600] },
                  3: { Fill: F.Ac[700], Outline: F.Ac[500] },
                  Highlight: F.Ac[400],
                  TypeAction: { Selected: F.Ac[800], Hover: F.Ac[900] },
                  Feedback: {
                    Info: F.ri[850],
                    Success: F.vd[300],
                    Warning: F.B6[400],
        ...
        z = 'auto 0 0',
        u = (e) => {
          let t = { Neutral: F.ri, Primary: F.w8, Secondary: F.vd, Tertiary: F.B6 },
            l = {
              1: e.Layer[1],
              2: e.Layer[2],
              3: e.Layer[3],
            ...
            r = {
              ...
              Transition: f,
              Primary: {
                Default: { Label: F.ri[50], Fill: F.w8[500] },
                Hover: { Label: F.ri[50], Fill: F.ri[900] },
                Disabled: { Label: a.TextColors.Disabled, Fill: F.w8[500] },
              },
              Secondary: {
                Default: { Label: F.ri[50], Fill: F.ri[900] },
                Hover: { Label: F.ri[50], Fill: F.w8[500] },
                Disabled: { Label: a.TextColors.Disabled, Fill: t.Neutral[900] },
              },
              Outlined: {
                Default: { Label: F.ri[950], Outline: F.ri[300] },
                Hover: { Label: F.w8[500], Outline: F.w8[500] },
                Disabled: { Label: a.TextColors.Disabled, Outline: a.TextColors.Disabled },
              },
              Ghost: {
                Default: { Label: a.TextColors.Highlight },
                Hover: { Label: F.ri[975] },
                Disabled: { Label: a.TextColors.Disabled, Fill: F.ri[900] },
              },
              Success: {
                Default: { Label: F.ri[900], Fill: F.vd[400] },
                Hover: { Label: F.vd[300], Fill: F.ri[900] },
                Disabled: { Label: F.ri[950], Fill: F.vd[200] },
              },
              Error: {
                Default: { Label: F.ri[50], Fill: F.B6[500] },
                Hover: { Label: F.B6[400], Fill: F.ri[900] },
                Disabled: { Label: F.ri[50], Fill: F.B6[500] },
              },
              Navigation: {
                Default: { Label: a.TextColors.Secondary },
                Hover: { Label: a.TextColors.Primary, Fill: l[1].Fill },
                Current: { Label: F.ri[50], Fill: l.Highlight.Fill },
              },
            },
            i = {
              Transition: f,
              UnderLined: {
                Inset: z,
                Default: { Label: a.TextColors.Secondary },
                Hover: { Label: a.TextColors.Highlight, Outline: l.Highlight.Outline },
                Current: { Label: a.TextColors.Primary, Outline: t.Primary[500] },
              },
              Contained: {
                Default: { Label: a.TextColors.Secondary, Fill: t.Neutral[300] },
                Hover: { Label: t.Neutral[50], Fill: t.Neutral[900] },
                Current: { Label: a.TextColors.Primary, Fill: l[1].Fill, Outline: t.Primary[500] },
              },
              OverLined: {
                Inset: E,
                Default: { Label: a.TextColors.Secondary },
            ...
            n = {
              ...
              Default: { Label: a.TextColors.Secondary, Fill: l[2].Fill, Stroke: l[2].Outline },
              Hover: { Label: t.Neutral[50], Fill: t.Neutral[900] },
              Current: {
            ...
            c = {
              Default: { Label: a.TextColors.Primary },
              Hover: { Label: a.TextColors.Highlight, Fill: l[3].Fill },
              Current: { Label: F.ri[50], Fill: t.Neutral[900] },
            },
            d = {
            ...
            o = {
              ...
              Large: { Default: { Fill: F.ri[150] } },
              SliderThumbImage: '/mui/slider-thumb-white.svg',
            },
            h = {
              Default: { Fill: l[1].Fill, Outline: t.Neutral[400], Label: t.Primary[500] },
              Checked: { Fill: t.Primary[500], Outline: t.Neutral[400], Label: F.ri[50] },
            };
          return {
            theme: 'light',
            Color: t,
        ...
        g = (e) => {
          let t = F.ri,
            l = {
              ...
              Tertiary: { 200: F.B6[500], 300: F.B6[400], 400: F.B6[300], 600: F.B6[200] },
            },
            a = {
            ...
            i = {
              ...
              Transition: f,
              Primary: {
                Default: { Label: t[50], Fill: F.w8[500] },
                Hover: { Label: t[900], Fill: t[50] },
                Disabled: { Label: r.TextColors.Disabled, Fill: F.w8[500] },
              },
              Secondary: {
                Default: { Label: t[900], Fill: t[50] },
                Hover: { Label: t[900], Fill: F.w8[500] },
                Disabled: { Label: r.TextColors.Disabled, Fill: l.Neutral[50] },
              },
              Outlined: {
                Default: { Label: t[50], Outline: t[700] },
                Hover: { Label: F.w8[500], Outline: F.w8[500] },
              ...
              Ghost: {
                ...
                Hover: { Label: t[50] },
                Disabled: { Label: r.TextColors.Disabled, Fill: t[850] },
              },
              Success: {
                Default: { Label: t[900], Fill: F.vd[300] },
                Hover: { Label: F.vd[500], Fill: t[50] },
                Disabled: { Label: t[950], Fill: F.vd[200] },
              },
              Error: {
                Default: { Label: t[50], Fill: F.B6[500] },
                Hover: { Label: F.B6[400], Fill: t[900] },
                Disabled: { Label: t[50], Fill: F.B6[500] },
              },
              Navigation: {
                Default: { Label: r.TextColors.Secondary },
                Hover: { Label: r.TextColors.Primary, Fill: a[1].Fill },
                Current: { Label: t[50], Fill: a.Highlight.Fill },
              },
            },
            n = {
              Transition: f,
              UnderLined: {
                Inset: z,
                Default: { Label: r.TextColors.Secondary },
                Hover: { Label: r.TextColors.Highlight, Outline: a.Highlight.Outline },
                Current: { Label: r.TextColors.Primary, Outline: l.Primary[500] },
              },
              Contained: {
                Default: { Label: r.TextColors.Secondary, Fill: l.Neutral[200] },
                Hover: { Label: l.Neutral[50], Fill: l.Neutral[900] },
                Current: { Label: r.TextColors.Primary, Fill: a[1].Fill, Outline: l.Primary[500] },
              },
              OverLined: {
                Inset: E,
                Default: { Label: r.TextColors.Secondary },
            ...
            m = {
              BorderRadius: { Clickable: 0, NonClickable: '100px' },
              Default: { Label: r.TextColors.Secondary, Fill: a[2].Fill, Stroke: a[2].Outline },
              Hover: { Label: l.Neutral[50], Fill: l.Neutral[900] },
              Current: { Label: l.Neutral[950], Fill: a[2].Fill, Outline: a.Highlight.Outline },
            },
            c = {
              Label: {
                Default: e.Badges.Label.Default,
            ...
            d = {
              ...
              Hover: { Label: r.TextColors.Highlight, Fill: a[3].Fill },
            ...
            h = {
              ...
              Large: { Default: { Fill: t[975] } },
              SliderThumbImage: '/mui/slider-thumb-black.svg',
            },
            p = {
              Default: { Fill: a[1].Fill, Outline: l.Neutral[400], Label: l.Primary[500] },
              Checked: { Fill: l.Primary[500], Outline: l.Neutral[400], Label: t[50] },
            };
          return {
            theme: 'dark',
            Color: l,
        ...
        b = (e) => {
          let t = { Neutral: F.ri, Primary: F.Ac, Secondary: F.vd, Tertiary: F.B6 },
            l = {
              1: e.Layer[1],
              2: e.Layer[2],
              3: e.Layer[3],
            ...
            r = {
              ...
              Transition: f,
              Primary: {
                Default: { Label: F.ri[50], Fill: F.Ac[500] },
                Hover: { Label: F.ri[50], Fill: F.ri[900] },
                Disabled: { Label: a.TextColors.Disabled, Fill: F.Ac[500] },
              },
              Secondary: {
                Default: { Label: F.ri[50], Fill: F.Ac[900] },
                Hover: { Label: F.ri[50], Fill: F.Ac[500] },
                Disabled: { Label: a.TextColors.Disabled, Fill: t.Primary[950] },
              },
              Outlined: {
                Default: { Label: F.ri[950], Outline: F.ri[300] },
                Hover: { Label: F.Ac[500], Outline: F.Ac[500] },
                Disabled: { Label: a.TextColors.Disabled, Outline: a.TextColors.Disabled },
              },
              Ghost: {
                Default: { Label: a.TextColors.Highlight },
                Hover: { Label: F.ri[800] },
                Disabled: { Label: a.TextColors.Disabled, Fill: F.Ac[950] },
              },
              Success: {
                Default: { Label: F.ri[900], Fill: F.vd[400] },
                Hover: { Label: F.vd[500], Fill: F.ri[900] },
                Disabled: { Label: F.ri[950], Fill: F.vd[200] },
              },
              Error: {
                Default: { Label: F.ri[50], Fill: F.B6[500] },
            ...
            i = {
              ...
              Contained: {
                Default: { Label: a.TextColors.Secondary, Fill: t.Primary[200] },
                Hover: { Label: t.Neutral[50], Fill: t.Primary[950] },
                Current: { Label: a.TextColors.Primary, Fill: l[1].Fill, Outline: t.Primary[500] },
              },
              OverLined: {
                Inset: E,
            ...
            n = {
              ...
              Default: { Label: a.TextColors.Secondary, Fill: l[1].Fill, Stroke: l[2].Outline },
              Hover: { Label: t.Neutral[50], Fill: t.Primary[950] },
              Current: {
                Label: a.TextColors.Primary,
                Fill: l[2].Fill,
            ...
            c = {
              Default: { Label: a.TextColors.Primary },
              Hover: { Label: a.TextColors.Highlight, Fill: l[3].Fill },
              Current: { Label: F.ri[50], Fill: t.Primary[800] },
            },
            d = {
              Header: { Fill: e.Tables.Header.Fill },
              Row: {
        ...
        v = (e, { Layer: t, Color: l, Text: { TextColors: a } }) => ({
          ...
          error: { main: t.Feedback.Error, contrastText: a.Feedback.Error },
          info: { main: t.Feedback.Info, contrastText: a.Primary },
          warning: { main: t.Feedback.Warning, contrastText: a.Feedback.Warning },
          success: { main: t.Feedback.Success, contrastText: a.Feedback.Success },
          text: {
            primary: a.Primary,
          ...
          action: { hover: t.TypeAction.Hover, selected: t.TypeAction.Selected },
          background: { default: t.App.Background, paper: t[2].Fill },
          divider: t[1].Outline,
        });
      var C = l(84032),
        x = l(41265);
      let B = [
        ...
        L = (e, t, l) => ({
          [d.b.breakpoints.up(l)]: { fontSize: w[e]?.[l], lineHeight: y[t]?.[l] },
        }),
        S = ({
          fontFamily: e,
          fontSize: t,
        ...
        k = ({ Text: e }) => ({
          ...
          ...B.reduce((e, t) => ({ ...e, [t]: void 0 }), {}),
          ...Object.fromEntries(
            Object.entries(M).map(([t, l]) => {
              let { fontFamily: a, ...r } = S(l);
              return [t, { ...r, fontFamily: x.vX[e.FontFamily[a]] }];
            })
          ),
        }),
        ...
        O = { light: (e) => T('light', e), dark: (e) => T('dark', e), chad: (e) => T('chad', e) },
        P = i()((e, t) => O[e]({ inverted: t })),
        j = ({ theme: e, children: t }) => (0, a.jsx)(m.A, { theme: P(e), children: t }),
        N = ({ children: e, inverted: t = !0 }) => {
          let { theme: l } = (0, n.A)().design,
            r = P(l, t);
          return (0, a.jsx)(m.A, { theme: r, children: e });
        };
    },
    75778: (e, t, l) => {
      l.d(t, { ku: () => c, ps: () => m });
    ...
    76586: (e, t, l) => {
      ...
      let d = (e) => e.design.Layer.TypeAction.Hover,
        o = ({ children: e, hoverEl: t, hoverColor: l = d }) => {
          let [o, F, h] = (0, i.K)(!1),
            p =
              (function (e, t) {
            ...
            s = e.props.sx ?? {};
          return (
            (0, c.Vg)(t, 'mouseenter', F),
            (0, a.jsx)(n.i, {
              inverted: p,
              children: (0, r.cloneElement)(e, {
                ...e.props,
                className: (0, c.xW)(p && c.Q6, e.props?.className),
                onMouseEnter: F,
                onMouseLeave: h,
                sx: {
                  ...s,
                  ...
                  '&:hover': { ...s['&:hover'], backgroundColor: l },
                  ...(p && { backgroundColor: l }),
                },
              }),
            })
    ...
    76635: (e, t, l) => {
      l.d(t, { Cn: () => c, Rm: () => n, SW: () => o, b0: () => r, dB: () => m, vV: () => d });
      var a = l(84826),
        r = (function (e) {
          return (
            (e.ERROR = 'error'),
    ...
    81473: (e, t, l) => {
      ...
      let { Spacing: i } = l(84032).B,
        ...
        o = 'size-medium',
        F = 'size-large',
        h = { contained: n, underlined: m, overlined: c },
        p = { small: d, medium: o, large: F },
        s = ({ Tabs: { Transition: e } }) => ({
          styleOverrides: {
            root: {
              transition: e,
        ...
        f = ({ Label: e, Fill: t, Outline: l }) => ({
          color: e,
          backgroundColor: t,
          '::after': { backgroundColor: l ?? 'transparant' },
        }),
        ...
        g = ({ Tabs: { UnderLined: e, OverLined: t, Contained: l }, Layer: a }) => ({
          styleOverrides: {
            root: {
              ...
              [`&.${n}`]: {
                '& .MuiTab-root': E(l),
                [`&.${d} .MuiTab-root`]: z('xs', 'xs', 'md', 'md'),
                [`&.${o} .MuiTab-root`]: z('md', 'xs', 'lg', 'lg'),
              },
              [`&.${c}`]: {
                '& .MuiTab-root': E(t),
                [`&.${d} .MuiTab-root`]: z('xs', 'xs', 'md', 'md'),
                [`&.${F} .MuiTab-root:hover`]: { backgroundColor: 'unset' },
                ...u,
              },
              [`&.${m}`]: {
                '& .MuiTab-root': E(e),
                [`&.${d} .MuiTab-root`]: z('xs', 'xs', 'sm', 'sm'),
                ...u,
              },
              [`&.${F} .MuiTab-root::after`]: { height: '0px' },
            },
            indicator: {
    ...
    84826: (e, t, l) => {
      ...
      let D = !!window.Cypress,
        w = 'curve.fi' !== window.location.hostname,
        L = w;
      async function S(e) {
        if ((0, a.P)(e))
          try {
    ...
    91920: (e, t, l) => {
      ...
      let T = (0, k.x)({
        ...
        j = (0, k.x)({
          ...
          name: 'MEGA Testnet',
          testnet: !0,
          nativeCurrency: H.r.nativeCurrency,
      ...
      let W = Object.fromEntries(
          R.map((e) => [
            e.id,
            (0, r.N)([(0, i.l)(a.b), (0, n.L)(void 0, { batch: { batchSize: 3 } })]),
          ])
        ),
        U = (0, m.Z)({ chains: R, connectors: Object.values(_.t), transports: W });
    },
    94046: (e, t, l) => {
      l.d(t, { c: () => a });
      let a = {
    ...
    96252: (e, t, l) => {
      l.d(t, { gu: () => m, kB: () => n, oe: () => i, wj: () => d });
      var a = l(36074),
        r = l(47636);
      let i = (e) => e?.chainId,
        n = (e) => e?.account?.address,
        m = ({ chains: e, provider: t, accounts: [l], label: a }) => ({
          chainId: Number(BigInt(e[0].id).toString()),
          provider: t,
          account: { ensName: l.ens?.name, address: l.address },
          label: a,
        }),
        c = (e, t) => new Promise((l, a) => setTimeout(() => a(Error(e)), t)),
        d = (e, t = (0, a.t)`Timeout connecting wallet`, l = r.oX['3s']) =>
          Promise.race([e, c(t, l)]);
    },
    99599: (e, t, l) => {
      l.d(t, { A: () => r.A, V: () => a.A });
      var a = l(71741),
