  ...
  [2711],
  {
      ...
      function l({ tokens: e, ...s }) {
        ...
        return (0, t.jsx)(i.A, {
          ...
          sx: {
            ...
            [`& > *:nth-of-type(${o}n-1):nth-last-of-type(1)`]: {
              gridColumn: `span ${n}`,
            },
          },
    ...
    62196: (e, s, r) => {
      ...
      var t = r(54568),
        ...
        a = r(12819),
        l = r(94990);
      let o = (0, i.Ay)(a.A).withConfig({
          componentId: 'sc-9d409d30-0',
        })(['min-height:3.375rem;']),
        n = function ({
          className: e = '',
          searchText: s,
    ...
    67520: (e, s, r) => {
      ...
      var t = r(54568),
        ...
        h = r(70657),
        p = r(71287);
      let m = l.Ay.div.withConfig({
          componentId: 'sc-7447a108-0',
        })(['line-height:1.2;']),
        x = ({
          isHighlightBase: e,
          isHighlightCrv: s,
      ...
      let A = ({ isHighLight: e, tvlCached: s, tvl: r }) =>
          (0, t.jsx)(u.v, {
            ...
            children: (0, f.ZV)(r?.value ?? s?.value, {
              currency: 'USD',
              notation: 'compact',
            }),
          }),
      ...
      var I = r(47990),
        ...
        N = r(84561),
        T = r(24633);
      let R = l.Ay.div.withConfig({
          componentId: 'sc-fd906268-0',
        })([
          'display:flex;justify-content:space-between;padding:4px;padding-left:var(--spacing-narrow);width:100%;',
        ]),
        O = l.Ay.div.withConfig({
          componentId: 'sc-fd906268-1',
        })(['display:grid;min-height:150px;padding:', ';'], ({ themeType: e }) =>
          'chad' === e ? '1rem 0.75rem 0.75rem' : '1rem 1rem 0.75rem 1rem'
        ),
        M = l.Ay.div.withConfig({
          componentId: 'sc-fd906268-2',
        })([
          'margin:0.3rem 0;> button:not(:last-of-type){border-right:1px solid rgba(255,255,255,0.25);}',
        ]),
        S = l.Ay.div.withConfig({
          componentId: 'sc-fd906268-3',
        })([
            ...
            G = (0, a.useMemo)(() => {
              if (_ && !P) {
                ...
                if ('rewardsOther' === _)
                  ...
                  return (0, f.ZV)(z?.value, {
                    notation: 'compact',
                    currency: 'USD',
                  });
                else if ('tvl' === _)
                  return (0, f.ZV)(F?.value, {
                    notation: 'compact',
                    currency: 'USD',
                  });
              }
      ...
      var _ = r(39651);
      let Z = l.Ay.col.withConfig({
          componentId: 'sc-ffc2c4ea-0',
        })(
          [
            '@media (min-width:',
        ...
        G = l.Ay.col.withConfig({
          componentId: 'sc-ffc2c4ea-1',
        })(['width:21px;']),
        J = (0, l.Ay)(o.d8).withConfig({
          componentId: 'sc-ffc2c4ea-2',
        })(['font-size:var(--font-size-2);']),
        X = (0, l.Ay)(o.rl).withConfig({
          componentId: 'sc-ffc2c4ea-3',
        ...
        q = ({
          ...
          let h = (0, a.useCallback)(
            ...
            p = {
              sortBy: n.sortBy,
              sortByOrder: n.sortByOrder,
              handleBtnClickSort: h,
            },
                      ...
                      children: [
                        ...
                        s === w.m.rewardsDesktop &&
                          (0, t.jsxs)(t.Fragment, {
                            children: [
                              (0, t.jsx)(Z, {
                                className: 'right base',
                              }),
                              (0, t.jsx)(Z, {
                                className: 'right rewards',
                              }),
                            ],
                          }),
                        s === w.m.rewardsMobile &&
      ...
      let ee = l.Ay.col.withConfig({
          componentId: 'sc-3c6e0c19-0',
        })(
          ['@media (min-width:', 'rem){&.pool{min-width:400px;}&.rewards{min-width:310px;}}'],
          _.fi.lg
        ),
        es = l.Ay.col.withConfig({
          componentId: 'sc-3c6e0c19-1',
        })(['width:25px;']);
      var er = r(59339),
        et = r(77540),
        ei = (function (e) {
      ...
      let ea = l.Ay.div.withConfig({
          componentId: 'sc-b1afab0e-0',
      ...
      var eh = r(62196),
        ep = r(33523),
        em = r(14026);
      let ex = l.Ay.div.withConfig({
          componentId: 'sc-9d596b1d-0',
        })(
          [
        ...
        eg = (0, l.Ay)(v.A).withConfig({
          componentId: 'sc-9d596b1d-1',
        })(
          [
          ...
          let m = (0, p.A)((e) => e.poolList.formStatus[s]),
            ...
            u = (0, a.useMemo)(
              () => [
                ...
                {
                  key: 'stableng',
                  label: (0, C.t)`Stable NG`,
                },
                {
                  key: 'cross-chain',
                  label: (0, C.t)`Cross-chain`,
                },
                {
                  key: 'user',
                  label: (0, C.t)`My Pools`,
                },
              ],
              []
            ),
      ...
      let ek = (e) => {
              ...
              () => ({
                ...
                ...(x
                  ? {
                      rewardsLite: {
                        name: (0, C.t)`Rewards`,
                        mobile: (0, C.t)`Rewards`,
                      },
                    }
                  : {
                      rewardsBase: {
                        name: (0, C.t)`Base vAPY`,
                        mobile: (0, C.t)`Rewards Base`,
                      },
                      rewardsCrv: {
                        name: 'CRV',
                        mobile: (0, C.t)`Rewards CRV`,
                      },
                      rewardsOther: {
        ...
        eP = l.Ay.div.withConfig({
          componentId: 'sc-35e6d4a-0',
        })(
          [
    ...
    88935: (e, s, r) => {
      ...
      let n = (0, i.i7)(['0%{opacity:0;transform:scale(0.5);}100%{opacity:1;transform:scale(1);}']),
        d = (0, i.Ay)(l.A).withConfig({
          componentId: 'sc-c8553551-0',
        })(
          ['padding:0.5rem;opacity:0;&.pop-in{animation:', ' 0.25s;animation-fill-mode:forwards;}'],
          n
        ),
        c = i.Ay.div.withConfig({
          componentId: 'sc-c8553551-1',
        })([
    ...
    90395: (e, s, r) => {
      ...
      var t = r(54568),
        ...
        n = r(77241),
        d = r(36074);
      let c = a.Ay.p.withConfig({
          componentId: 'sc-d3941c84-0',
        })(['font-weight:bold;margin-bottom:var(--spacing-1);white-space:nowrap;']),
        h = (0, a.Ay)(o.v).withConfig({
          componentId: 'sc-d3941c84-1',
            ...
            (0, t.jsxs)(l.A, {
              children: [
                ...
                (0, t.jsxs)('ul', {
                  children: [
                    (0, t.jsxs)('li', {
                      children: ['Daily: ', (0, n.ZV)(e?.day, n.hd.PERCENT)],
                    }),
                    (0, t.jsxs)('li', {
                      children: ['Weekly: ', (0, n.ZV)(e?.week, n.hd.PERCENT)],
                    }),
                  ],
                }),
                e?.day &&
    ...
    96025: (e, s, r) => {
      ...
      let x = ({ className: e, ...s }) => {
        ...
        g = o.Ay.button.withConfig({
          componentId: 'sc-5ad86fca-0',
        })([
        ...
        A = o.Ay.span.withConfig({
          componentId: 'sc-5ad86fca-3',
        })(['margin-right:2px;font-family:var(--font-mono);font-size:var(--font-size-2);']),
        j = (0, o.Ay)(h.A).withConfig({
          componentId: 'sc-5ad86fca-4',
        })(
          [
        ...
        w = (0, o.Ay)(c.A).withConfig({
          componentId: 'sc-5ad86fca-5',
      ...
      let P = ({ className: e, ...s }) => {
        ...
        I = o.Ay.button.withConfig({
          componentId: 'sc-81d6bdb3-0',
        })([
        ...
        T = o.Ay.span.withConfig({
          componentId: 'sc-81d6bdb3-3',
        })([
          'margin:0 2px;position:relative;top:-2px;font-size:var(--font-size-1);font-weight:bold;',
        ]),
        R = (0, o.Ay)(c.A).withConfig({
          componentId: 'sc-81d6bdb3-4',
      ...
      var M = r(79614),
        ...
        H = r(46205),
        z = r(55928);
      let E = o.Ay.div.withConfig({
          componentId: 'sc-7b0963a-0',
        })(['min-width:3.3125rem;']),
        V = o.Ay.div.withConfig({
          componentId: 'sc-7b0963a-1',
        })([
          'display:grid;align-items:center;grid-template-columns:auto 1fr;grid-column-gap:var(--spacing-2);width:100%;',
        ]),
        K = o.Ay.div.withConfig({
          componentId: 'sc-7b0963a-2',
        })(['min-height:1.5rem;max-width:24.375rem;']),
        U = o.Ay.span.withConfig({
          componentId: 'sc-7b0963a-3',
        })(['font-size:var(--font-size-2);']),
        W = (0, o.Ay)(D.A).withConfig({
          componentId: 'sc-7b0963a-4',
        })([
        ...
        Y = ({
          ...
          let { pool: n } = i ?? {},
            d = (0, l.useMemo)(
              () =>
                a()(i?.tokens, i?.tokenAddresses).map(([e, s]) => ({
                  symbol: e,
                  address: s,
                })),
  ...
  (e) => {
    ...
    e.O(
      ...
      [
        ...
        4925, 9720, 9556, 4237, 2226, 7653, 9630, 4034, 7587, 4845, 8534, 5476, 4968, 41, 7399,
        3414, 1451, 1287, 587, 8315, 7358,
      ],
      () => s(96244)
    ),
      (_N_E = e.O());
