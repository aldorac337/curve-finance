  ...
  [8373],
  {
    4289: (e, t, l) => {
      ...
      function c({
        ...
        let f = (e, t) => (0, F.p6)(d, e, t),
          z = (e) => (0, F.VG)(d, e) && !h?.(e).some((e) => !m.q.getQueryData(e)),
          s = ({ queryKey: t }) => (
            (0, r.dB)(t),
            e(
              f(
          ...
          o = (e, m = !0) =>
            (0, a.j)({
              ...
              queryFn: s,
              staleTime: i.o[l ?? '5m'],
              refetchInterval: c ? i.o[c] : void 0,
              enabled: m && z(e),
              refetchOnWindowFocus: E,
              refetchOnMount: p,
            });
        return {
          assertValidity: f,
          checkValidity: (e, t) => (0, F.VG)(d, e, t),
          isEnabled: z,
          queryKey: t,
          getQueryOptions: o,
          getQueryData: (e) => m.q.getQueryData(t(e)),
          setQueryData: (e, l) => m.q.setQueryData(t(e), l),
          prefetchQuery: (e, l = 0) =>
            m.q.prefetchQuery({ queryKey: t(e), queryFn: s, staleTime: l }),
          fetchQuery: (e) => m.q.fetchQuery(o(e)),
          useQuery: (0, n.GQ)(o),
          invalidate: (e) => m.q.invalidateQueries({ queryKey: t(e) }),
        };
      }
    },
    4387: (e, t, l) => {
      ...
      let bD = (e) =>
        bg.createElement(
          'svg',
          bC({ xmlns: 'http://www.w3.org/2000/svg', fill: 'none', viewBox: '0 0 17 18' }, e),
          m ||
      ...
      let b_ = (e) =>
          bg.createElement(
            'svg',
            bP({ xmlns: 'http://www.w3.org/2000/svg', fill: 'none', viewBox: '0 0 15 15' }, e),
            bp ||
      ...
      let bk = (e) =>
        bg.createElement(
          'svg',
          bN({ xmlns: 'http://www.w3.org/2000/svg', viewBox: '0 0 24 24' }, e),
          bf ||
            (bf = bg.createElement('path', {
      ...
      let bX = (e) =>
        bg.createElement(
          'svg',
          bI({ xmlns: 'http://www.w3.org/2000/svg', viewBox: '0 0 24 24' }, e),
          bz ||
      ...
      let bL = (e) =>
        bg.createElement(
          'svg',
          bQ({ xmlns: 'http://www.w3.org/2000/svg', width: 18, height: 16, fill: 'none' }, e),
          bs ||
      ...
      let bT = (e) =>
        bg.createElement(
          'svg',
          bO({ xmlns: 'http://www.w3.org/2000/svg', viewBox: '0 0 24 24' }, e),
          bo ||
      ...
      let bG = (e) =>
        bg.createElement(
          'svg',
          bR({ xmlns: 'http://www.w3.org/2000/svg', width: 14, height: 14, fill: '#EA3943' }, e),
          bA ||
            (bA = bg.createElement('path', {
              fillRule: 'evenodd',
    ...
    21802: (e, t, l) => {
      ...
      let m = {
        ...
        r = { PAGE_MARKETS: '/markets', PAGE_DISCLAIMER: '/disclaimer' },
        i = {
        ...
        F = {
          dex: {
            label: 'DEX',
            routes: [
              { app: 'dex', route: m.PAGE_SWAP, label: () => (0, a.t)`Quickswap` },
              { app: 'dex', route: m.PAGE_POOLS, label: () => (0, a.t)`Pools` },
              { app: 'dex', route: m.PAGE_CREATE_POOL, label: () => (0, a.t)`Pool Creation` },
              { app: 'dex', route: m.PAGE_DASHBOARD, label: () => (0, a.t)`Dashboard` },
            ],
          },
          crvusd: {
            label: 'crvUSD',
          ...
          lend: {
            label: 'Lend',
            routes: [{ app: 'lend', route: r.PAGE_MARKETS, label: () => (0, a.t)`Lend` }],
          },
          dao: {
            label: 'DAO',
            routes: [
        ...
        c = (e, t, l = '/') => `/${e}/${t}${l}`,
        d = ({ route: e, target: t, label: l, app: a }, { networkName: m, pathname: r }) => {
          let i = e.startsWith('http') ? e : c(a, m, e);
          return { href: i, target: t, label: l(), isActive: r?.startsWith(i.split('?')[0]) };
        };
    },
    23779: (e, t, l) => {
      l.d(t, { Jg: () => s, Xs: () => z, hJ: () => p });
      var a = l(16430),
        m = l(58648),
        r = l.n(m),
        i = l(44096),
      ...
      let f = (e) =>
        Array.isArray(e) ? e.map(f) : 'string' == typeof e ? e.replace(/₮/g, 'T') : e;
      function z(e, t, l, m) {
        let { addresses: i, tokens: n } = p(e),
          F =
            n.length > 0
              ? (function (e, t, l) {
                  let m = e.some((e) => e.includes('₮')),
                    i = new a.A(t, {
                      ignoreLocation: !0,
                      ignoreDiacritics: !0,
                      isCaseSensitive: !1,
          ...
          c =
            i.length > 0
              ...
              : { tokens: [], other: [] };
        return { tokensResult: [...F, ...c.tokens], addressesResult: c.other };
      }
      function s(e, t, l) {
        let { addressesResult: a, tokensResult: m } = z(e, t, ['symbol'], { tokens: ['address'] }),
          r = h()([...m, ...a], (e) => e.item.address);
        return r.length > 0 ? r.map((e) => e.item) : t.filter((t) => l(t.address, e));
      }
    },
    23795: (e, t, l) => {
      l.d(t, { c: () => i, t: () => r });
      ...
      let r = async (e, t) => {
        ...
        i = async (e, t) => {
          let { results: l, errors: a } = await m()
            .for(e)
            .process((e) => r(e, t));
    ...
    29514: (e, t, l) => {
      ...
      let F = (e, t, l) => 0 === Object.keys(e(t, l).getErrors()).length;
      function c(e, t, l) {
    ...
    35183: (e, t, l) => {
      ...
      let a = 'https://cdn.jsdelivr.net',
        ...
        r = `${m}/curve-assets`,
        i = 1e14,
        n = (e) => `${r}/images/assets${'ethereum' == e ? '' : `-${e}`}/`,
        F = (e) => `${r}/chains/${e}.png`,
        c = (e) => `${r}/branding/curve_illustration-${'dark' === e ? 'dark' : 'light'}.svg`;
    },
    36074: (e, t, l) => {
      l.d(t, { Y: () => r, t: () => a, x: () => m });
      let a = (e, ...t) =>
        ...
        m = ({ children: e }) => e,
        r = () => navigator.languages?.[0]?.startsWith('zh') ?? !1;
    },
    39651: (e, t, l) => {
      l.d(t, { HP: () => m, fi: () => a, tr: () => r });
      let a = { xxs: 20, xs: 30, sm: 26.625, md: 60.063, lg: 80, xl: 120.063 },
        m = (e) => (t) => `@media (min-width: ${a[e]}rem) { ${t} }`;
      function r(e) {
    ...
    47636: (e, t, l) => {
      l.d(t, { D$: () => m.D$, D6: () => a.D, X6: () => m.X6, oX: () => a.o }), l(94046);
      var a = l(89425),
        m = l(91069);
    },
    53082: (e, t, l) => {
      ...
      l.d(t, { _p: () => m, q5: () => a, z5: () => r });
    },
    57889: (e, t, l) => {
      l.d(t, { Ej: () => a, N6: () => r, VP: () => i, oJ: () => m });
      let a = {
        CONNECT_API: 'api',
    ...
    61873: (e, t, l) => {
      ...
      let F = new r.$({
        ...
        E = (0, a.s)({ storage: window.localStorage });
    },
    64174: (e, t, l) => {
      l.d(t, { Mj: () => F, ZB: () => r, zM: () => m });
      var a = l(7620);
      function m(e) {
      ...
      function F(e, t) {
        let [l, m] = (0, a.useState)(() => i(e, t)),
          F = (0, a.useCallback)(
            (l) => {
              let a = 'function' == typeof l ? l(i(e, t)) : l;
              r(e, a), m(a), n.dispatchEvent(new Event(e));
            },
            [t, e]
          );
        return (
    ...
    64269: (e, t, l) => {
      ...
      let d = a.A,
        h = (0, F.o0)((0, F.uz)('lang'), (0, F.sm)(), () => 'en') || 'en-US',
        E = {
      ...
      function z(e, t) {
        ...
        try {
          ...
          if (r()(Number(e))) return '?';
          {
            let l = { ...F, useGrouping: !0 };
              ...
              );
            {
              ...
              if (
                      ...
                      : t?.style === 'percent'
                        ...
                        : 'compact' === n
                          ? (delete l.minimumFractionDigits,
                            ...
                            r >= 1e6
                              ? ((l.maximumFractionDigits = p(c, 2)), (l.notation = n))
                              : r > 10
                                ? ((l.trailingZeroDisplay = 'stripIfInteger'),
                                  (l.maximumFractionDigits = 0),
                ...
                if (
                  (function (e, t) {
                    let { useGrouping: l, style: a, notation: m, ...r } = t;
                    return 0 === Number(new Intl.NumberFormat('en-US', r).format(Number(e)));
                  })(e, l)
                ) {
                  if (1e-9 > Number(e) && 'percent' !== l.style) return '<0.000000001';
                  {
                    let { minimumFractionDigits: t, maximumFractionDigits: a, ...m } = l;
                    return s(e, { ...m, minimumSignificantDigits: 2, maximumSignificantDigits: 2 });
                  }
                }
                if (9e-4 >= Number(e) && !('showAllFractionDigits' in (t ?? {}))) {
                  let { minimumFractionDigits: t, maximumFractionDigits: a, ...m } = l;
                  return s(e, { ...(m ?? {}), maximumSignificantDigits: 4 });
                }
              }
              return s(e, { ...l, ...F });
            }
      ...
      function o(e, t) {
        ...
        if (r()(e)) l = '$N/A';
          ...
          if (1e-7 > Number(e)) {
            ...
            t && delete e.currency, (l = `<${z(1e-7, e)}`);
          } else {
            let a = { ...(Number(e) > 10 ? { minimumFractionDigits: 2 } : {}), currency: 'USD' };
            t && delete a.currency, (l = z(e, a));
          }
        }
        return l;
      }
      ...
      let u = (e, t = 'short') =>
        ...
        g = (e) => u(new Date(1e3 * e)),
        C = (e) => e - 60 * new Date().getTimezoneOffset();
    },
    70697: (e, t, l) => {
      l.d(t, { v$: () => d, yE: () => h, px: () => r, GQ: () => c, it: () => n });
      var a = l(7620),
        m = l(84007);
      let r = (e) => ({
        ...
        n = (e, t) =>
          (0, m.useQueries)({ queries: e, combine: (0, a.useCallback)((e) => i(e, t), [t]) });
      var F = l(67933);
      let c = (e) => (t, l) => {
          let a = e(t, l);
          return (0, F.useQuery)(a);
        },
    ...
    72986: (e, t, l) => {
      ...
      var a = l(75334),
        ...
        o = l(11830),
        A = l(88259);
      let u = '982ea4bdf92e49746bd040a981283b36',
        g = (0, h.Ay)(),
        C = (0, s.A)({ email: 'info@curve.fi', appUrl: 'https://curve.fi' }),
        D = () => (0, E.A)({ walletConnectVersion: 2, projectId: u }),
        b = (0, d.A)({
          whitelistedDomains: [
        ...
        v = (0, n.A)({ darkMode: !0 }),
        B = (0, F.A)({ apiKey: 'pk_live_190B10CE18F47DCD' }),
        w = () => (0, A.A)({ projectId: u, dappUrl: window.location.origin }),
        y = (0, z.A)(),
        x = (0, f.A)(),
        S = (0, c.A)(),
        M = (0, o.A)(),
        ...
        U = (e, t) =>
          a.Ts({
            wallets: [g, C, D(), b, v, B, w(), y, x, S, P, M, _],
      ...
      let Q = (e) => e?.accounts[0]?.address,
        L = (e) => e?.accounts[0]?.ens?.name,
        O = (e, t) => new Promise((l, a) => setTimeout(() => a(Error(e)), t)),
        T = (e, t = (0, k.t)`Timeout connecting wallet`, l = I.oX['3s']) =>
          Promise.race([e, O(t, l)]),
        R = null,
        G = { provider: null, wallet: null },
        $ = 'walletName',
        j = () => {
          let [{ wallet: e, connecting: t }, l, i] = (0, a.VN)(),
            [n, F] = (0, N.Mj)($);
          (0, r.useEffect)(() => {
            (G.wallet = e),
              (G.provider =
          ...
          return {
            ...
            walletName: n,
            setWalletName: F,
            provider: j.getState().provider,
            signerAddress: c,
          };
        };
      (j.initialize = (...e) => (R = U(...e))),
        (j.getState = () => ({ wallet: G.wallet, provider: G.provider }));
      let K = (e, t, l) => {
        if (!R) throw Error('Onboard not initialized');
        return R.state.actions.customNotification({
          type: t,
          message: e,
      ...
      let V = {
        ...
        { HYDRATE: Y, SWITCH_NETWORK: ee, CONNECT_WALLET: et, CONNECT_API: el } = V,
        ea = (e) => e.status === Z,
        em = ({ status: e, stage: t }, l) => e === H && !!(!l || t?.startsWith(l)),
        er = ({ status: e, stage: t }, l) =>
          e === J &&
          !!(!l || (Array.isArray(l) ? l.some((e) => t?.startsWith(e)) : t?.startsWith(l))),
        ei = (0, r.createContext)({ connectState: { status: J } }),
        en = (e, t) => Q(e)?.toLowerCase() == t?.signerAddress?.toLowerCase(),
        eF = ({ hydrate: e, initLib: t, chainId: l, onChainUnavailable: m, children: i }) => {
          let [n, F] = (0, r.useState)({ status: J }),
            c = (0, r.useRef)(!1),
            { wallet: d, connect: h } = j(),
            [E, p] = (0, a.v3)();
          (0, r.useEffect)(() => {
            c.current && (0, N.ZB)($, d?.label ?? null);
          }, [d]),
            (0, r.useEffect)(() => {
              let a = new AbortController(),
                r = async (e) => (
                  F({ status: J, stage: et }),
                  T(h({ autoSelect: { label: e, disableModals: !0 } }))
                    .then((e) => e.length > 0)
                    .catch(() => !1)
                );
              return (
                (async () => {
                  try {
                    if (!c.current) {
                      c.current = !0;
                      let e = (0, N.zM)($);
                      if (e && (await r(e))) return;
                    }
                    let i = X(d);
                    if (
                      i &&
                      i !== l &&
                      (F({ status: J, stage: ee }), !(await p({ chainId: W.nD(l) })))
                    ) {
                      if (a.signal.aborted) return;
                      F({ status: H, stage: ee }), m([l, i]);
                    }
                    let n = ed.get();
                    if (!ed.get() || !en(d, n)) {
                      if (a.signal.aborted) return;
                    ...
                    if (a.signal.aborted) return;
                    F({ status: Z, stage: Y }), await e(ed.require(), n, d), F({ status: Z });
                  } catch (e) {
                    if ((console.error(e), a.signal.aborted)) return;
                    F(({ stage: e }) => ({ status: H, stage: e }));
                  }
                })(),
                () => a.abort()
              );
          ...
          let f = ed.get(),
            z = f?.chainId === l && en(d, f);
          return (0, q.jsx)(ei.Provider, {
            value: { connectState: n, ...(z && { lib: f }) },
            children: i,
          });
        },
        ec = () => (0, r.useContext)(ei),
        ed = {
          current: null,
          get: () => ed.current,
          require: () => {
            if (!ed.current) throw Error('Lib not initialized');
            return ed.current;
          },
          set: (e) => (ed.current = e),
        },
        eh = () => ed.get();
      var eE = l(56120);
      let ep = ({ onConnectWallet: e, label: t, ...l }) =>
        (0, q.jsx)(eE.A, {
          size: 'small',
          color: 'primary',
          onClick: e,
      ...
      var ef = l(84826);
      let ez = ({ walletAddress: e, onDisconnectWallet: t, ...l }) =>
          (0, q.jsx)(eE.A, {
            size: 'small',
            color: 'ghost',
            onClick: t,
        ...
        es = ({ walletAddress: e, label: t, onConnectWallet: l, onDisconnectWallet: a, ...m }) => {
          let { signerAddress: r, connect: i, disconnect: n, wallet: F } = j();
          return F && r
            ? (0, q.jsx)(ez, {
                walletAddress: e ?? r,
                onDisconnectWallet: () => (a ? a() : n({ label: F.label })),
                ...m,
              })
            : (0, q.jsx)(ep, { label: t, onConnectWallet: () => (l ?? i)(), ...m });
        };
      var eo = l(61773),
        eA = l(31184),
        eu = l(32678),
      ...
      let ev = ({
          ...
          (0, q.jsxs)(eA.A, {
            padding: 7,
            spacing: 8,
            width: eb.B.MaxWidth.connectWallet,
            maxWidth: '90vw',
            ...
            children: [
              (0, q.jsxs)(eA.A, {
                ...
                sx: {
                  backgroundImage: (e) => `url(${(0, eD.K4)(e.key)})`,
                  backgroundSize: 'contain',
                  backgroundPosition: 'center',
                  backgroundRepeat: 'no-repeat',
                },
                children: [
                  (0, q.jsx)(eB, { src: eC.jp, alt: 'Curve Logo' }),
                  (0, q.jsx)(eg.A, { variant: 'headingXxl', children: (0, k.t)`Enter Curve` }),
                ],
              }),
              (0, q.jsxs)(eA.A, {
                spacing: 3,
                alignItems: 'center',
                children: [
                  (0, q.jsx)(eg.A, { variant: 'bodyMRegular', children: e }),
                  (0, q.jsx)(eE.A, {
                    size: 'large',
                    color: 'primary',
                    onClick: a,
    ...
    76635: (e, t, l) => {
      l.d(t, { Cn: () => F, Rm: () => i, SW: () => d, b0: () => m, dB: () => n, vV: () => c });
      var a = l(84826),
        m = (function (e) {
          return (
            (e.ERROR = 'error'),
      ...
      function i(e, t, ...l) {
        ...
        let n = new Date().toISOString(),
          F = 'string' == typeof e ? e.split('.') : Array.isArray(e) ? e : [e],
          c = (e) => {
            switch (e) {
              case 'error':
        ...
        if (a.OC) return c(t)(t, JSON.stringify({ keyArray: F, args: l }).slice(0, 300));
        let d = t && Object.values(m).includes(t),
          [h, E] = ((e) => {
            let t = '',
              l = [];
            return (
      ...
      let i = (e) =>
        ...
        n = (e) => {
          let t = Math.abs(new Date().getTime() - i(e).getTime()),
            l = Math.floor(t / 6e4),
            a = Math.floor(t / 36e5),
            m = Math.floor(t / 864e5);
          return m > 0 ? `${m}d` : a > 0 ? `${a}h` : `${l}m`;
        };
      l(46759);
      var F = l(64269),
        c = l(57889),
    ...
    82994: (e, t, l) => {
      ...
      let i = {
          ...
          gasPricesDefault: 0,
          integrations: {
            listUrl: `${r.w2}/curve-external-integrations/integrations-list.json`,
            tagsUrl: `${r.w2}/curve-external-integrations/integrations-tags.json`,
          },
          rewards: {
            baseUrl: r.nE,
            campaignsUrl: `${r.w2}/curve-external-reward@latest/campaign-list.json`,
            tagsUrl: `${r.w2}/curve-external-reward@latest/reward-tags.json`,
          },
          orgUIPath: '',
        },
        n = {
      ...
      function F(e, t) {
        ...
        return {
          ...
          networkId: r,
          hex: m.nD(e),
          logoSrc: `https://cdn.jsdelivr.net/gh/curvefi/curve-assets/chains/${r}.png`,
          logoSrcDark: `https://cdn.jsdelivr.net/gh/curvefi/curve-assets/chains/${r}-dark.png`,
          rpcUrl: F,
          isTestnet: c,
    ...
    84826: (e, t, l) => {
      ...
      class n {
        ...
        constructor(e, t = 0) {
          ...
          if ('string' == typeof e) {
            ...
            let [, a, m, r = ''] = l;
            (this._integerPart = BigInt(m || '0')),
              (this._fractionalPart = BigInt(r.padEnd(t, '0'))),
              (this._scale = Math.max(r.length, t)),
              (this._isNegative = '-' === a);
            return;
          }
        ...
        div(e, t = this._scale) {
          ...
          let l = this.scaleUp(t + e._scale + 1),
            a = e.scaleUp(0),
            m = l.toScaledBigInt(),
            r = new n(m / a.toScaledBigInt(), t);
          return (r._isNegative = this._isNegative !== e._isNegative), r;
        }
        create(e, t = 0) {
      ...
      var w = l(23779);
      let y = !!window.Cypress,
        x = 'curve.fi' !== window.location.hostname;
      async function S(e) {
        if ((0, a.P)(e))
          try {
            e = (0, m.b)(e);
    ...
    91069: (e, t, l) => {
      ...
      let m = {
        ...
        pool: ({ chainId: e, poolId: t }) => [...m.chain({ chainId: e }), 'pool', { poolId: t }],
        contract: ({ blockchainId: e, contractAddress: t }) => [
          ...m.chainName({ blockchainId: e }),
          'contract',
          { contractAddress: t },
        ],
        gauge: ({ chainId: e, poolId: t }) => [...m.pool({ chainId: e, poolId: t }), 'gauge'],
      };
    },
    94046: (e, t, l) => {
      l.d(t, { c: () => a });
