  ...
  [104],
  {
    1334: (e, t, r) => {
      ...
      var l = r(54568),
        ...
        m = r(87401),
        v = r(36074);
      let w = ({ isBeta: e, setIsBeta: t, open: r, openBetaSnackbar: s, onClose: n }) =>
        (0, l.jsx)(g.A, {
          open: r,
          onClose: n,
          children: (0, l.jsxs)(h.A, {
            sx: {
              width: c.B.ModalWidth.md,
              maxWidth: '100vw',
              display: 'flex',
            ...
            children: [
              (0, l.jsx)(x.A, {
                ...
                title: (0, l.jsx)(m.A, {
                  ...
                  color: 'textSecondary',
                  children: e ? (0, v.t)`Disable Beta Features` : (0, v.t)`Enable Beta Features`,
                }),
              }),
              (0, l.jsx)(p.A, {
                sx: {
                ...
                children: [
                  (0,
                  v.t)`Get early access to upcoming features and UI experiments before they go live.`,
                  (0,
                  v.t)`These are work-in-progress tools meant for testing, feedback, and iteration. You might experience minor bugs or visual inconsistencies — but your funds remain safe, and core functionality is unaffected.`,
                  (0,
                  v.t)`By enabling beta mode, you help shape the future of the Curve interface.`,
                  (0, v.t)`You can turn this off at any time.`,
                ].map((e) => (0, l.jsx)(m.A, { color: 'textSecondary', children: e }, e)),
              }),
              (0, l.jsx)(u.A, {
      ...
      let B = ({ isBeta: e, open: t, onClose: r, headerHeight: s }) =>
        (0, l.jsx)(j.A, {
          ...
          children: (0, l.jsxs)(b.A, {
            ...
            children: [
              (0, l.jsx)(L.A, {
                children: e ? (0, v.t)`Beta Features On` : (0, v.t)`Beta Features Off`,
              }),
              e
                ? (0, v.t)`You have successfully enabled beta features.`
                : (0, v.t)`You have successfully disabled beta features.`,
            ],
          }),
        });
      var y = r(51121),
        Q = r(26055);
      let { IconSize: H, Spacing: M, FontWeight: Z } = c.B,
        U = () =>
          (0, l.jsxs)(s.A, {
            ...
            children: [
              (0, l.jsxs)(y.A, {
                href: '/',
                sx: { display: 'flex', alignItems: 'center', textDecoration: 'none', gap: M.xs },
                children: [
                  (0, l.jsx)(Q.A, {
                    sx: { width: H.xxl, height: H.xxl, margin: M.sm },
              ...
              (0, l.jsx)(m.A, {
                ...
                sx: { textWrap: 'balance' },
                children: (0,
                v.t)`Curve DAO is building the software that powers the future world economy: decentralised, trustless, inclusive and autonomous.`,
              }),
            ],
          });
      var V = r(27261),
        k = r.n(V);
      let O = ({ label: e, href: t, icon: r, target: s = '_blank', appName: n, networkId: i }) =>
          (0, l.jsx)(d.A, {
            ...(t.startsWith('http')
              ? { component: y.A, href: t, target: s, rel: 'noreferrer' }
              : { component: k(), href: `/${n}/${i}/${t}` }),
            color: 'ghost',
            variant: 'link',
            startIcon: r,
            children: e,
          }),
        P = ({ title: e, links: t, networkId: r, appName: s }) =>
          (0, l.jsxs)(n.A, {
            container: !0,
            spacing: 1,
            children: [
              ...
              t.map((e) =>
                (0, l.jsx)(
                  n.A,
                  {
                    ...
                    children: (0, l.jsx)(O, { ...e, appName: s, networkId: r }),
                  },
                  e.href
                )
              ),
      ...
      let X = (0, I.A)(
        ...
        er = (e) => [
          {
            ...
            links: [
              ...
              {
                label: (0, v.t)`Announcements`,
                href: 'https://t.me/curvefiann',
                icon: (0, l.jsx)($, {}),
              },
              { label: (0, v.t)`Telegram`, href: 'https://t.me/curvefi', icon: (0, l.jsx)($, {}) },
              {
                label: (0, v.t)`Telegram (CN)`,
                href: 'https://t.me/curveficn',
                icon: (0, l.jsx)(_, {}),
              },
              {
                label: (0, v.t)`Telegram (RU)`,
          ...
          },
          {
            ...
            links: [
              ...
              {
                label: (0, v.t)`User Docs`,
                href: 'https://resources.curve.finance/',
                icon: (0, l.jsx)(R.A, {}),
              },
              { label: (0, v.t)`Integrations`, href: 'integrations/', icon: (0, l.jsx)(G, {}) },
              {
                label: (0, v.t)`Technical Docs`,
          ...
          },
          {
            ...
            links: [
              ...
              {
                label: (0, v.t)`Bug Bounty`,
                href: 'https://docs.curve.finance/security/security/#bug-bounty',
                icon: (0, l.jsx)(N.A, {}),
              },
              {
                label: (0, v.t)`Curve Monitor`,
                href: 'https://curvemonitor.com/',
                icon: (0, l.jsx)(Y, {}),
              },
              { label: (0, v.t)`CrvHub`, href: 'https://crvhub.com/', icon: (0, l.jsx)(J, {}) },
              {
                label: (0, v.t)`Dune Analytics`,
                href: 'https://dune.com/mrblock_buidl/Curve.fi',
                icon: (0, l.jsx)(q, {}),
              },
              {
                label: (0, v.t)`API Status`,
        ...
        el = o.NC.src,
        es = (0, i.Ay)('img')({ alt: 'Llama', position: 'absolute' }),
        en = ({ appName: e, networkId: t, headerHeight: r }) => {
          let [i, o, C] = (0, A.K)(),
            [d, h, u] = (0, A.K)(),
            [p, x] = (0, a.iq)();
          return (0, l.jsx)(s.A, {
            ...
            children: (0, l.jsxs)(n.A, {
              ...
              children: [
                (0, l.jsx)(n.A, { size: { mobile: 12, desktop: 3 }, children: (0, l.jsx)(U, {}) }),
                er(e).map((r) =>
                  (0, l.jsx)(
                    n.A,
                    {
                      size: { mobile: 12, tablet: 4, desktop: 3 },
                      children: (0, l.jsx)(P, { ...r, networkId: t, appName: e }),
                    },
                    r.title
                  )
                ),
                ...
                null != d && (0, l.jsx)(B, { open: d, onClose: u, headerHeight: r, isBeta: p }),
              ],
            }),
          });
        };
    ...
    86895: (e, t, r) => {
      ...
      let X = Object.fromEntries(
          J.map((e) => [
            e.id,
            (0, a.N)([(0, A.l)(o.b), (0, c.L)(void 0, { batch: { batchSize: 3 } })]),
          ])
        ),
        q = (0, C.Z)({ chains: J, connectors: Object.values(K.t), transports: X });
      var G = r(75911),
        Y = r(61873),
        F = r(84826),
        W = r(87606),
        _ = r(82099),
        $ = r(54152);
      function ee({ children: e, persister: t, queryClient: r }) {
        return ((e = (0, l.jsxs)(l.Fragment, { children: [e, !F.OC && (0, l.jsx)(_.E, {})] })), t)
          ? (0, l.jsx)($.t, { client: r, persistOptions: { persister: t }, children: e })
          : (0, l.jsx)(W.QueryClientProvider, { client: r, children: e });
      }
      var et = r(74043),
        er = r(41265);
      let el = ({ children: e, loading: t }) => {
        let r = (0, G.nv)((e) => e.theme);
        return (0, l.jsxs)('div', {
          ...
          children: [
            ...
            (0, l.jsx)(et.N, {
              theme: r,
              children: (0, l.jsx)(i.so, {
                children: (0, l.jsx)(ee, {
                  persister: Y.a,
                  queryClient: Y.q,
                  children: (0, l.jsx)(s.x, { config: q, reconnectOnMount: !0, children: !t && e }),
                }),
              }),
            }),
          ],
