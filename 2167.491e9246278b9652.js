...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [2167],
  {
      ...
      class o {
        ...
        async initUi() {
          if ('undefined' != typeof window) {
            await s.e(3881).then(s.bind(s, 83881));
    ...
    39829: (e, t, s) => {
        ...
        [u] = ((
          ...
          f = (r) => {
            ...
            let i = u[0],
              ...
              W = Array.isArray(r) ? [] : Object.create(Object.getPrototypeOf(r)),
              O = {
                deleteProperty(e, t) {
                ...
                set(t, r, o, a) {
                  let i = Reflect.has(t, r),
                    u = Reflect.get(t, r, a);
                  if (i && (e(u, o) || (l.has(o) && e(u, l.get(o))))) return !0;
                  I(r), c(o) && (o = n(o) || o);
                  let h = o;
                  if (o instanceof Promise)
                    ...
                    !d.has(o) && s(o) && (h = f(o));
                    let e = !p.has(h) && d.get(h);
                    e && w(r, e);
                  }
                  return Reflect.set(t, r, h, a), g(['set', [r], o, u]), !0;
                },
              },
              E = t(W, O);
            l.set(r, E);
            ...
            return (
              ...
              Reflect.ownKeys(r).forEach((e) => {
                ...
                'value' in t && ((E[e] = r[e]), delete t.value, delete t.writable),
                  Object.defineProperty(W, e, t);
              }),
              E
            );
          }
        ) => [f, d, p, e, t, s, r, o, a, l, u])();
      function f(e = {}) {
        return u(e);
      }
      function h(e, t, s) {
      ...
      var g = s(50887).Buffer;
      let m = f({ history: ['ConnectWallet'], view: 'ConnectWallet', data: void 0 }),
        b = {
          state: m,
          subscribe: (e) => h(m, () => e(m)),
          push(e, t) {
        ...
        y = {
          ...
          setModalVersionInStorage() {
            try {
              'undefined' != typeof localStorage && localStorage.setItem(y.WCM_VERSION, '2.7.0');
            } catch (e) {
        ...
        O = {
          ...
          setConfig(e) {
            ...
            w.initialize(),
              ...
              C.setIsCustomMobile(!!(null == (t = e.mobileWallets) ? void 0 : t.length)),
              C.setIsCustomDesktop(!!(null == (s = e.desktopWallets) ? void 0 : s.length)),
      ...
      var E = Object.defineProperty,
        ...
        k = (e, t, s) =>
          t in e
            ? E(e, t, { enumerable: !0, configurable: !0, writable: !0, value: s })
            : (e[t] = s),
        M = (e, t) => {
          for (var s in t || (t = {})) j.call(t, s) && k(e, s, t[s]);
          if (L) for (var s of L(t)) A.call(t, s) && k(e, s, t[s]);
          return e;
        };
      ...
      let S = {
        ...
        getWalletImageUrl: (e) =>
          `${D}/w3m/v1/getWalletImage/${e}?projectId=${O.state.projectId}&sdkType=wcm&sdkVersion=${U}`,
        getAssetImageUrl: (e) =>
          `${D}/w3m/v1/getAssetImage/${e}?projectId=${O.state.projectId}&sdkType=wcm&sdkVersion=${U}`,
      };
      var N = Object.defineProperty,
        ...
        x = (e, t, s) =>
          t in e
            ? N(e, t, { enumerable: !0, configurable: !0, writable: !0, value: s })
            : (e[t] = s),
        $ = (e, t) => {
          for (var s in t || (t = {})) _.call(t, s) && x(e, s, t[s]);
          if (T) for (var s of T(t)) R.call(t, s) && x(e, s, t[s]);
          return e;
        };
      let H = y.isMobile(),
        V = f({
        ...
        K = {
          ...
          async getRecomendedWallets() {
            let { explorerRecommendedWalletIds: e, explorerExcludedWalletIds: t } = O.state;
            ...
            if (y.isArray(e)) {
              ...
              let { chains: e, isAuth: s } = C.state,
                ...
                { listings: l } = H ? await S.getMobileListings(a) : await S.getDesktopListings(a);
              V.recomendedWallets = Object.values(l);
            }
            return V.recomendedWallets;
          },
          async getWallets(e) {
            let t = $({}, e),
              { explorerRecommendedWalletIds: s, explorerExcludedWalletIds: r } = O.state,
            ...
            let { page: a, search: l } = e,
              { listings: n, total: i } = H
                ? await S.getMobileListings(t)
                : await S.getDesktopListings(t),
              c = Object.values(n),
              d = l ? 'search' : 'wallets';
            return (
              (V[d] = { listings: [...V[d].listings, ...c], total: i, page: null != a ? a : 1 }),
              { listings: c, total: i }
            );
          },
        ...
        B = {
          ...
          open: async (e) =>
            new Promise((t) => {
              let { isUiLoaded: s, isDataLoaded: r } = C.state;
              if (
                (y.removeWalletConnectDeepLink(),
                C.setWalletConnectUri(null == e ? void 0 : e.uri),
                C.setChains(null == e ? void 0 : e.chains),
      ...
      var J = Object.defineProperty,
        ...
        G = (e, t, s) =>
          t in e
            ? J(e, t, { enumerable: !0, configurable: !0, writable: !0, value: s })
            : (e[t] = s),
        Q = (e, t) => {
          for (var s in t || (t = {})) Z.call(t, s) && G(e, s, t[s]);
          if (q) for (var s of q(t)) F.call(t, s) && G(e, s, t[s]);
          return e;
        };
      let X = f({
          themeMode:
